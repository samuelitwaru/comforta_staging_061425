...
namespace GeneXus.Programs {
   public class aprc_uploadprofileimage : GXProcedure
   {
      public static int Main( string[] args )
      {
         return new aprc_uploadprofileimage().MainImpl(args); ;
      }
      ...
      public aprc_uploadprofileimage( )
      {
      ...
      public aprc_uploadprofileimage( IGxContext context )
      {
      ...
      {
         this.AV30ProfileImageUrl = aP0_ProfileImageUrl;
      ...
      private string AV30ProfileImageUrl ;
