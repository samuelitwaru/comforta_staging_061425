...
namespace GeneXus.Programs {
   public class wp_createlocationandreceptionist : GXDataArea
   {
      ...
      protected void E125Y2( )
      {
         ...
         {
            AV14WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV13WizardSteps.Item(AV21GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20257212555568", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createlocationandreceptionist.js", "?20257212555568", false, true);
