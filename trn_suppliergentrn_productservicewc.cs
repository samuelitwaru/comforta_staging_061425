...
namespace GeneXus.Programs {
   public class trn_suppliergentrn_productservicewc : GXWebComponent
   {
      public trn_suppliergentrn_productservicewc( )
      {
      ...
      public trn_suppliergentrn_productservicewc( IGxContext context )
      {
      ...
      {
         this.AV32SupplierGenId = aP0_SupplierGenId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV32SupplierGenId = StringUtil.StrToGuid( GetPar( "SupplierGenId"));
                  AssignAttri(sPrefix, false, "AV32SupplierGenId", AV32SupplierGenId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)AV32SupplierGenId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV26OrderedBy, AV27OrderedDsc, AV9FilterFullText, AV32SupplierGenId, AV24ManageFiltersExecutionStep, AV41Pgmname, AV18IsAuthorized_Display, AV22IsAuthorized_Update, AV17IsAuthorized_Delete, AV20IsAuthorized_ProductServiceName, AV19IsAuthorized_Insert, A11OrganisationId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV41Pgmname = "Trn_SupplierGenTrn_ProductServiceWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Trn_Supplier Gen Trn_Product Service WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_suppliergentrn_productservicewc.aspx"+UrlEncode(AV32SupplierGenId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_suppliergentrn_productservicewc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV32SupplierGenId", wcpOAV32SupplierGenId.ToString());
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV19IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV19IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSUPPLIERGENID", AV32SupplierGenId.ToString());
      ...
      {
         return "Trn_SupplierGenTrn_ProductServiceWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Supplier Gen Trn_Product Service WC", "") ;
      }
      ...
      protected void WB9G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_suppliergentrn_productservicewc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV9FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV9FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_Trn_SupplierGenTrn_ProductServiceWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSupplierGenId_Internalname, A42SupplierGenId.ToString(), A42SupplierGenId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierGenId_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierGenId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_SupplierGenTrn_ProductServiceWC.htm");
            /* User Defined Control */
      ...
      protected void START9G2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Trn_Supplier Gen Trn_Product Service WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_suppliergentrn_productservicewc.aspx")), "trn_suppliergentrn_productservicewc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_suppliergentrn_productservicewc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         /* Using cursor H009G2 */
         pr_default.execute(0, new Object[] {AV32SupplierGenId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A11OrganisationId = H009G2_A11OrganisationId[0];
            A31LocationName = H009G2_A31LocationName[0];
            A29LocationId = H009G2_A29LocationId[0];
            A42SupplierGenId = H009G2_A42SupplierGenId[0];
            n42SupplierGenId = H009G2_n42SupplierGenId[0];
            AssignAttri(sPrefix, false, "A42SupplierGenId", A42SupplierGenId.ToString());
            A51SupplierAgbName = H009G2_A51SupplierAgbName[0];
            A49SupplierAgbId = H009G2_A49SupplierAgbId[0];
            n49SupplierAgbId = H009G2_n49SupplierAgbId[0];
            A338ProductServiceGroup = H009G2_A338ProductServiceGroup[0];
            A40000ProductServiceImage_GXI = H009G2_A40000ProductServiceImage_GXI[0];
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
            A370ProductServiceClass = H009G2_A370ProductServiceClass[0];
            A60ProductServiceDescription = H009G2_A60ProductServiceDescription[0];
            A266ProductServiceTileName = H009G2_A266ProductServiceTileName[0];
            A59ProductServiceName = H009G2_A59ProductServiceName[0];
            A58ProductServiceId = H009G2_A58ProductServiceId[0];
            A61ProductServiceImage = H009G2_A61ProductServiceImage[0];
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
            AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
            A31LocationName = H009G2_A31LocationName[0];
            A51SupplierAgbName = H009G2_A51SupplierAgbName[0];
      ...
      protected void RF9G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H009G3 */
            pr_default.execute(1, new Object[] {AV32SupplierGenId});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            GRID_nEOF = 0;
            ...
            {
               A11OrganisationId = H009G3_A11OrganisationId[0];
               A31LocationName = H009G3_A31LocationName[0];
               A29LocationId = H009G3_A29LocationId[0];
               A42SupplierGenId = H009G3_A42SupplierGenId[0];
               n42SupplierGenId = H009G3_n42SupplierGenId[0];
               AssignAttri(sPrefix, false, "A42SupplierGenId", A42SupplierGenId.ToString());
               A51SupplierAgbName = H009G3_A51SupplierAgbName[0];
               A49SupplierAgbId = H009G3_A49SupplierAgbId[0];
               n49SupplierAgbId = H009G3_n49SupplierAgbId[0];
               A338ProductServiceGroup = H009G3_A338ProductServiceGroup[0];
               A40000ProductServiceImage_GXI = H009G3_A40000ProductServiceImage_GXI[0];
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               A370ProductServiceClass = H009G3_A370ProductServiceClass[0];
               A60ProductServiceDescription = H009G3_A60ProductServiceDescription[0];
               A266ProductServiceTileName = H009G3_A266ProductServiceTileName[0];
               A59ProductServiceName = H009G3_A59ProductServiceName[0];
               A58ProductServiceId = H009G3_A58ProductServiceId[0];
               A61ProductServiceImage = H009G3_A61ProductServiceImage[0];
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               A31LocationName = H009G3_A31LocationName[0];
               A51SupplierAgbName = H009G3_A51SupplierAgbName[0];
      ...
      protected void STRUP9G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV32SupplierGenId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV32SupplierGenId"));
      ...
      protected void E119G2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_SupplierGenTrn_ProductServiceWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV41Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("Trn_SupplierGenTrn_ProductServiceWCFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "Trn_SupplierGenTrn_ProductServiceWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV41Pgmname+"GridState",  AV25ManageFiltersXml) ;
      ...
      protected void S122( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_SupplierGenTrn_ProductServiceWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV31Session.Get(AV41Pgmname+"GridState"), "") == 0 )
         {
            AV13GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV41Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV13GridState.FromXml(AV31Session.Get(AV41Pgmname+"GridState"), null, "", "");
         }
         AV26OrderedBy = AV13GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV26OrderedBy", StringUtil.LTrimStr( (decimal)(AV26OrderedBy), 4, 0));
         AV27OrderedDsc = AV13GridState.gxTpr_Ordereddsc;
      ...
      protected void S192( )
      {
         ...
         {
            AV14GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV13GridState.gxTpr_Filtervalues.Item(AV43GXV1));
      ...
      protected void S172( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV41Pgmname+"GridState",  AV13GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S132( )
      {
         ...
         AV33TrnContext.gxTpr_Callerobject = AV41Pgmname;
         ...
         AV34TrnContextAtt.gxTpr_Attributename = "SupplierGenId";
         AV34TrnContextAtt.gxTpr_Attributevalue = AV32SupplierGenId.ToString();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV32SupplierGenId = (Guid)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV32SupplierGenId", AV32SupplierGenId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV32SupplierGenId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_suppliergentrn_productservicewc", GetJustCreated( ));
         ...
         {
            AV32SupplierGenId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV32SupplierGenId", AV32SupplierGenId.ToString());
         }
         wcpOAV32SupplierGenId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV32SupplierGenId"));
         if ( ! GetJustCreated( ) && ( ( AV32SupplierGenId != wcpOAV32SupplierGenId ) ) )
         {
            setjustcreated();
         }
         wcpOAV32SupplierGenId = AV32SupplierGenId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV32SupplierGenId = cgiGet( sPrefix+"AV32SupplierGenId_CTRL");
         if ( StringUtil.Len( sCtrlAV32SupplierGenId) > 0 )
         {
            AV32SupplierGenId = StringUtil.StrToGuid( cgiGet( sCtrlAV32SupplierGenId));
            AssignAttri(sPrefix, false, "AV32SupplierGenId", AV32SupplierGenId.ToString());
         }
         else
         {
            AV32SupplierGenId = StringUtil.StrToGuid( cgiGet( sPrefix+"AV32SupplierGenId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV32SupplierGenId_PARM", AV32SupplierGenId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV32SupplierGenId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV32SupplierGenId_CTRL", StringUtil.RTrim( sCtrlAV32SupplierGenId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20257212463565", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_suppliergentrn_productservicewc.js", "?20257212463565", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 37,'" + sPrefix + "',false,'" + sGXsfl_35_idx + "',35)\"";
            ROClassString = "Attribute";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:ProductServiceName|3:ProductServiceTileName|5:ProductServiceClass";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV32SupplierGenId","fld":"vSUPPLIERGENID"},{"av":"sPrefix"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV26OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV27OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV9FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV41Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV18IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV22IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV17IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV19IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E129G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV26OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV27OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV9FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV32SupplierGenId","fld":"vSUPPLIERGENID"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV41Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV18IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV22IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV17IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV19IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E199G2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV5ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV26OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV27OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV9FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV32SupplierGenId","fld":"vSUPPLIERGENID"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV41Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV18IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV22IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV17IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV19IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"sPrefix"},{"av":"A58ProductServiceId","fld":"PRODUCTSERVICEID","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E159G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV26OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV27OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV9FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV32SupplierGenId","fld":"vSUPPLIERGENID"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV41Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV18IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV22IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV17IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV19IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"sPrefix"},{"av":"A58ProductServiceId","fld":"PRODUCTSERVICEID","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"}]""");
      ...
      {
         wcpOAV32SupplierGenId = Guid.Empty;
         ...
         A51SupplierAgbName = "";
         GXDecQS = "";
         H009G2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009G2_A31LocationName = new string[] {""} ;
         H009G2_A29LocationId = new Guid[] {Guid.Empty} ;
         H009G2_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H009G2_n42SupplierGenId = new bool[] {false} ;
         H009G2_A51SupplierAgbName = new string[] {""} ;
         H009G2_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H009G2_n49SupplierAgbId = new bool[] {false} ;
         H009G2_A338ProductServiceGroup = new string[] {""} ;
         H009G2_A40000ProductServiceImage_GXI = new string[] {""} ;
         H009G2_A370ProductServiceClass = new string[] {""} ;
         H009G2_A60ProductServiceDescription = new string[] {""} ;
         H009G2_A266ProductServiceTileName = new string[] {""} ;
         H009G2_A59ProductServiceName = new string[] {""} ;
         H009G2_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H009G2_A61ProductServiceImage = new string[] {""} ;
         H009G3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009G3_A31LocationName = new string[] {""} ;
         H009G3_A29LocationId = new Guid[] {Guid.Empty} ;
         H009G3_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H009G3_n42SupplierGenId = new bool[] {false} ;
         H009G3_A51SupplierAgbName = new string[] {""} ;
         H009G3_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         H009G3_n49SupplierAgbId = new bool[] {false} ;
         H009G3_A338ProductServiceGroup = new string[] {""} ;
         H009G3_A40000ProductServiceImage_GXI = new string[] {""} ;
         H009G3_A370ProductServiceClass = new string[] {""} ;
         H009G3_A60ProductServiceDescription = new string[] {""} ;
         H009G3_A266ProductServiceTileName = new string[] {""} ;
         H009G3_A59ProductServiceName = new string[] {""} ;
         H009G3_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H009G3_A61ProductServiceImage = new string[] {""} ;
         ...
         H009G4_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H009G4_A29LocationId = new Guid[] {Guid.Empty} ;
         ...
         sCtrlAV32SupplierGenId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         sImgUrl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergentrn_productservicewc__default(),
            new Object[][] {
                new Object[] {
               H009G2_A11OrganisationId, H009G2_A31LocationName, H009G2_A29LocationId, H009G2_A42SupplierGenId, H009G2_n42SupplierGenId, H009G2_A51SupplierAgbName, H009G2_A49SupplierAgbId, H009G2_n49SupplierAgbId, H009G2_A338ProductServiceGroup, H009G2_A40000ProductServiceImage_GXI,
               H009G2_A370ProductServiceClass, H009G2_A60ProductServiceDescription, H009G2_A266ProductServiceTileName, H009G2_A59ProductServiceName, H009G2_A58ProductServiceId, H009G2_A61ProductServiceImage
               }
               , new Object[] {
               H009G3_A11OrganisationId, H009G3_A31LocationName, H009G3_A29LocationId, H009G3_A42SupplierGenId, H009G3_n42SupplierGenId, H009G3_A51SupplierAgbName, H009G3_A49SupplierAgbId, H009G3_n49SupplierAgbId, H009G3_A338ProductServiceGroup, H009G3_A40000ProductServiceImage_GXI,
               H009G3_A370ProductServiceClass, H009G3_A60ProductServiceDescription, H009G3_A266ProductServiceTileName, H009G3_A59ProductServiceName, H009G3_A58ProductServiceId, H009G3_A61ProductServiceImage
               }
               , new Object[] {
               H009G4_A11OrganisationId, H009G4_A29LocationId
               }
            }
         );
         AV41Pgmname = "Trn_SupplierGenTrn_ProductServiceWC";
      ...
      private string sCtrlAV32SupplierGenId ;
      ...
      private Guid AV32SupplierGenId ;
      private Guid wcpOAV32SupplierGenId ;
      ...
      private Guid[] H009G2_A11OrganisationId ;
      private string[] H009G2_A31LocationName ;
      private Guid[] H009G2_A29LocationId ;
      private Guid[] H009G2_A42SupplierGenId ;
      private bool[] H009G2_n42SupplierGenId ;
      private string[] H009G2_A51SupplierAgbName ;
      private Guid[] H009G2_A49SupplierAgbId ;
      private bool[] H009G2_n49SupplierAgbId ;
      private string[] H009G2_A338ProductServiceGroup ;
      private string[] H009G2_A40000ProductServiceImage_GXI ;
      private string[] H009G2_A370ProductServiceClass ;
      private string[] H009G2_A60ProductServiceDescription ;
      private string[] H009G2_A266ProductServiceTileName ;
      private string[] H009G2_A59ProductServiceName ;
      private Guid[] H009G2_A58ProductServiceId ;
      private string[] H009G2_A61ProductServiceImage ;
      private Guid[] H009G3_A11OrganisationId ;
      private string[] H009G3_A31LocationName ;
      private Guid[] H009G3_A29LocationId ;
      private Guid[] H009G3_A42SupplierGenId ;
      private bool[] H009G3_n42SupplierGenId ;
      private string[] H009G3_A51SupplierAgbName ;
      private Guid[] H009G3_A49SupplierAgbId ;
      private bool[] H009G3_n49SupplierAgbId ;
      private string[] H009G3_A338ProductServiceGroup ;
      private string[] H009G3_A40000ProductServiceImage_GXI ;
      private string[] H009G3_A370ProductServiceClass ;
      private string[] H009G3_A60ProductServiceDescription ;
      private string[] H009G3_A266ProductServiceTileName ;
      private string[] H009G3_A59ProductServiceName ;
      private Guid[] H009G3_A58ProductServiceId ;
      private string[] H009G3_A61ProductServiceImage ;
      ...
      private Guid[] H009G4_A11OrganisationId ;
      private Guid[] H009G4_A29LocationId ;
   ...
   public class trn_suppliergentrn_productservicewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A370ProductServiceClass )
      {
         ...
         scmdbuf = "SELECT T1.OrganisationId, T2.LocationName, T1.LocationId, T1.SupplierGenId, T3.SupplierAgbName, T1.SupplierAgbId, T1.ProductServiceGroup, T1.ProductServiceImage_GXI, T1.ProductServiceClass, T1.ProductServiceDescription, T1.ProductServiceTileName, T1.ProductServiceName, T1.ProductServiceId, T1.ProductServiceImage FROM ((Trn_ProductService T1 INNER JOIN Trn_Location T2 ON T2.LocationId = T1.LocationId AND T2.OrganisationId = T1.OrganisationId) LEFT JOIN Trn_SupplierAGB T3 ON T3.SupplierAgbId = T1.SupplierAgbId)";
         AddWhere(sWhereString, "(T1.SupplierGenId = :AV32SupplierGenId)");
         scmdbuf += sWhereString;
         if ( ( AV26OrderedBy == 1 ) && ! AV27OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.SupplierGenId, T1.ProductServiceName, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 1 ) && ( AV27OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.SupplierGenId DESC, T1.ProductServiceName DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 2 ) && ! AV27OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.SupplierGenId, T1.ProductServiceTileName, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 2 ) && ( AV27OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.SupplierGenId DESC, T1.ProductServiceTileName DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 3 ) && ! AV27OrderedDsc )
         {
            scmdbuf += " ORDER BY T1.SupplierGenId, T1.ProductServiceClass, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV26OrderedBy == 3 ) && ( AV27OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T1.SupplierGenId DESC, T1.ProductServiceClass DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H009G2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] );
               case 1 :
                     return conditional_H009G3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV32SupplierGenId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH009G3;
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[9])[0] = rslt.getMultimediaUri(8);
                ...
                ((string[]) buf[15])[0] = rslt.getMultimediaFile(14, rslt.getVarchar(8));
                return;
             case 1 :
                ((Guid[]) buf[0])[0] = rslt.getGuid(1);
                ((string[]) buf[1])[0] = rslt.getVarchar(2);
