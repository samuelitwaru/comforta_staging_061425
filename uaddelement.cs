...
namespace GeneXus.Programs {
   public class uaddelement : GXWebComponent
   {
      public uaddelement( )
      {
      ...
      public uaddelement( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Add Element", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "uaddelement.aspx"+UrlEncode(StringUtil.RTrim(AV54WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV61WWPFormElementParentId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV60WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("uaddelement.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void RenderHtmlCloseForm9S2( )
      {
      ...
      {
         return context.GetMessage( "Add Element", "") ;
      }
      ...
      protected void WB9S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "uaddelement.aspx");
               context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
               context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
               context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
               context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTab1_title_Internalname, context.GetMessage( "WWP_DF_GeneralInformation", ""), "", "", lblTab1_title_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_UAddElement.htm");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavFormtype, radavFormtype_Internalname, StringUtil.RTrim( AV18FormType), "", radavFormtype.Visible, 1, 0, 0, StyleString, ClassString, "", "", 0, radavFormtype_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavWwpformelementcaption, cmbavWwpformelementcaption_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV57WWPFormElementCaption), 1, 0)), 1, cmbavWwpformelementcaption_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbavWwpformelementcaption.Visible, cmbavWwpformelementcaption.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,47);\"", "", true, 0, "HLP_UAddElement.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockwwpformelementreferenceid_Internalname, context.GetMessage( "WWP_DF_ReferenceId", ""), "", "", lblTextblockwwpformelementreferenceid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_60_9S2( true) ;
         }
         else
         {
            wb_table1_60_9S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_60_9S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavControl, cmbavControl_Internalname, StringUtil.RTrim( AV10Control), 1, cmbavControl_Jsonclick, 5, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVCONTROL.CLICK."+"'", "svchar", "", cmbavControl.Visible, cmbavControl.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,71);\"", "", true, 0, "HLP_UAddElement.htm");
            ...
            GxWebStd.gx_radio_ctrl( context, radavText_format, radavText_format_Internalname, StringUtil.RTrim( AV35Text_Format), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavText_format_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_radio_ctrl( context, radavTextarea_format, radavTextarea_format_Internalname, StringUtil.RTrim( AV36TextArea_Format), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavTextarea_format_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,81);\"", "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavPredoptions_type, cmbavPredoptions_type_Internalname, StringUtil.RTrim( AV30PredOptions_Type), 1, cmbavPredoptions_type_Jsonclick, 5, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVPREDOPTIONS_TYPE.CLICK."+"'", "svchar", "", cmbavPredoptions_type.Visible, cmbavPredoptions_type.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,101);\"", "", true, 0, "HLP_UAddElement.htm");
            ...
            GxWebStd.gx_radio_ctrl( context, radavFile_format, radavFile_format_Internalname, StringUtil.RTrim( AV17File_Format), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavFile_format_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,151);\"", "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_radio_ctrl( context, radavRadio_direction, radavRadio_direction_Internalname, StringUtil.RTrim( AV32Radio_Direction), "", 1, 1, 0, 0, StyleString, ClassString, "", "", 0, radavRadio_direction_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,171);\"", "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavWwp_df_elementsrepeatermetadata_repetitionstype, cmbavWwp_df_elementsrepeatermetadata_repetitionstype_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV49WWP_DF_ElementsRepeaterMetadata.gxTpr_Repetitionstype), 1, 0)), 1, cmbavWwp_df_elementsrepeatermetadata_repetitionstype_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbavWwp_df_elementsrepeatermetadata_repetitionstype.Visible, cmbavWwp_df_elementsrepeatermetadata_repetitionstype.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,196);\"", "", true, 0, "HLP_UAddElement.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavWwp_df_labelmetadata_style, cmbavWwp_df_labelmetadata_style_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV51WWP_DF_LabelMetadata.gxTpr_Style), 2, 0)), 1, cmbavWwp_df_labelmetadata_style_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbavWwp_df_labelmetadata_style.Visible, cmbavWwp_df_labelmetadata_style.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,231);\"", "", true, 0, "HLP_UAddElement.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 236,'" + sPrefix + "',false,'" + sGXsfl_276_idx + "',0)\"";
            ClassString = "AttributeCheckBox";
            StyleString = "";
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTab2_title_Internalname, context.GetMessage( "WWP_DF_Visibility", ""), "", "", lblTab2_title_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_UAddElement.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockvisiblecondition_Internalname, context.GetMessage( "WWP_DF_VisibleCondition", ""), "", "", lblTextblockvisiblecondition_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table2_254_9S2( true) ;
         }
         else
         {
            wb_table2_254_9S2( false) ;
         }
         return  ;
      }

      protected void wb_table2_254_9S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTab3_title_Internalname, context.GetMessage( "Validations", ""), "", "", lblTab3_title_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_UAddElement.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            GxWebStd.gx_div_end( context, "end", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 HasGridEmpowerer", "start", "top", "", "", "div");
            /*  Grid Control  */
         ...
         if ( wbEnd == 276 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuacancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(276), 3, 0)+","+"null"+");", context.GetMessage( "GX_BtnCancel", ""), bttBtnuacancel_Jsonclick, 7, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e119s1_client"+"'", TempTags, "", 2, "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavWwpform_wwpformresume, cmbavWwpform_wwpformresume_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV55WWPForm.gxTpr_Wwpformresume), 1, 0)), 1, cmbavWwpform_wwpformresume_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbavWwpform_wwpformresume.Visible, 1, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,290);\"", "", true, 0, "HLP_UAddElement.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavWwp_df_containermetadata_style, cmbavWwp_df_containermetadata_style_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV47WWP_DF_ContainerMetadata.gxTpr_Style), 1, 0)), 1, cmbavWwp_df_containermetadata_style_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbavWwp_df_containermetadata_style.Visible, 1, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,291);\"", "", true, 0, "HLP_UAddElement.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavColumns_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Columns), 2, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8Columns), "Z9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,292);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavColumns_Jsonclick, 0, "Attribute", "", "", "", "", edtavColumns_Visible, 1, 0, "text", "1", 2, "chr", 1, "row", 2, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_UAddElement.htm");
            wb_table3_293_9S2( true) ;
         }
         else
         {
            wb_table3_293_9S2( false) ;
         }
         return  ;
      }

      protected void wb_table3_293_9S2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_298_9S2( true) ;
         }
         else
         {
            wb_table4_298_9S2( false) ;
         }
         return  ;
      }

      protected void wb_table4_298_9S2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
      ...
      protected void START9S2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Add Element", ""), 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDVALIDATIONS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "VGRIDACTIONGROUP1.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "VGRIDACTIONGROUP1.CLICK") == 0 ) )
                           {
                              ...
                              AV98GXV28 = (int)(nGXsfl_276_idx+GRIDVALIDATIONS_nFirstRecordOnPage);
                              if ( ( AV39Validations.Count >= AV98GXV28 ) && ( AV98GXV28 > 0 ) )
                              {
                                 AV39Validations.CurrentItem = ((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)AV39Validations.Item(AV98GXV28));
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "uaddelement.aspx")), "uaddelement.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "uaddelement.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void STRUP9S0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            while ( nGXsfl_276_fel_idx < nRC_GXsfl_276 )
            {
               ...
               AV98GXV28 = (int)(nGXsfl_276_fel_idx+GRIDVALIDATIONS_nFirstRecordOnPage);
               if ( ( AV39Validations.Count >= AV98GXV28 ) && ( AV98GXV28 > 0 ) )
               {
                  AV39Validations.CurrentItem = ((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)AV39Validations.Item(AV98GXV28));
                  cmbavGridactiongroup1.Name = cmbavGridactiongroup1_Internalname;
      ...
      protected void E319S2( )
      {
               ...
               else if ( AV64WWPFormElementType == 1 )
               {
                  if ( AV58WWPFormElementDataType == 2 )
                  {
                     ...
                     if ( AV46WWP_DF_CharMetadata.gxTpr_Controltype == 4 )
                     {
                        ...
                        {
                           AV102GXV32 = 1;
                           while ( AV102GXV32 <= AV46WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Count )
                           {
                              AV41VarCharAux = ((string)AV46WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Item(AV102GXV32));
         ...
         if ( ! AV22IsFormSettings && ( ( StringUtil.StrCmp(AV54WWPDynamicFormMode, "INS") == 0 ) || ( AV64WWPFormElementType == 3 ) ) )
         {
            ...
            AV103GXV33 = 1;
            while ( AV103GXV33 <= AV55WWPForm.gxTpr_Element.Count )
            {
               AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV103GXV33));
      ...
      private void E339S2( )
      {
         ...
         returnInSub = false;
         AV98GXV28 = 1;
         while ( AV98GXV28 <= AV39Validations.Count )
         {
            AV39Validations.CurrentItem = ((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)AV39Validations.Item(AV98GXV28));
      ...
      protected void E349S2( )
      {
         AV98GXV28 = (int)(nGXsfl_276_idx+GRIDVALIDATIONS_nFirstRecordOnPage);
         if ( ( AV98GXV28 > 0 ) && ( AV39Validations.Count >= AV98GXV28 ) )
         {
            AV39Validations.CurrentItem = ((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)AV39Validations.Item(AV98GXV28));
         }
      ...
      protected void E169S2( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "WWP_DF_EnterConditionToValidate", ""),  "error",  edtavVisiblecondition_Internalname,  "true",  ""));
         }
         else
         {
            ...
            {
               GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "WWP_DF_ConditionExecSuccessfully", ""),  "success",  "",  "true",  ""));
            }
         }
         /*  Sending Event outputs  */
      ...
      protected void S182( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_Title", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwpform_wwpformtitle_Internalname,  "true",  ""));
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_ReferenceName", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwpform_wwpformreferencename_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_ResumeMessage", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwpform_wwpformresumemessage_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_Title", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwpformelementtitle_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_ReferenceId", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwpformelementreferenceid_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_ServiceURL", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwp_df_charmetadata_multipleoptions_dynamic_getoptionsservice_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_Options", ""), "", "", "", "", "", "", "", ""),  "error",  edtavPredoptions_options_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_InsertChildCaption", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwp_df_elementsrepeatermetadata_repetitions_useradded_insertchildcaption_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_MaxRepetitions", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwp_df_elementsrepeatermetadata_repetitions_useradded_maxrepetitions_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_RepetitionsValue", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWwp_df_elementsrepeatermetadata_repetitions_fixedvalue_value_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_DF_RepetitionsCountVariable", ""), "", "", "", "", "", "", "", ""),  "error",  cmbavWwp_df_elementsrepeatermetadata_repetitions_variable_elementid_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
      }
      ...
      protected void S112( )
      {
         ...
         else
         {
            ...
            divTextblockwwpformelementreferenceid_cell_Class = "Invisible";
            AssignProp(sPrefix, false, divTextblockwwpformelementreferenceid_cell_Internalname, "Class", divTextblockwwpformelementreferenceid_cell_Class, true);
            lblReferencieidhelpicon_Visible = 0;
            AssignProp(sPrefix, false, lblReferencieidhelpicon_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(lblReferencieidhelpicon_Visible), 5, 0), true);
         }
         ...
         if ( AV7CheckRequiredFieldsResult && ( ( StringUtil.StrCmp(AV54WWPDynamicFormMode, "INS") == 0 ) || ( StringUtil.StrCmp(AV54WWPDynamicFormMode, "UPD") == 0 ) ) )
         {
            if ( AV22IsFormSettings )
            {
               ...
               if ( AV55WWPForm.gxTpr_Wwpformiswizard != ( ( StringUtil.StrCmp(AV18FormType, "Wizard") == 0 ) ) )
               {
                  ...
                  AV104GXV34 = 1;
                  while ( AV104GXV34 <= AV55WWPForm.gxTpr_Element.Count )
                  {
                     AV56WWPFormElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV104GXV34));
                     if ( AV55WWPForm.gxTpr_Wwpformiswizard )
                     {
                        if ( AV56WWPFormElement.gxTpr_Wwpformelementtype == 5 )
                        {
                           ...
                           AV105GXV35 = 1;
                           while ( AV105GXV35 <= AV53WWP_DF_StepMetadata.gxTpr_Validations.Count )
                           {
                              AV37Validation = ((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)AV53WWP_DF_StepMetadata.gxTpr_Validations.Item(AV105GXV35));
                              AV39Validations.Add((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)(AV37Validation.Clone()), 0);
                              gx_BV276 = true;
                              AV105GXV35 = (int)(AV105GXV35+1);
                           }
                     ...
                     else
                     {
                        if ( (0==AV56WWPFormElement.gxTpr_Wwpformelementparentid) )
                        {
                           ...
                           else
                           {
                              AV7CheckRequiredFieldsResult = false;
                              AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
                              GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "WWP_DF_ChangeFormTypeWizardRequirement", ""),  "error",  radavFormtype_Internalname,  "true",  ""));
                              if (true) break;
                           }
                        }
                     }
                     AV104GXV34 = (int)(AV104GXV34+1);
                  }
               }
               ...
               {
                  GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "WWP_DF_ReferenceMustBeUnique", ""),  "error",  edtavWwpform_wwpformreferencename_Internalname,  "true",  ""));
                  AV7CheckRequiredFieldsResult = false;
                  AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
               }
               if ( AV7CheckRequiredFieldsResult )
               {
                  ...
                  if ( AV55WWPForm.gxTpr_Element.Count == 0 )
                  {
                     AV58WWPFormElementDataType = 2;
                     AssignAttri(sPrefix, false, "AV58WWPFormElementDataType", StringUtil.LTrimStr( (decimal)(AV58WWPFormElementDataType), 2, 0));
                     AV47WWP_DF_ContainerMetadata.gxTpr_Style = 0;
                     ...
                     cmbavWwp_df_elementsrepeatermetadata_repetitions_variable_elementid.addItem(StringUtil.Str( (decimal)(0), 1, 0), "", 0);
                     AV106GXV36 = 1;
                     while ( AV106GXV36 <= AV55WWPForm.gxTpr_Element.Count )
                     {
                        AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV106GXV36));
                        if ( ( AV15ElementAux.gxTpr_Wwpformelementparentid >= 0 ) && ( AV15ElementAux.gxTpr_Wwpformelementtype == 1 ) && ( AV15ElementAux.gxTpr_Wwpformelementdatatype == 3 ) && ! String.IsNullOrEmpty(StringUtil.RTrim( StringUtil.Trim( AV15ElementAux.gxTpr_Wwpformelementreferenceid))) )
                        {
                           cmbavWwp_df_elementsrepeatermetadata_repetitions_variable_elementid.addItem(StringUtil.LTrimStr( (decimal)(AV15ElementAux.gxTpr_Wwpformelementid), 4, 0), AV15ElementAux.gxTpr_Wwpformelementreferenceid, 0);
                        }
                        AV106GXV36 = (int)(AV106GXV36+1);
                     }
                     AV8Columns = 1;
                     AssignAttri(sPrefix, false, "AV8Columns", StringUtil.LTrimStr( (decimal)(AV8Columns), 2, 0));
                     ...
                     AV107GXV37 = 1;
                     while ( AV107GXV37 <= AV55WWPForm.gxTpr_Element.Count )
                     {
                        AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV107GXV37));
                     ...
                     AV55WWPForm.Check();
                     AV108GXV38 = 1;
                     while ( AV108GXV38 <= AV55WWPForm.gxTpr_Element.Count )
                     {
                        AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV108GXV38));
            ...
            else
            {
               if ( StringUtil.StrCmp(AV54WWPDynamicFormMode, "INS") == 0 )
               {
                  ...
                  AV56WWPFormElement.gxTpr_Wwpformelementid = (short)(AV55WWPForm.gxTpr_Element.Count+1);
                  AV109GXV39 = 1;
                  while ( AV109GXV39 <= AV55WWPForm.gxTpr_Element.Count )
                  {
                     AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV109GXV39));
                     if ( AV15ElementAux.gxTpr_Wwpformelementid >= AV56WWPFormElement.gxTpr_Wwpformelementid )
                     {
                        AV56WWPFormElement.gxTpr_Wwpformelementid = (short)(AV15ElementAux.gxTpr_Wwpformelementid+1);
                     }
                     AV109GXV39 = (int)(AV109GXV39+1);
                  }
                  AV56WWPFormElement.gxTpr_Wwpformelementparentid = AV61WWPFormElementParentId;
                  AV56WWPFormElement.gxTpr_Wwpformelementorderindex = (short)(((AV55WWPForm.gxTpr_Element.Count==0) ? 0 : ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV55WWPForm.gxTpr_Element.Count)).gxTpr_Wwpformelementorderindex));
                  AV56WWPFormElement.gxTpr_Wwpformelementorderindex = (short)(AV56WWPFormElement.gxTpr_Wwpformelementorderindex+1);
               ...
               else if ( AV64WWPFormElementType == 1 )
               {
                  ...
                  else if ( StringUtil.StrCmp(AV10Control, "Options") == 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(AV31PredOptions_Values, "Fixed") == 0 )
                     {
                        ...
                        AV111GXV41 = 1;
                        AV110GXV40 = GxRegex.Split(AV29PredOptions_Options,StringUtil.Chr( 10));
                        while ( AV111GXV41 <= AV110GXV40.Count )
                        {
                           AV41VarCharAux = AV110GXV40.GetString(AV111GXV41);
               ...
               if ( AV7CheckRequiredFieldsResult )
               {
                  AV55WWPForm.Check();
                  AV112GXV42 = 1;
                  while ( AV112GXV42 <= AV55WWPForm.gxTpr_Element.Count )
                  {
                     AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV112GXV42));
                     if ( StringUtil.Contains( AV15ElementAux.ToJSonString(true, true), "\"Mode\":\"DLT\"") )
                     {
                        AV15ElementAux.gxTpr_Wwpformelementparentid = (short)(AV15ElementAux.gxTpr_Wwpformelementid*-1);
                     }
                     AV112GXV42 = (int)(AV112GXV42+1);
                  }
                  new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_saveformdefinition(context ).execute(  AV33SessionId,  AV55WWPForm) ;
      ...
      protected void E189S2( )
      {
         ...
         radavFormtype.CurrentValue = StringUtil.RTrim( AV18FormType);
         AssignProp(sPrefix, false, radavFormtype_Internalname, "Values", radavFormtype.ToJavascriptSource(), true);
         cmbavWwpformelementtype.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV64WWPFormElementType), 1, 0));
         AssignProp(sPrefix, false, cmbavWwpformelementtype_Internalname, "Values", cmbavWwpformelementtype.ToJavascriptSource(), true);
         cmbavWwpformelementcaption.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV57WWPFormElementCaption), 1, 0));
         AssignProp(sPrefix, false, cmbavWwpformelementcaption_Internalname, "Values", cmbavWwpformelementcaption.ToJavascriptSource(), true);
      ...
      protected void S192( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( StringUtil.Trim( AV62WWPFormElementReferenceId))) )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( StringUtil.Trim( AV62WWPFormElementReferenceId)), "value") == 0 )
            {
               ...
               GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_DF_InvalidReferenceId", ""), AV62WWPFormElementReferenceId, "", "", "", "", "", "", "", ""),  "error",  edtavWwpformelementreferenceid_Internalname,  "true",  ""));
               AV7CheckRequiredFieldsResult = false;
               AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
            }
            else
            {
               AV113GXV43 = 1;
               while ( AV113GXV43 <= AV55WWPForm.gxTpr_Element.Count )
               {
                  AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV113GXV43));
                  ...
                  {
                     this.executeUsercontrolMethod(sPrefix, false, "GXUITABSPANEL_TABS1Container", "SelectTab", "", new Object[] {(short)1});
                     GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_DF_DuplicatedReferenceId", ""), AV62WWPFormElementReferenceId, "", "", "", "", "", "", "", ""),  "error",  edtavWwpformelementreferenceid_Internalname,  "true",  ""));
                     AV7CheckRequiredFieldsResult = false;
                     AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
                  }
                  AV113GXV43 = (int)(AV113GXV43+1);
               }
            }
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "WWP_DF_DecimalsGreater5", ""),  "error",  edtavWwp_df_numericmetadata_decimals_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
         ...
         {
            AV114GXV44 = 1;
            while ( AV114GXV44 <= AV39Validations.Count )
            {
               AV37Validation = ((WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation)AV39Validations.Item(AV114GXV44));
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9ConditionError)) )
               {
                  ...
                  GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  AV9ConditionError,  "error",  "",  "true",  ""));
                  AV7CheckRequiredFieldsResult = false;
                  AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
                  if (true) break;
               }
               AV114GXV44 = (int)(AV114GXV44+1);
            }
         }
         if ( AV7CheckRequiredFieldsResult && ( StringUtil.StrCmp(AV54WWPDynamicFormMode, "UPD") == 0 ) && ( AV64WWPFormElementType == 3 ) )
         {
            ...
            {
               AV115GXV45 = 1;
               while ( AV115GXV45 <= AV55WWPForm.gxTpr_Element.Count )
               {
                  AV15ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV55WWPForm.gxTpr_Element.Item(AV115GXV45));
                  if ( AV15ElementAux.gxTpr_Wwpformelementparentid == AV60WWPFormElementId )
                  {
                     if ( AV49WWP_DF_ElementsRepeaterMetadata.gxTpr_Repetitionsdatatype == 2 )
                     {
                        if ( AV15ElementAux.gxTpr_Wwpformelementtype != 1 )
                        {
                           AV7CheckRequiredFieldsResult = false;
                           AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
                           GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "WWP_DF_ChangeDisplayTypeRequirement", ""),  "error",  "",  "true",  ""));
                           if (true) break;
                        }
                        else
                        {
      ...
      protected void S172( )
      {
         ...
         else
         {
            ...
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  AV9ConditionError,  "error",  edtavVisiblecondition_Internalname,  "true",  ""));
            AV7CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV7CheckRequiredFieldsResult", AV7CheckRequiredFieldsResult);
         }
      }

      protected void wb_table4_298_9S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_298_9S2e( true) ;
         }
         else
         {
            wb_table4_298_9S2e( false) ;
         }
      }

      protected void wb_table3_293_9S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_293_9S2e( true) ;
         }
         else
         {
            wb_table3_293_9S2e( false) ;
         }
      }

      protected void wb_table2_254_9S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 258,'" + sPrefix + "',false,'" + sGXsfl_276_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavVisiblecondition_Internalname, AV43VisibleCondition, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,258);\"", 0, 1, edtavVisiblecondition_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_UAddElement.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DynFormConditionHelpCell'>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblVisibleconditionhelpicon_Internalname, lblVisibleconditionhelpicon_Caption, "", "", lblVisibleconditionhelpicon_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 2, "HLP_UAddElement.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_254_9S2e( true) ;
         }
         else
         {
            wb_table2_254_9S2e( false) ;
         }
      }

      protected void wb_table1_60_9S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "uaddelement", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562016593436", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("uaddelement.js", "?202562016593440", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void sendrow_2762( )
      {
         ...
         if ( ( subGridvalidations_Rows * 1 == 0 ) || ( nGXsfl_276_idx <= subGridvalidations_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( ( cmbavGridactiongroup1.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  if ( ( AV98GXV28 > 0 ) && ( AV39Validations.Count >= AV98GXV28 ) && (0==AV19GridActionGroup1) )
                  {
      ...
      public override void initialize_properties( )
      {
         ...
         lblReferencieidhelpicon_Visible = 1;
         ...
         edtavWwpformelementtitle_Height = 10;
         chkavWwp_df_datemetadata_isdefaultvaluetoday.Caption = context.GetMessage( "WWP_DF_SetTodayAsDefaultValue", "");
         edtavWwpformelementreferenceid_Visible = 1;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUACANCEL'","""{"handler":"E119S1","iparms":[]}""");
         setEventMetadata("ADDVALIDATION_MODAL.ONLOADCOMPONENT","""{"handler":"E139S2","iparms":[{"av":"AV54WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE"},{"av":"AV61WWPFormElementParentId","fld":"vWWPFORMELEMENTPARENTID","pic":"ZZZ9"},{"av":"AV60WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV62WWPFormElementReferenceId","fld":"vWWPFORMELEMENTREFERENCEID"},{"av":"AV58WWPFormElementDataType","fld":"vWWPFORMELEMENTDATATYPE","pic":"Z9"},{"av":"AV33SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         setEventMetadata("ADDVALIDATION_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("VGRIDACTIONGROUP1.CLICK","""{"handler":"E349S2","iparms":[{"av":"cmbavGridactiongroup1"},{"av":"AV19GridActionGroup1","fld":"vGRIDACTIONGROUP1","pic":"ZZZ9"},{"av":"AV39Validations","fld":"vVALIDATIONS","grid":276},{"av":"nGXsfl_276_idx","ctrl":"GRID","prop":"GridCurrRow","grid":276},{"av":"GRIDVALIDATIONS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_276","ctrl":"GRIDVALIDATIONS","prop":"GridRC","grid":276},{"av":"GRIDVALIDATIONS_nEOF"},{"av":"subGridvalidations_Rows","ctrl":"GRIDVALIDATIONS","prop":"Rows"},{"av":"sPrefix"},{"av":"cmbavWwpformelementtype"},{"av":"AV64WWPFormElementType","fld":"vWWPFORMELEMENTTYPE","pic":"9"},{"av":"radavFormtype"},{"av":"AV18FormType","fld":"vFORMTYPE"},{"av":"radavText_format"},{"av":"AV35Text_Format","fld":"vTEXT_FORMAT"},{"av":"radavTextarea_format"},{"av":"AV36TextArea_Format","fld":"vTEXTAREA_FORMAT"},{"av":"AV14Date_IncludeTime","fld":"vDATE_INCLUDETIME"},{"av":"GXV4","fld":"WWP_DF_DATEMETADATA_ISDEFAULTVALUETODAY"},{"av":"GXV5","fld":"WWP_DF_CHARMETADATA_MULTIPLEOPTIONS_ALLOWMULTIPLESELECTION"},{"av":"radavPredoptions_values"},{"av":"AV31PredOptions_Values","fld":"vPREDOPTIONS_VALUES"},{"av":"GXV7","fld":"WWP_DF_CHARMETADATA_MULTIPLEOPTIONS_COMBOBOX_INCLUDEEMPTYVALUE"},{"av":"GXV11","fld":"WWP_DF_CONTAINERMETADATA_COLLAPSABLE"},{"av":"GXV12","fld":"WWP_DF_CONTAINERMETADATA_COLLAPSEDBYDEFAULT"},{"av":"radavFile_format"},{"av":"AV17File_Format","fld":"vFILE_FORMAT"},{"av":"radavRadio_direction"},{"av":"AV32Radio_Direction","fld":"vRADIO_DIRECTION"},{"av":"GXV17","fld":"WWP_DF_BOOLEANMETADATA_DEFAULTVALUE"},{"av":"GXV22","fld":"WWP_DF_ELEMENTSREPEATERMETADATA_REPETITIONS_USERADDED_INSERTCHILDBUTTON_ISALIGNEDTOLABEL"},{"av":"AV24IsRequired","fld":"vISREQUIRED"},{"av":"AV59WWPFormElementExcludeFromExport","fld":"vWWPFORMELEMENTEXCLUDEFROMEXPORT"},{"av":"AV22IsFormSettings","fld":"vISFORMSETTINGS","hsh":true},{"av":"AV65WWPFormTitle","fld":"vWWPFORMTITLE","hsh":true},{"av":"AV28ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true}]""");
         ...
         setEventMetadata("UPDATEVALIDATION_MODAL.ONLOADCOMPONENT","""{"handler":"E159S2","iparms":[{"av":"AV54WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE"},{"av":"AV61WWPFormElementParentId","fld":"vWWPFORMELEMENTPARENTID","pic":"ZZZ9"},{"av":"AV60WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV62WWPFormElementReferenceId","fld":"vWWPFORMELEMENTREFERENCEID"},{"av":"AV58WWPFormElementDataType","fld":"vWWPFORMELEMENTDATATYPE","pic":"Z9"},{"av":"AV33SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV38ValidationJson","fld":"vVALIDATIONJSON"}]""");
         setEventMetadata("UPDATEVALIDATION_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("'DOTESTVISIBLECONDITION'","""{"handler":"E169S2","iparms":[{"av":"AV43VisibleCondition","fld":"vVISIBLECONDITION"},{"av":"AV33SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV60WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV9ConditionError","fld":"vCONDITIONERROR"},{"av":"AV55WWPForm","fld":"vWWPFORM"},{"av":"AV16ExecuteConditionToTest","fld":"vEXECUTECONDITIONTOTEST"},{"av":"AV62WWPFormElementReferenceId","fld":"vWWPFORMELEMENTREFERENCEID"},{"av":"AV58WWPFormElementDataType","fld":"vWWPFORMELEMENTDATATYPE","pic":"Z9"},{"av":"AV5AllReferenceIds","fld":"vALLREFERENCEIDS"},{"av":"AV44VisibleConditionExpression","fld":"vVISIBLECONDITIONEXPRESSION"}]""");
         ...
         setEventMetadata("UPDATEVALIDATION_MODAL.CLOSE","""{"handler":"E149S2","iparms":[{"av":"Updatevalidation_modal_Result","ctrl":"UPDATEVALIDATION_MODAL","prop":"Result"},{"av":"AV13CurrentValidationIndex","fld":"vCURRENTVALIDATIONINDEX","pic":"ZZZ9"},{"av":"AV39Validations","fld":"vVALIDATIONS","grid":276},{"av":"nGXsfl_276_idx","ctrl":"GRID","prop":"GridCurrRow","grid":276},{"av":"GRIDVALIDATIONS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_276","ctrl":"GRIDVALIDATIONS","prop":"GridRC","grid":276},{"av":"GRIDVALIDATIONS_nEOF"},{"av":"subGridvalidations_Rows","ctrl":"GRIDVALIDATIONS","prop":"Rows"},{"av":"sPrefix"},{"av":"cmbavWwpformelementtype"},{"av":"AV64WWPFormElementType","fld":"vWWPFORMELEMENTTYPE","pic":"9"},{"av":"radavFormtype"},{"av":"AV18FormType","fld":"vFORMTYPE"},{"av":"radavText_format"},{"av":"AV35Text_Format","fld":"vTEXT_FORMAT"},{"av":"radavTextarea_format"},{"av":"AV36TextArea_Format","fld":"vTEXTAREA_FORMAT"},{"av":"AV14Date_IncludeTime","fld":"vDATE_INCLUDETIME"},{"av":"GXV4","fld":"WWP_DF_DATEMETADATA_ISDEFAULTVALUETODAY"},{"av":"GXV5","fld":"WWP_DF_CHARMETADATA_MULTIPLEOPTIONS_ALLOWMULTIPLESELECTION"},{"av":"radavPredoptions_values"},{"av":"AV31PredOptions_Values","fld":"vPREDOPTIONS_VALUES"},{"av":"GXV7","fld":"WWP_DF_CHARMETADATA_MULTIPLEOPTIONS_COMBOBOX_INCLUDEEMPTYVALUE"},{"av":"GXV11","fld":"WWP_DF_CONTAINERMETADATA_COLLAPSABLE"},{"av":"GXV12","fld":"WWP_DF_CONTAINERMETADATA_COLLAPSEDBYDEFAULT"},{"av":"radavFile_format"},{"av":"AV17File_Format","fld":"vFILE_FORMAT"},{"av":"radavRadio_direction"},{"av":"AV32Radio_Direction","fld":"vRADIO_DIRECTION"},{"av":"GXV17","fld":"WWP_DF_BOOLEANMETADATA_DEFAULTVALUE"},{"av":"GXV22","fld":"WWP_DF_ELEMENTSREPEATERMETADATA_REPETITIONS_USERADDED_INSERTCHILDBUTTON_ISALIGNEDTOLABEL"},{"av":"AV24IsRequired","fld":"vISREQUIRED"},{"av":"AV59WWPFormElementExcludeFromExport","fld":"vWWPFORMELEMENTEXCLUDEFROMEXPORT"},{"av":"AV22IsFormSettings","fld":"vISFORMSETTINGS","hsh":true},{"av":"AV65WWPFormTitle","fld":"vWWPFORMTITLE","hsh":true},{"av":"AV28ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true}]""");
         ...
         setEventMetadata("ADDVALIDATION_MODAL.CLOSE","""{"handler":"E129S2","iparms":[{"av":"Addvalidation_modal_Result","ctrl":"ADDVALIDATION_MODAL","prop":"Result"},{"av":"AV39Validations","fld":"vVALIDATIONS","grid":276},{"av":"nGXsfl_276_idx","ctrl":"GRID","prop":"GridCurrRow","grid":276},{"av":"GRIDVALIDATIONS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_276","ctrl":"GRIDVALIDATIONS","prop":"GridRC","grid":276},{"av":"GRIDVALIDATIONS_nEOF"},{"av":"subGridvalidations_Rows","ctrl":"GRIDVALIDATIONS","prop":"Rows"},{"av":"sPrefix"},{"av":"cmbavWwpformelementtype"},{"av":"AV64WWPFormElementType","fld":"vWWPFORMELEMENTTYPE","pic":"9"},{"av":"radavFormtype"},{"av":"AV18FormType","fld":"vFORMTYPE"},{"av":"radavText_format"},{"av":"AV35Text_Format","fld":"vTEXT_FORMAT"},{"av":"radavTextarea_format"},{"av":"AV36TextArea_Format","fld":"vTEXTAREA_FORMAT"},{"av":"AV14Date_IncludeTime","fld":"vDATE_INCLUDETIME"},{"av":"GXV4","fld":"WWP_DF_DATEMETADATA_ISDEFAULTVALUETODAY"},{"av":"GXV5","fld":"WWP_DF_CHARMETADATA_MULTIPLEOPTIONS_ALLOWMULTIPLESELECTION"},{"av":"radavPredoptions_values"},{"av":"AV31PredOptions_Values","fld":"vPREDOPTIONS_VALUES"},{"av":"GXV7","fld":"WWP_DF_CHARMETADATA_MULTIPLEOPTIONS_COMBOBOX_INCLUDEEMPTYVALUE"},{"av":"GXV11","fld":"WWP_DF_CONTAINERMETADATA_COLLAPSABLE"},{"av":"GXV12","fld":"WWP_DF_CONTAINERMETADATA_COLLAPSEDBYDEFAULT"},{"av":"radavFile_format"},{"av":"AV17File_Format","fld":"vFILE_FORMAT"},{"av":"radavRadio_direction"},{"av":"AV32Radio_Direction","fld":"vRADIO_DIRECTION"},{"av":"GXV17","fld":"WWP_DF_BOOLEANMETADATA_DEFAULTVALUE"},{"av":"GXV22","fld":"WWP_DF_ELEMENTSREPEATERMETADATA_REPETITIONS_USERADDED_INSERTCHILDBUTTON_ISALIGNEDTOLABEL"},{"av":"AV24IsRequired","fld":"vISREQUIRED"},{"av":"AV59WWPFormElementExcludeFromExport","fld":"vWWPFORMELEMENTEXCLUDEFROMEXPORT"},{"av":"AV22IsFormSettings","fld":"vISFORMSETTINGS","hsh":true},{"av":"AV65WWPFormTitle","fld":"vWWPFORMTITLE","hsh":true},{"av":"AV28ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV37Validation = new WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation(context);
         AV56WWPFormElement = new GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element(context);
         AV110GXV40 = new GxSimpleCollection<string>();
         GXt_char3 = "";
      ...
      private int AV102GXV32 ;
      private int AV103GXV33 ;
      private int nGXsfl_276_bak_idx=1 ;
      private int edtavWwpformelementreferenceid_Visible ;
      private int lblReferencieidhelpicon_Visible ;
      private int edtavWwpformelementtitle_Height ;
      private int AV104GXV34 ;
      private int AV105GXV35 ;
      private int AV106GXV36 ;
      private int AV107GXV37 ;
      private int AV108GXV38 ;
      private int AV109GXV39 ;
      private int AV111GXV41 ;
      private int AV112GXV42 ;
      private int AV113GXV43 ;
      private int AV114GXV44 ;
      private int AV115GXV45 ;
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWWPSuggestDataItem> AV5AllReferenceIds ;
      ...
      private GxSimpleCollection<string> AV110GXV40 ;
