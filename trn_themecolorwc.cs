...
namespace GeneXus.Programs {
   public class trn_themecolorwc : GXWebComponent
   {
      ...
      protected void RenderHtmlCloseForm7H2( )
      {
      ...
      protected void WB7H0( )
      {
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTrn_ThemeId_Internalname, A273Trn_ThemeId.ToString(), A273Trn_ThemeId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_ThemeId_Jsonclick, 0, "Attribute", "", "", "", "", edtTrn_ThemeId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ThemeColorWC.htm");
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A276ColorName = cgiGet( edtColorName_Internalname);
      ...
      protected void RF7H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A273Trn_ThemeId = H007H2_A273Trn_ThemeId[0];
               AssignAttri(sPrefix, false, "A273Trn_ThemeId", A273Trn_ThemeId.ToString());
               A277ColorCode = H007H2_A277ColorCode[0];
               A276ColorName = H007H2_A276ColorName[0];
               A275ColorId = H007H2_A275ColorId[0];
               /* Execute user event: Grid.Load */
               E167H2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561716202094", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_themecolorwc.js", "?202561716202094", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl15( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A275ColorId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A276ColorName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A277ColorCode));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void initialize( )
      {
         ...
         A277ColorCode = "";
         GXDecQS = "";
         H007H2_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         H007H2_A277ColorCode = new string[] {""} ;
         H007H2_A276ColorName = new string[] {""} ;
         H007H2_A275ColorId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_themecolorwc__default(),
            new Object[][] {
                new Object[] {
               H007H2_A273Trn_ThemeId, H007H2_A277ColorCode, H007H2_A276ColorName, H007H2_A275ColorId
               }
               , new Object[] {
      ...
      private Guid[] H007H2_A273Trn_ThemeId ;
      private string[] H007H2_A277ColorCode ;
      private string[] H007H2_A276ColorName ;
      private Guid[] H007H2_A275ColorId ;
   ...
   public class trn_themecolorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid A273Trn_ThemeId )
      {
         ...
         {
            sOrderString += " ORDER BY Trn_ThemeId, ColorName";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY Trn_ThemeId DESC, ColorName DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007H2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 1 :
                     return conditional_H007H3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
