...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_Theme" , Namespace="Comforta_version21" )]
	[Serializable]
	public class SdtSDT_Theme : GxUserType
	{
		...
		public override void ToJSON(bool includeState)
		{
			...
			if (gxTv_SdtSDT_Theme_Ctacolors != null)
			{
				AddObjectProperty("CtaColors", gxTv_SdtSDT_Theme_Ctacolors, false);
			}
			return;
		}
		#endregion
		...
		public GXBaseCollection<SdtSDT_Theme_CtaColorsItem> gxTpr_Ctacolors
		{
			get {
				if ( gxTv_SdtSDT_Theme_Ctacolors == null )
				{
					gxTv_SdtSDT_Theme_Ctacolors = new GXBaseCollection<SdtSDT_Theme_CtaColorsItem>( context, "SDT_Theme.CtaColorsItem", "");
				}
				return gxTv_SdtSDT_Theme_Ctacolors;
			}
			set {
				gxTv_SdtSDT_Theme_Ctacolors_N = false;
				gxTv_SdtSDT_Theme_Ctacolors = value;
				SetDirty("Ctacolors");
			}
		}

		public void gxTv_SdtSDT_Theme_Ctacolors_SetNull()
		{
			gxTv_SdtSDT_Theme_Ctacolors_N = true;
			gxTv_SdtSDT_Theme_Ctacolors = null;
		}

		public bool gxTv_SdtSDT_Theme_Ctacolors_IsNull()
		{
			return gxTv_SdtSDT_Theme_Ctacolors == null;
		}
		public bool ShouldSerializegxTpr_Ctacolors_GxSimpleCollection_Json()
		{
			return gxTv_SdtSDT_Theme_Ctacolors != null && gxTv_SdtSDT_Theme_Ctacolors.Count > 0;
		...
		protected bool gxTv_SdtSDT_Theme_Ctacolors_N;
		protected GXBaseCollection<SdtSDT_Theme_CtaColorsItem> gxTv_SdtSDT_Theme_Ctacolors = null; 
	...
	[DataContract(Name=@"SDT_Theme", Namespace="Comforta_version21")]
	public class SdtSDT_Theme_RESTInterface : GxGenericCollectionItem<SdtSDT_Theme>, System.Web.SessionState.IRequiresSessionState
	{
		...
		public GxGenericCollection<SdtSDT_Theme_CtaColorsItem_RESTInterface> gxTpr_Ctacolors
		{
			get {
				if (sdt.ShouldSerializegxTpr_Ctacolors_GxSimpleCollection_Json())
					return new GxGenericCollection<SdtSDT_Theme_CtaColorsItem_RESTInterface>(sdt.gxTpr_Ctacolors);
				else
					return null;
