...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsunderlinewc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsunderlinewc.aspx"+UrlEncode(StringUtil.RTrim(AV25WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
      ...
      private void E131F2( )
      {
         ...
         returnInSub = false;
         AV29GXV2 = 1;
         while ( AV29GXV2 <= AV19WizardStepsAux.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV29GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562016572164", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsunderlinewc.js", "?202562016572164", false, true);
         }
      ...
      protected void sendrow_92( )
      {
         ...
         GridwizardstepsRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkavAllowclick_Internalname,StringUtil.BoolToStr( AV27AllowClick),(string)"",context.GetMessage( "Allow Click", ""),chkavAllowclick.Visible,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)""});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
         GridwizardstepsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("TBLCONTAINERSTEP.CLICK","""{"handler":"E111F2","iparms":[{"av":"AV27AllowClick","fld":"vALLOWCLICK"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV25WebSessionKey","fld":"vWEBSESSIONKEY"},{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true}]}""");
