...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   public class wwp_masterpagenotificationswc : GXWebComponent
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 30), "GRIDSDTNOTIFICATIONSDATAS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "NOTIFICATIONITEM.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              {
                                 AV6SDTNotificationsData.CurrentItem = ((WorkWithPlus.workwithplus_notificationscommon.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)AV6SDTNotificationsData.Item(AV9GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void gxgrGridsdtnotificationsdatas_refresh( GXBaseCollection<WorkWithPlus.workwithplus_notificationscommon.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem> AV6SDTNotificationsData ,
      ...
      private void E151R2( )
      {
         ...
         {
            AV6SDTNotificationsData.CurrentItem = ((WorkWithPlus.workwithplus_notificationscommon.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)AV6SDTNotificationsData.Item(AV9GXV1));
            lblNotificationitemicon_Caption = StringUtil.Format( "<i class='%1'></i>", ((WorkWithPlus.workwithplus_notificationscommon.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem)(AV6SDTNotificationsData.CurrentItem)).gxTpr_Notificationiconclass, "", "", "", "", "", "", "", "");
            /* Load Method */
            if ( wbStart != -1 )
            {
               wbStart = 15;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025630933394", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/notifications/common/wwp_masterpagenotificationswc.js", "?2025630933394", false, true);
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_notificationscommon.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem> AV6SDTNotificationsData ;
      private GXBaseCollection<WorkWithPlus.workwithplus_notificationscommon.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem> GXt_objcol_SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem1 ;
