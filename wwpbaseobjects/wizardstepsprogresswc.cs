...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsprogresswc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsprogresswc.aspx"+UrlEncode(StringUtil.RTrim(AV12WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
      ...
      protected void E111H2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV7SelectedStepNumber), "ZZZ9"), context));
         AV13GXV1 = 1;
         while ( AV13GXV1 <= AV9WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.Item(AV13GXV1));
      ...
      private void E121H2( )
      {
         ...
         returnInSub = false;
         AV14GXV2 = 1;
         while ( AV14GXV2 <= AV9WizardSteps.Count )
         {
            AV9WizardSteps.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV9WizardSteps.Item(AV14GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562016572083", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsprogresswc.js", "?202562016572084", false, true);
         }
      ...
      {
         AV9WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Comforta_version2");
