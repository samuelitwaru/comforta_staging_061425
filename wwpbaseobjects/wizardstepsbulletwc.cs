...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsbulletwc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsbulletwc.aspx"+UrlEncode(StringUtil.RTrim(AV24WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "TBLCONTAINERSTEP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV26GXV1 = nGXsfl_5_idx;
                              if ( ( AV18WizardStepsAux.Count >= AV26GXV1 ) && ( AV26GXV1 > 0 ) )
                              {
                                 AV18WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.Item(AV26GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void E12172( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV12SelectedStepNumber), "ZZZ9"), context));
         AV28GXV3 = 1;
         while ( AV28GXV3 <= AV17WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV17WizardSteps.Item(AV28GXV3));
      ...
      private void E13172( )
      {
         ...
         returnInSub = false;
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV18WizardStepsAux.Count )
         {
            AV18WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.Item(AV26GXV1));
      ...
      {
         AV26GXV1 = nGXsfl_5_idx;
         if ( ( AV26GXV1 > 0 ) && ( AV18WizardStepsAux.Count >= AV26GXV1 ) )
         {
            AV18WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardStepsAux.Item(AV26GXV1));
         }
         ...
         if ( ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV18WizardStepsAux.CurrentItem)).gxTpr_Code, AV6CurrentStep) != 0 ) && ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV18WizardStepsAux.CurrentItem)).gxTpr_Allowclick )
         {
            AV25ClickedIndex = 1;
            AV29GXV4 = 1;
            while ( AV29GXV4 <= AV17WizardSteps.Count )
            {
               AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV17WizardSteps.Item(AV29GXV4));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562016572256", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsbulletwc.js", "?202562016572256", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E13172","iparms":[{"av":"AV15StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV12SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV18WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"hsh":true},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5},{"av":"AV14StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV20WizardStepsCount","fld":"vWIZARDSTEPSCOUNT","pic":"ZZZ9","hsh":true},{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"},{"av":"AV7FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true},{"av":"AV8LastIsDummy","fld":"vLASTISDUMMY","hsh":true},{"av":"AV17WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV10PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true}]""");
         ...
         setEventMetadata("TBLCONTAINERSTEP.CLICK","""{"handler":"E11172","iparms":[{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"},{"av":"AV18WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"hsh":true},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5},{"av":"AV17WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV24WebSessionKey","fld":"vWEBSESSIONKEY"}]}""");
      ...
      {
         AV17WizardSteps = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Comforta_version2");
         wcpOAV24WebSessionKey = "";
         wcpOAV6CurrentStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV18WizardStepsAux = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Comforta_version2");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
