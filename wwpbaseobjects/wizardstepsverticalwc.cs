...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsverticalwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV26WebSessionKey,(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV18WizardSteps,(string)AV6CurrentStep});
                  componentstart();
      ...
      protected void gxgrGridwizardsteps_refresh_invoke( )
      {
         ...
         gxgrGridwizardsteps_refresh( AV18WizardSteps, AV15StepNumber, AV13SelectedStepNumber, AV6CurrentStep, AV19WizardStepsAux, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsverticalwc.aspx"+UrlEncode(StringUtil.RTrim(AV26WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV6CurrentStep));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "TBLCONTAINERSTEP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV25AllowClick = StringUtil.StrToBool( cgiGet( chkavAllowclick_Internalname));
                              AssignAttri(sPrefix, false, chkavAllowclick_Internalname, AV25AllowClick);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void gxgrGridwizardsteps_refresh( GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV18WizardSteps ,
                                                  short AV15StepNumber ,
                                                  short AV13SelectedStepNumber ,
                                                  string AV6CurrentStep ,
                                                  GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem> AV19WizardStepsAux ,
                                                  string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void E121E2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV13SelectedStepNumber), "ZZZ9"), context));
         AV28GXV1 = 1;
         while ( AV28GXV1 <= AV18WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV28GXV1));
      ...
      private void E131E2( )
      {
         ...
         returnInSub = false;
         AV29GXV2 = 1;
         while ( AV29GXV2 <= AV18WizardSteps.Count )
         {
            AV5WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV29GXV2));
            ...
            AV25AllowClick = (bool)(AV5WizardStep.gxTpr_Allowclick&&(StringUtil.StrCmp(AV5WizardStep.gxTpr_Code, AV6CurrentStep)!=0));
            AssignAttri(sPrefix, false, chkavAllowclick_Internalname, AV25AllowClick);
            divTblcontainerstep_Class = "Flex";
      ...
      protected void E111E2( )
      {
         ...
         if ( AV25AllowClick )
         {
            AV27ClickedIndex = (short)(Math.Round(NumberUtil.Val( lblStepnumber_Caption, "."), 18, MidpointRounding.ToEven));
            if ( ( AV27ClickedIndex > 0 ) && ( AV27ClickedIndex <= AV18WizardSteps.Count ) )
            {
               this.executeExternalObjectMethod(sPrefix, false, "GlobalEvents", "Wizard_ChangeStep", new Object[] {(string)AV26WebSessionKey,(short)AV27ClickedIndex,((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Code}, true);
            }
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         wcpOAV26WebSessionKey = cgiGet( sPrefix+"wcpOAV26WebSessionKey");
         wcpOAV6CurrentStep = cgiGet( sPrefix+"wcpOAV6CurrentStep");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV26WebSessionKey, wcpOAV26WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV6CurrentStep, wcpOAV6CurrentStep) != 0 ) ) )
         {
            setjustcreated();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202571111444896", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsverticalwc.js", "?202571111444896", false, true);
         }
      ...
      protected void sendrow_92( )
      {
         ...
         GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
         /* Div Control */
         GridwizardstepsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divTblcontainerstep_Internalname+"_"+sGXsfl_9_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)divTblcontainerstep_Class,(string)"start",(string)"top",(string)" "+"data-gx-flex"+" ",(string)"",(string)"div"});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
         /* Div Control */
         ...
         GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
         /* Attribute/Variable Label */
         GridwizardstepsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)chkavAllowclick_Internalname,context.GetMessage( "Allow Click", ""),(string)"gx-form-item AttributeLabel",(short)0,(bool)true,(string)"width: 25%;"});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
         /* Check box */
         ...
         chkavAllowclick.Caption = context.GetMessage( "Allow Click", "");
         ...
         GridwizardstepsRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkavAllowclick_Internalname,StringUtil.BoolToStr( AV25AllowClick),(string)"",context.GetMessage( "Allow Click", ""),chkavAllowclick.Visible,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)""});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridwizardstepsRow.AddRenderProperties(GridwizardstepsColumn);
         GridwizardstepsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void StartGridControl9( )
      {
         ...
         else
         {
            ...
            GridwizardstepsContainer.AddColumnProperties(GridwizardstepsColumn);
            GridwizardstepsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridwizardstepsColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( AV25AllowClick)));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"GRIDWIZARDSTEPS_nEOF"},{"av":"chkavAllowclick.Visible","ctrl":"vALLOWCLICK","prop":"Visible"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"},{"av":"sPrefix"},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV13SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true}]}""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E131E2","iparms":[{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV13SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true},{"av":"AV6CurrentStep","fld":"vCURRENTSTEP"}]""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD",""","oparms":[{"av":"AV22WizardStepTitle","fld":"vWIZARDSTEPTITLE"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"divUnnamedtablefsgridwizardsteps_Class","ctrl":"UNNAMEDTABLEFSGRIDWIZARDSTEPS","prop":"Class"},{"av":"AV25AllowClick","fld":"vALLOWCLICK"},{"av":"divTblcontainerstep_Class","ctrl":"TBLCONTAINERSTEP","prop":"Class"},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("TBLCONTAINERSTEP.CLICK","""{"handler":"E111E2","iparms":[{"av":"AV25AllowClick","fld":"vALLOWCLICK"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV26WebSessionKey","fld":"vWEBSESSIONKEY"},{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true}]}""");
      ...
      private short AV27ClickedIndex ;
