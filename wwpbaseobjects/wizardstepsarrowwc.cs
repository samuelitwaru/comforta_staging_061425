   ...
   public class wizardstepsarrowwc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV22WebSessionKey,(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV18WizardSteps,(string)AV11SelectedStep});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsarrowwc.aspx"+UrlEncode(StringUtil.RTrim(AV22WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV11SelectedStep));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "TBLCONTAINERSTEP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              {
                                 AV19WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV24GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
      ...
      protected void E12162( )
      {
         ...
         if ( AV19WizardStepsAux.Count > AV7MaxStepsToShow )
         {
            ...
            {
               AV17WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV26GXV3));
      ...
      private void E13162( )
      {
         ...
         while ( AV24GXV1 <= AV19WizardStepsAux.Count )
         {
            ...
            if ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Code, AV11SelectedStep) == 0 )
            {
            ...
            if ( ! ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Allowclick || ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Code, AV11SelectedStep) == 0 ) )
            {
               AV16TableContainerStepClass += " CursorDefault";
            }
      ...
      {
         AV24GXV1 = nGXsfl_5_idx;
         if ( ( AV24GXV1 > 0 ) && ( AV19WizardStepsAux.Count >= AV24GXV1 ) )
         {
            AV19WizardStepsAux.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV24GXV1));
         }
         /* Tblcontainerstep_Click Routine */
         returnInSub = false;
         if ( ( StringUtil.StrCmp(((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Code, AV11SelectedStep) != 0 ) && ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Allowclick )
         {
            AV23ClickedIndex = 1;
            AV27GXV4 = 1;
            while ( AV27GXV4 <= AV18WizardSteps.Count )
            {
               AV17WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV27GXV4));
               if ( StringUtil.StrCmp(AV17WizardStep.gxTpr_Code, ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Code) == 0 )
               {
                  if (true) break;
               }
               AV23ClickedIndex = (short)(AV23ClickedIndex+1);
               AV27GXV4 = (int)(AV27GXV4+1);
            }
            if ( AV23ClickedIndex <= AV18WizardSteps.Count )
            {
               this.executeExternalObjectMethod(sPrefix, false, "GlobalEvents", "Wizard_ChangeStep", new Object[] {(string)AV22WebSessionKey,(short)AV23ClickedIndex,((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)(AV19WizardStepsAux.CurrentItem)).gxTpr_Code}, true);
            }
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AV11SelectedStep = (string)getParm(obj,2);
         AssignAttri(sPrefix, false, "AV11SelectedStep", AV11SelectedStep);
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV11SelectedStep = (string)((string)getParm(obj,2));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AV11SelectedStep = (string)getParm(obj,4);
            AssignAttri(sPrefix, false, "AV11SelectedStep", AV11SelectedStep);
         }
         wcpOAV22WebSessionKey = cgiGet( sPrefix+"wcpOAV22WebSessionKey");
         wcpOAV11SelectedStep = cgiGet( sPrefix+"wcpOAV11SelectedStep");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(AV22WebSessionKey, wcpOAV22WebSessionKey) != 0 ) || ( StringUtil.StrCmp(AV11SelectedStep, wcpOAV11SelectedStep) != 0 ) ) )
         {
            setjustcreated();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309334147", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsarrowwc.js", "?20256309334147", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("TBLCONTAINERSTEP.CLICK","""{"handler":"E11162","iparms":[{"av":"AV11SelectedStep","fld":"vSELECTEDSTEP"},{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"hsh":true},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS"},{"av":"AV22WebSessionKey","fld":"vWEBSESSIONKEY"}]}""");
      ...
      private short AV23ClickedIndex ;
