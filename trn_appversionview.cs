...
namespace GeneXus.Programs {
   public class trn_appversionview : GXDataArea
   {
      public trn_appversionview( )
      {
      ...
      public trn_appversionview( IGxContext context )
      {
      ...
      {
         get {
            return "trn_appversionview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_appversionview.aspx"+UrlEncode(AV10AppVersionId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_appversionview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAPPVERSIONID", AV10AppVersionId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vAPPVERSIONID", GetSecureSignedToken( "", AV10AppVersionId, context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Pagewc == null ) )
         {
            WebComp_Pagewc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_appversionview.aspx"+UrlEncode(AV10AppVersionId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_appversionview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_AppVersionView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_App Version View", "") ;
      }
      ...
      protected void WBB70( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Trn_App Version", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_AppVersionView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_appversiongeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPage_title_Internalname, context.GetMessage( "Page", ""), "", "", lblPage_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_AppVersionView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Page") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablepage_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Pagewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Pagewc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldPagewc), StringUtil.Lower( WebComp_Pagewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Pagewc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldPagewc), StringUtil.Lower( WebComp_Pagewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void STARTB72( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_App Version View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldPagewc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldPagewc) == 0 ) || ( StringUtil.StrCmp(OldPagewc, WebComp_Pagewc_Component) != 0 ) )
                           {
                              WebComp_Pagewc = getWebComponent(GetType(), "GeneXus.Programs", OldPagewc, new Object[] {context} );
                              WebComp_Pagewc.ComponentInit();
                              WebComp_Pagewc.Name = "OldPagewc";
                              WebComp_Pagewc_Component = OldPagewc;
                           }
                           if ( StringUtil.Len( WebComp_Pagewc_Component) != 0 )
                           {
                              WebComp_Pagewc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Pagewc_Component = OldPagewc;
                        }
                        else if ( nCmpId == 42 )
      ...
      protected void PAB72( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_appversionview.aspx")), "trn_appversionview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_appversionview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10AppVersionId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10AppVersionId", AV10AppVersionId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vAPPVERSIONID", GetSecureSignedToken( "", AV10AppVersionId, context));
      ...
      protected void RFB72( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A523AppVersionId = H00B72_A523AppVersionId[0];
               /* Execute user event: Load */
               E16B72 ();
      ...
      protected void send_integrity_lvl_hashesB72( )
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV14RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV16IsAuthorized_Discussions);
      ...
      protected void E14B72( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_appversionww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00B73 */
         pr_default.execute(1, new Object[] {AV10AppVersionId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A523AppVersionId = H00B73_A523AppVersionId[0];
            A524AppVersionName = H00B73_A524AppVersionName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A524AppVersionName;
      ...
      protected void E15B72( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_AppVersion",  StringUtil.Trim( A523AppVersionId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_AppVersion",  2) )
         {
      ...
      protected void E11B72( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_AppVersion",(short)2,StringUtil.Trim( A523AppVersionId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12B72( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_AppVersion",StringUtil.Trim( A523AppVersionId.ToString()),(string)AV14RecordDescription,formatLink("trn_appversionview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_AppVersionGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_appversiongeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_AppVersionGeneral";
            WebComp_Webcomponent_general_Component = "Trn_AppVersionGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10AppVersionId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Page") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Pagewc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Pagewc_Component), StringUtil.Lower( "Trn_AppVersionPageWC")) != 0 )
            {
               WebComp_Pagewc = getWebComponent(GetType(), "GeneXus.Programs", "trn_appversionpagewc", new Object[] {context} );
               WebComp_Pagewc.ComponentInit();
               WebComp_Pagewc.Name = "Trn_AppVersionPageWC";
               WebComp_Pagewc_Component = "Trn_AppVersionPageWC";
            }
            if ( StringUtil.Len( WebComp_Pagewc_Component) != 0 )
            {
               WebComp_Pagewc.setjustcreated();
               WebComp_Pagewc.componentprepare(new Object[] {(string)"W0037",(string)"",(Guid)AV10AppVersionId});
               WebComp_Pagewc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Pagewc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Pagewc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10AppVersionId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10AppVersionId", AV10AppVersionId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vAPPVERSIONID", GetSecureSignedToken( "", AV10AppVersionId, context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Pagewc == null ) )
         {
            if ( StringUtil.Len( WebComp_Pagewc_Component) != 0 )
            {
               WebComp_Pagewc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017144641", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_appversionview.js", "?202562017144642", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_appversiongeneral_cell_Internalname = "TRN_APPVERSIONGENERAL_CELL";
         lblPage_title_Internalname = "PAGE_TITLE";
         divUnnamedtablepage_Internalname = "UNNAMEDTABLEPAGE";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_App Version View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A523AppVersionId","fld":"APPVERSIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10AppVersionId","fld":"vAPPVERSIONID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11B72","iparms":[{"av":"A523AppVersionId","fld":"APPVERSIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12B72","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A523AppVersionId","fld":"APPVERSIONID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13B72","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10AppVersionId","fld":"vAPPVERSIONID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"PAGEWC"}]}""");
         return  ;
      }
      ...
      {
         wcpOAV10AppVersionId = Guid.Empty;
         wcpOAV8TabCode = "";
         ...
         lblPage_title_Jsonclick = "";
         WebComp_Pagewc_Component = "";
         OldPagewc = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00B72_A523AppVersionId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00B73_A523AppVersionId = new Guid[] {Guid.Empty} ;
         H00B73_A524AppVersionName = new string[] {""} ;
         A524AppVersionName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_appversionview__default(),
            new Object[][] {
                new Object[] {
               H00B72_A523AppVersionId
               }
               , new Object[] {
               H00B73_A523AppVersionId, H00B73_A524AppVersionName
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Pagewc = new GeneXus.Http.GXNullWebComponent();
      ...
      private string divTrn_appversiongeneral_cell_Internalname ;
      ...
      private string lblPage_title_Internalname ;
      private string lblPage_title_Jsonclick ;
      private string divUnnamedtablepage_Internalname ;
      private string WebComp_Pagewc_Component ;
      private string OldPagewc ;
      ...
      private Guid[] H00B72_A523AppVersionId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00B73_A523AppVersionId ;
      private string[] H00B73_A524AppVersionName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_appversionview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00B72", "SELECT AppVersionId FROM Trn_AppVersion WHERE AppVersionId = :AV10AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B72,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00B73", "SELECT AppVersionId, AppVersionName FROM Trn_AppVersion WHERE AppVersionId = :AV10AppVersionId ORDER BY AppVersionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B73,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
