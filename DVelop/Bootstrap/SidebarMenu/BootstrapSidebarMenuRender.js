function BootstrapSidebarMenu(n) {
  function t(i, r) {
    ...
    u instanceof Object && u.length > 0
  ...
  this.SetSidebarMenuOptionsDataOptionsData = function (n) {
    n != undefined &&
      ...
      this.needExecShow ||
        ((this.SidebarMenuOptionsData == undefined ||
          this.SidebarMenuOptionsData.length != n.length ||
          JSON.stringify(this.SidebarMenuOptionsData, null, 2) !=
            JSON.stringify(n, null, 2)) &&
          (this.needExecShow = !0)),
      (this.SidebarMenuOptionsData = n));
  };
  ...
  this.SetSidebarMenuUserData = function (n) {
    n != undefined &&
      (this.needExecShow ||
        ((this.SidebarMenuUserData == undefined ||
          JSON.stringify(this.SidebarMenuUserData, null, 2) !=
            JSON.stringify(n, null, 2)) &&
          (this.needExecShow = !0)),
      (this.SidebarMenuUserData = n));
  };
  ...
  this.show = function () {
    ...
    if (
      ((this.HasMenuSearch =
        this.SearchServiceUrl && this.SearchServiceUrl != ""),
      this.needExecShow || !this.IsPostBack || n(window).width() <= 767)
    )
      try {
        this.needExecShow = !1;
        ...
        l = !1;
        readCookie("DVelopBootstrap_SidebarMenu_State") == "C" &&
          ((l = !0), (b += " menu-compact"));
        t = '<div class="' + b + '" id="sidebar">';
        t += '<div class="sidebar-header">';
        this.SidebarMenuUserData != null &&
          this.SidebarMenuUserData != "" &&
          (this.SidebarMenuUserData.PhotoUri != "" ||
            this.SidebarMenuUserData.FirstLine != "" ||
            this.SidebarMenuUserData.SecondLine != "") &&
          ((t += '<div class="' + e + ' user-info">'),
          this.SidebarMenuUserData.PhotoUri != "" &&
            (t +=
              '<div><img src="' +
              this.SidebarMenuUserData.PhotoUri +
              '"></img></div>'),
          (t += '<div class="user-text">'),
          (t +=
            '<span class="user-info-first">' +
            this.SidebarMenuUserData.FirstLine +
            "</span><br>"),
          (t +=
            '<span class="user-info-second">' +
            this.SidebarMenuUserData.SecondLine +
            " </span>"),
          (t += "</div>"),
          (t += "</div>"));
        this.IncludeToggleButton &&
          this.ToggleButtonPosition == "Top" &&
          (t +=
            '<div class="' +
            e +
            ' show-hide-menu"><i class="' +
        ...
        this.HasMenuSearch &&
          ((t +=
            '<div class="' +
            e +
            '"><input type="text" id="sidebar_search_input" autocomplete="off" autocorrect="off" autocapitalize="off"  class="' +
            d +
            '" placeholder="' +
            gx.getMessage(this.SearchHelperDescription) +
            '" /><i class="' +
            g +
            '"></i><i class="searchreset fa-fw fa fa-times"></i>'),
          (t += "</div>"));
        t += "</div>";
        t += '<ul id="sidebar_ul" class="' + this._sidebarMenuClass + '">';
        r = this;
        this.SidebarMenuOptionsData != undefined &&
          this.SidebarMenuOptionsData.length > 0 &&
          ((f = !1),
          (a = !0),
          jQuery.each(this.SidebarMenuOptionsData, function (i, u) {
            var e, o;
            r.FirstLevelIsGrouping
              ? (f && (t += '<li class="menuGroupTitleDivider"></li>'),
                (e = u.subItems),
                e instanceof Object && e.length > 0
                  ? (f || a || (t += '<li class="menuGroupTitleDivider"></li>'),
                    (o =
                      u.tooltip != null && u.tooltip.trim() != ""
                        ? " title='" + WWP_replaceAll(u.tooltip, "'", "") + "'"
                        : ""),
                    (t +=
                    ...
                    (f = !0))
                  : ((t +=
                      "<li>" + r._sidebarMenuRecursiveLoad(i, u) + "</li>"),
                    (f = !1)),
                (a = !1))
              : (t += "<li>" + r._sidebarMenuRecursiveLoad(i, u) + "</li>");
          }));
        t += "</ul>";
        this.IncludeToggleButton &&
          this.ToggleButtonPosition == "Bottom" &&
          ((this.ToggleButtonClass = "fas fa-chevron-left"),
          (t += '<div class="sidebar-header ">'),
          (t +=
            '<div class="' +
            e +
            ' show-hide-menu sidebar-header-bottom"><i class="' +
            this.ToggleButtonClass +
            '"></i></div>'),
          (t += "</div>"));
        t += "</div>";
        ...
        if (
          ...
          jQuery("#sidebar_search_input").on("input", function () {
            if (this.value.length >= r.SearchMinChars)
              return r.onSearchExec(this.value);
            r.onSearchExec("");
          });
          n(n("#sidebar_search_input").get(0)).keydown(function (n) {
            if (n.keyCode == 13) return n.preventDefault(), !1;
          });
          n(".page-sidebar .sidebar-header-wrapper .searchreset").on(
            "click",
            function () {
        ...
        for (
          o = jQuery("div.page-container"),
            v = jQuery("div.page-sidebar"),
            o.length > 0 &&
              v.length > 0 &&
              ((s = o.children().get(0)),
              s &&
                s.id != "sidebar" &&
                ((k = n(s)), v.detach().prependTo(o), k.remove())),
            h = n("#sidebar_ul").get(0),
            nt = 0,
            c = 0;
          c < h.childNodes.length;
          c++
        ) {
          y = h.childNodes[c];
          n(y).on(
            ...
            (function (t) {
              n(t).css("opacity") == "1" &&
                (t.removeAttribute("ch"), n(t).css("height", ""));
            })(y)
          );
        }
        if (
          ...
          this.display(),
          n(".page-content").addClass("sidebarmenu-transtion"),
          n("#sidebar").addClass("sidebarmenu-transtion"),
          l &&
            this.FirstLevelIsGrouping &&
            n(h).find(".menuGroupTitle").css("display", "none"),
          this.AllMenuItemsVisibleAtLoad && i(),
          this.IncludeToggleButton)
        )
          n(".page-sidebar .show-hide-menu").on("click", function () {
            r.CollapseExpand();
          });
        this.ScrollWidth > 0 &&
          ((r = this),
      ...
      (p = readCookie("DVelopBootstrap_SidebarMenuSelected") || 0),
        (u = this.getActiveItem()),
        p != u &&
          (this.setInactiveItem(p),
          this.setActiveItem(this.SelectedItem),
          u && u != "" && this.openItem(u),
          this.IsScrollVisible() &&
            ((this.scrollTop = -1), this.updateSlimscroll(!0)));
  };
  this.IsScrollVisible = function () {
    return (
      this.ScrollWidth > 0 &&
      (!n("#sidebar").hasClass("menu-compact") || !this.HideScrollInCompactMenu)
    );
  };
  this.updateScrollBottomSpace = function () {
    ...
    t != null &&
      ...
      n("#sidebar").hasClass("menu-compact") &&
        ...
        u != null &&
          ((i = n(u).height()),
          i > parseInt(n(t).css("margin-bottom")) && (r = i))),
      n(t).css("transition", "margin-bottom 0.2s"),
      n(t).css("margin-bottom", r));
  };
      ...
      if (!t.hasClass("menu-dropdown")) {
        ...
        if (i) {
          ...
          if (
            ...
            n(i.target).closest("a").attr("href") == "#"
          )
            return !1;
        }
        return;
  ...
  this._sidebarMenuRecursiveLoad = function (t, i) {
    ...
    return (
      ...
      (r = i.subItems),
      (u =
        i.tooltip != null && i.tooltip.trim() != ""
          ? " title='" + WWP_replaceAll(i.tooltip, "'", "") + "'"
          : ""),
      r instanceof Object && r.length > 0
        ? ((_buffer +=
          ...
          (_buffer += "</ul>"))
        : ((_link = i.link || "#"),
          (_linkTarget = i.linkTarget || ""),
          (i.id = jQuery.trim(i.id)),
          (_activeClass = ""),
          i.id === jQuery.trim(this.getActiveItem()) &&
            (_activeClass = "active"),
          (_buffer +=
            '<li class="' +
            _activeClass +
            ...
            i.id +
            '"'),
          _link != "#" && (_buffer += ' target="' + _linkTarget + '"'),
          (_buffer += u + ">"),
          i.iconClass &&
            i.iconClass != "" &&
            (_buffer += '<i class="' + i.iconClass + '"></i>'),
          (_buffer +=
            '<span class="menu-text">' + i.caption + "</span></a></li>")),
      _buffer
    );
  };
        ...
        s ||
          (t =
            t.normalize != null
              ...
              : t),
          f = 0;
        f < u.childNodes.length;
        f++
      )
        (e = u.childNodes[f]),
          e.childNodes.length > 0 && n(e).find("> a > span").length > 0
            ? this.onSearchOptionMatches(e, t) &&
              (r != -1 &&
                (!o || n(u.childNodes[r]).hasClass("menuGroupTitle")
                  ? n(u.childNodes[r]).slideDown(200)
                  : n(u.childNodes[r]).slideUp(200),
                this.LiIsGroupTitle(u, r + 1) &&
                  n(u.childNodes[r + 1]).slideDown(200),
                (r = -1)),
              (o = !1))
            : this.LiIsGroupTitle(u, f) &&
              (s
                ? h == "C" && n(e).hasClass("menuGroupTitle")
                  ? n(e).slideUp(200)
                  : n(e).slideDown(200)
                : (r != -1 &&
                    (n(u.childNodes[r]).slideUp(200),
                    this.LiIsGroupTitle(u, r + 1) &&
                      n(u.childNodes[r + 1]).slideUp(200)),
                  (r = f),
                  this.LiIsGroupTitle(u, f + 1) && f++));
      r != -1 &&
        (n(u.childNodes[r]).slideUp(200),
        this.LiIsGroupTitle(u, r + 1) && n(u.childNodes[r + 1]).slideUp(200));
      this.AllMenuItemsVisibleAtLoad && i();
    } catch (c) {
  ...
  this.LiIsGroupTitle = function (t, i) {
    return (
      ...
      (n(t.childNodes[i]).hasClass("menuGroupTitleDivider") ||
        n(t.childNodes[i]).hasClass("menuGroupTitle"))
    );
  };
  this.onSearchOptionMatches = function (t, i) {
    ...
    if (i != null && i.length > 0) {
      if (
        ((e = (
          u.normalize != null
            ? u.normalize("NFD").replace(/[\u0300-\u036f]/g, "")
            : u
        )
          .toLowerCase()
          .indexOf(i.toLowerCase())),
        e >= 0)
      ) {
        if (
          ((u =
            u.substring(0, e) +
            "<strong>" +
            u.substring(e, e + i.length) +
            "</strong>" +
            u.substring(e + i.length)),
          (s = o.getAttribute("dscSuffix")),
          (o.innerHTML = s != null ? u + s : u),
    ...
    if (
      ((o.innerHTML = u), n(t).slideDown(200), n(r).hasClass("menu-dropdown"))
    ) {
      n(t).removeClass("open");
      f = r.parentNode.getElementsByTagName("ul")[0];
      n(f).slideUp(200);
  ...
  this.onSearchSubMenuOptionMatches = function (t, i) {
    ...
    if (n(t).hasClass("menu-dropdown"))
      for (
        u = t.parentNode.getElementsByTagName("ul")[0], r = 0;
        r < u.childNodes.length;
        r++
      )
        (f = u.childNodes[r]),
          f.childNodes.length > 0 &&
            this.onSearchOptionMatches(f, i) &&
            (e = !0);
    return e;
  };
  ...
  this.findActiveItemByUrlRecursive = function (n) {
    ...
    jQuery.each(n, function (n, i) {
      var u = i.subItems,
        r;
      if (u instanceof Object && u.length > 0)
        t.findActiveItemByUrlRecursive(u);
      else if (
        i != null &&
        i.link != null &&
        ((r = i.link.split(" ").join("%20")),
        r.indexOf("/") == -1 && (r = "/" + r),
        window.location.href.length >= r.length &&
        ...
        return createCookie("DVelopBootstrap_SidebarMenuSelected", i.id), !1;
    });
  };
  this.setActiveItem = function (t) {
    ...
    i &&
      i.length > 0 &&
      (createCookie("DVelopBootstrap_SidebarMenuSelected", t),
  ...
  this.openItem = function (t) {
    ...
    t &&
      t != "" &&
      ((i = n(".page-sidebar a[id='" + jQuery.trim(t) + "']")),
      (r = n("#sidebar").hasClass("menu-compact")),
      !r &&
        i &&
        i.length == 1 &&
        ((u = i.parents("ul")),
  ...
  this.getA_scrollTop = function (t) {
    ...
    return i.length > 0
      ? ((r =
          n(window).height() -
          n(".sidebar-menu").offset().top +
          n(window).scrollTop()),
        i.is(":visible"),
        (u = i.offset().top),
        u != 0 && i.is(":visible")
          ? ((f =
              n(".sidebar-menu").scrollTop() +
              u -
              n(".sidebar-menu").offset().top),
            f + i[0].scrollHeight + 10 <= r
              ? 0
              : f - (r - i[0].scrollHeight) / 2)
          : 0)
      : 0;
  };
  this.display = function () {
    n(window).width() <= 500 &&
      ...
      n(".page-content").addClass("menu-compact"),
      n(".sidebar-toggler").toggleClass("active"),
  ...
  this.ExpandAux = function (t) {
    ...
    this.ScrollWidth > 0 &&
      (this.updateScrollBottomSpace(), this.updateSlimscroll(!0));
    ...
    if (f) {
      typeof ClearMinWidthPaginationBars == "function" &&
        ClearMinWidthPaginationBars();
      n(".gx-grid>table.TitleFixed>thead").css(
        "max-width",
        "calc(100% - 50px)"
      );
      n(".gx-grid>table.TitleFixed>tfoot").css(
        "max-width",
        "calc(100% - 50px)"
      );
      r = this;
  ...
  this.CollapseAux = function (t) {
    ...
    if (
      (createCookie("DVelopBootstrap_SidebarMenu_State", "C"),
      this.HasMenuSearch && (n("#sidebar_search_input").get(0).value = ""),
      !t && this.FirstLevelIsGrouping)
    )
      this.onSearchExec("");
    if (
      ((r = n("#sidebar").hasClass("menu-compact")),
      n("#sidebar").is(":visible") || n("#sidebar").addClass("hide"),
      n("#sidebar").addClass("menu-compact"),
      n(".sidebar-collapse").toggleClass("active"),
      (r = n("#sidebar").hasClass("menu-compact")),
      n(".page-content").addClass("menu-compact"),
      this.ScrollWidth > 0 &&
        (this.updateScrollBottomSpace(),
        this.HideScrollInCompactMenu
          ? this.removeSlimscroll()
          : this.updateSlimscroll(!0)),
      r && n(".open > .submenu").removeClass("open"),
      t || ((i = this.getActiveItem()), i && i != "" && this.openItem(i)),
      (f = n(".page-content").css("transition-duration") != "0s, 0s, 0s"),
      f)
    ) {
      u = this;
      this.resizeTriggered = !1;
  ...
  this.removeSlimscroll = function () {
    ...
    t.closest("div").hasClass("slimScrollDiv") &&
      (t.slimScroll({
        destroy: !0,
      }),
      t.attr("style", ""),
      t.parent().find(">.slimScrollRail").remove(),
      t.parent().find(">.slimScrollBar").remove());
  };
  this.createSlimscroll = function (t) {
    ...
    if (i.length > 0) {
      ...
      this.IncludeToggleButton &&
        this.ToggleButtonPosition == "Bottom" &&
        ((u = n(".sidebar-header-wrapper.show-hide-menu")),
        u.length == 1 &&
          (s =
            u.outerHeight() +
            parseInt(u.css("margin-top")) +
            parseInt(u.css("margin-bottom"))));
      f = n(window).height() - i.offset().top + n(window).scrollTop() - s;
      i.closest("div").hasClass("slimScrollDiv")
        ? (i.height(f - parseInt(i.css("padding-bottom"))),
          n(".slimScrollDiv").height(f))
        : ((e = i.parent().position()),
          (h =
            e != null && e.left != null && e.left > window.innerWidth / 2
              ? "right"
              : "left"),
          i.slimscroll({
            height: f,
      ...
      r.scrollTop == -1 &&
        ((r.scrollTop = 0),
        (o = r.getActiveItem()),
        o && o != "" && (r.scrollTop = r.getA_scrollTop(o)));
...
$(window).one("load", function () {
  WWP_VV([["GXBootstrap.SidebarMenu", "15.2.9"]]);
});
