...
namespace GeneXus.Programs {
   public class trn_supplieragbtypewwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV26GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  "Trn_SupplierAgbTypeWWGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRK6B2 = false;
            A256SupplierAgbTypeName = P006B2_A256SupplierAgbTypeName[0];
            A255SupplierAgbTypeId = P006B2_A255SupplierAgbTypeId[0];
            AV23count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P006B2_A256SupplierAgbTypeName[0], A256SupplierAgbTypeName) == 0 ) )
            {
               BRK6B2 = false;
               A255SupplierAgbTypeId = P006B2_A255SupplierAgbTypeId[0];
            ...
            if ( (0==AV14SkipItems) )
            {
               AV18Option = (String.IsNullOrEmpty(StringUtil.RTrim( A256SupplierAgbTypeName)) ? "<#Empty#>" : A256SupplierAgbTypeName);
      ...
      public override void initialize( )
      {
         ...
         A256SupplierAgbTypeName = "";
         P006B2_A256SupplierAgbTypeName = new string[] {""} ;
         P006B2_A255SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_supplieragbtypewwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P006B2_A256SupplierAgbTypeName, P006B2_A255SupplierAgbTypeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P006B2_A256SupplierAgbTypeName ;
      private Guid[] P006B2_A255SupplierAgbTypeId ;
   ...
   public class trn_supplieragbtypewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P006B2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
         }
