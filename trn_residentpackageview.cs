...
namespace GeneXus.Programs {
   public class trn_residentpackageview : GXDataArea
   {
      public trn_residentpackageview( )
      {
      ...
      public trn_residentpackageview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_ResidentPackageId ,
                           string aP1_TabCode )
      {
         this.AV10ResidentPackageId = aP0_ResidentPackageId;
      ...
      {
         get {
            return "trn_residentpackageview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_residentpackageview.aspx"+UrlEncode(AV10ResidentPackageId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_residentpackageview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_residentpackageview.aspx"+UrlEncode(AV10ResidentPackageId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_residentpackageview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_ResidentPackageView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Resident Package View", "") ;
      }

      protected void WBAD0( )
      {
         if ( context.isAjaxRequest( ) )
         {
            disableOutput();
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentPackageView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_resident_title_Internalname, context.GetMessage( "Residents", ""), "", "", lblTrn_resident_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentPackageView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0035"+"", StringUtil.RTrim( WebComp_Trn_residentwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void STARTAD2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Resident Package View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void WSAD2( )
      {
         STARTAD2( ) ;
         EVTAD2( ) ;
      }

      protected void EVTAD2( )
      {
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldTrn_residentwc = cgiGet( "W0035");
                           ...
                           if ( StringUtil.Len( WebComp_Trn_residentwc_Component) != 0 )
                           {
                              WebComp_Trn_residentwc.componentprocess("W0035", "", sEvt);
                           }
                           WebComp_Trn_residentwc_Component = OldTrn_residentwc;
                        }
                        else if ( nCmpId == 40 )
      ...
      protected void PAAD2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_residentpackageview.aspx")), "trn_residentpackageview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_residentpackageview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10ResidentPackageId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10ResidentPackageId", AV10ResidentPackageId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTPACKAGEID", GetSecureSignedToken( "", AV10ResidentPackageId, context));
      ...
      protected void RFAD2( )
      {
         ...
         {
            /* Using cursor H00AD2 */
            pr_default.execute(0, new Object[] {AV10ResidentPackageId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A527ResidentPackageId = H00AD2_A527ResidentPackageId[0];
               /* Execute user event: Load */
               E16AD2 ();
      ...
      protected void send_integrity_lvl_hashesAD2( )
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV14RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV16IsAuthorized_Discussions);
      ...
      protected void E15AD2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_ResidentPackage",  StringUtil.Trim( A527ResidentPackageId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_ResidentPackage",  2) )
         {
      ...
      protected void E16AD2( )
      {
         /* Load Routine */
         returnInSub = false;
      }

      protected void E11AD2( )
      {
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10ResidentPackageId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10ResidentPackageId", AV10ResidentPackageId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTPACKAGEID", GetSecureSignedToken( "", AV10ResidentPackageId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017141865", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentpackageview.js", "?202562017141865", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Resident Package View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10ResidentPackageId","fld":"vRESIDENTPACKAGEID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11AD2","iparms":[{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
      ...
      {
         wcpOAV10ResidentPackageId = Guid.Empty;
         wcpOAV8TabCode = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00AD2_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00AD3_A527ResidentPackageId = new Guid[] {Guid.Empty} ;
      ...
      private Guid wcpOAV10ResidentPackageId ;
      ...
      private Guid[] H00AD2_A527ResidentPackageId ;
   ...
   public class trn_residentpackageview__default : DataStoreHelperBase, IDataStoreHelper
   {
