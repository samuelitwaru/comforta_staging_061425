...
namespace GeneXus.Programs {
   public class trn_appversiongeneral : GXWebComponent
   {
      public trn_appversiongeneral( )
      {
      ...
      public trn_appversiongeneral( IGxContext context )
      {
      ...
      {
         this.A523AppVersionId = aP0_AppVersionId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A523AppVersionId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "Trn_AppVersionGeneral";
               WSBB2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Trn_App Version General", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_appversiongeneral.aspx"+UrlEncode(A523AppVersionId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_appversiongeneral.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA523AppVersionId", wcpOA523AppVersionId.ToString());
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      {
         return "Trn_AppVersionGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_App Version General", "") ;
      }
      ...
      protected void WBBB0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_appversiongeneral.aspx");
            }
            ...
            GxWebStd.gx_single_line_edit( context, edtAppVersionId_Internalname, A523AppVersionId.ToString(), A523AppVersionId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAppVersionId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAppVersionId_Enabled, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_AppVersionGeneral.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtAppVersionName_Internalname, A524AppVersionName, StringUtil.RTrim( context.localUtil.Format( A524AppVersionName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAppVersionName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAppVersionName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_AppVersionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtAppVersionLanguage_Internalname, A648AppVersionLanguage, StringUtil.RTrim( context.localUtil.Format( A648AppVersionLanguage, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAppVersionLanguage_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAppVersionLanguage_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_AppVersionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STARTBB2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Trn_App Version General", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_appversiongeneral.aspx")), "trn_appversiongeneral.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_appversiongeneral.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void STRUPBB0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA523AppVersionId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA523AppVersionId"));
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "Trn_AppVersion";
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA523AppVersionId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_appversiongeneral", GetJustCreated( ));
         ...
         {
            A523AppVersionId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A523AppVersionId", A523AppVersionId.ToString());
         }
         wcpOA523AppVersionId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA523AppVersionId"));
         if ( ! GetJustCreated( ) && ( ( A523AppVersionId != wcpOA523AppVersionId ) ) )
         {
            setjustcreated();
         }
         wcpOA523AppVersionId = A523AppVersionId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA523AppVersionId = cgiGet( sPrefix+"A523AppVersionId_CTRL");
         if ( StringUtil.Len( sCtrlA523AppVersionId) > 0 )
         {
            A523AppVersionId = StringUtil.StrToGuid( cgiGet( sCtrlA523AppVersionId));
            AssignAttri(sPrefix, false, "A523AppVersionId", A523AppVersionId.ToString());
         }
         else
         {
            A523AppVersionId = StringUtil.StrToGuid( cgiGet( sPrefix+"A523AppVersionId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A523AppVersionId_PARM", A523AppVersionId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA523AppVersionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A523AppVersionId_CTRL", StringUtil.RTrim( sCtrlA523AppVersionId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572320191870", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_appversiongeneral.js", "?202572320191870", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         AssignProp(sPrefix, false, chkIsActive_Internalname, "TitleCaption", chkIsActive.Caption, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A523AppVersionId","fld":"APPVERSIONID"},{"av":"A535IsActive","fld":"ISACTIVE"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E13BB2","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A523AppVersionId","fld":"APPVERSIONID"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E14BB2","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A523AppVersionId","fld":"APPVERSIONID"}]""");
         setEventMetadata("'DODELETE'",""","oparms":[{"ctrl":"BTNDELETE","prop":"Visible"}]}""");
         setEventMetadata("VALID_APPVERSIONID","""{"handler":"Valid_Appversionid","iparms":[]}""");
         return  ;
      }
      ...
      {
         wcpOA523AppVersionId = Guid.Empty;
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV15Pgmname = "";
      ...
      private string sCtrlA523AppVersionId ;
   ...
   public class trn_appversiongeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
