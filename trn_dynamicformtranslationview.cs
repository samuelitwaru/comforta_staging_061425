...
namespace GeneXus.Programs {
   public class trn_dynamicformtranslationview : GXDataArea
   {
      public trn_dynamicformtranslationview( )
      {
      ...
      public trn_dynamicformtranslationview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_DynamicFormTranslationId ,
                           string aP1_TabCode )
      {
         this.AV10DynamicFormTranslationId = aP0_DynamicFormTranslationId;
      ...
      {
         get {
            return "trn_dynamicformtranslationview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_dynamicformtranslationview.aspx"+UrlEncode(AV10DynamicFormTranslationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_dynamicformtranslationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vDYNAMICFORMTRANSLATIONID", AV10DynamicFormTranslationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vDYNAMICFORMTRANSLATIONID", GetSecureSignedToken( "", AV10DynamicFormTranslationId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_dynamicformtranslationview.aspx"+UrlEncode(AV10DynamicFormTranslationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_dynamicformtranslationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_DynamicFormTranslationView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Dynamic Form Translation View", "") ;
      }

      protected void WBBE0( )
      {
         if ( context.isAjaxRequest( ) )
         {
            disableOutput();
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Trn_Dynamic Form Translation", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_DynamicFormTranslationView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_dynamicformtranslationgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void STARTBE2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Dynamic Form Translation View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void WSBE2( )
      {
         STARTBE2( ) ;
         EVTBE2( ) ;
      }

      protected void EVTBE2( )
      {
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
      ...
      protected void PABE2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_dynamicformtranslationview.aspx")), "trn_dynamicformtranslationview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_dynamicformtranslationview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10DynamicFormTranslationId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10DynamicFormTranslationId", AV10DynamicFormTranslationId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vDYNAMICFORMTRANSLATIONID", GetSecureSignedToken( "", AV10DynamicFormTranslationId, context));
      ...
      protected void RFBE2( )
      {
         ...
         {
            /* Using cursor H00BE2 */
            pr_default.execute(0, new Object[] {AV10DynamicFormTranslationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A585DynamicFormTranslationId = H00BE2_A585DynamicFormTranslationId[0];
               /* Execute user event: Load */
               E15BE2 ();
      ...
      protected void send_integrity_lvl_hashesBE2( )
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV14RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV16IsAuthorized_Discussions);
      ...
      protected void E13BE2( )
      {
         /* Start Routine */
         returnInSub = false;
         new GeneXus.Programs.wwpbaseobjects.loadwwpcontext(context ).execute( out  AV6WWPContext) ;
         lblWorkwithlink_Link = formatLink("trn_dynamicformtranslationww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00BE3 */
         pr_default.execute(1, new Object[] {AV10DynamicFormTranslationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A585DynamicFormTranslationId = H00BE3_A585DynamicFormTranslationId[0];
            A586DynamicFormTranslationWWpFormI = H00BE3_A586DynamicFormTranslationWWpFormI[0];
            AV17GXLvl9 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A586DynamicFormTranslationWWpFormI), 6, 0);
      ...
      protected void E14BE2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_DynamicFormTranslation",  StringUtil.Trim( A585DynamicFormTranslationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_DynamicFormTranslation",  2) )
         {
      ...
      protected void E15BE2( )
      {
         /* Load Routine */
         returnInSub = false;
      }

      protected void E11BE2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_DynamicFormTranslation",(short)2,StringUtil.Trim( A585DynamicFormTranslationId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12BE2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_DynamicFormTranslation",StringUtil.Trim( A585DynamicFormTranslationId.ToString()),(string)AV14RecordDescription,formatLink("trn_dynamicformtranslationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_DynamicFormTranslationGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_dynamicformtranslationgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_DynamicFormTranslationGeneral";
            WebComp_Webcomponent_general_Component = "Trn_DynamicFormTranslationGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10DynamicFormTranslationId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10DynamicFormTranslationId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10DynamicFormTranslationId", AV10DynamicFormTranslationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vDYNAMICFORMTRANSLATIONID", GetSecureSignedToken( "", AV10DynamicFormTranslationId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017145568", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_dynamicformtranslationview.js", "?202562017145569", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_dynamicformtranslationgeneral_cell_Internalname = "TRN_DYNAMICFORMTRANSLATIONGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Dynamic Form Translation View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A585DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10DynamicFormTranslationId","fld":"vDYNAMICFORMTRANSLATIONID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11BE2","iparms":[{"av":"A585DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12BE2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A585DynamicFormTranslationId","fld":"DYNAMICFORMTRANSLATIONID"}]""");
      ...
      {
         wcpOAV10DynamicFormTranslationId = Guid.Empty;
         wcpOAV8TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00BE2_A585DynamicFormTranslationId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00BE3_A585DynamicFormTranslationId = new Guid[] {Guid.Empty} ;
         H00BE3_A586DynamicFormTranslationWWpFormI = new int[1] ;
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_dynamicformtranslationview__default(),
            new Object[][] {
                new Object[] {
               H00BE2_A585DynamicFormTranslationId
               }
               , new Object[] {
               H00BE3_A585DynamicFormTranslationId, H00BE3_A586DynamicFormTranslationWWpFormI
               }
            }
         );
      ...
      private string divTrn_dynamicformtranslationgeneral_cell_Internalname ;
      ...
      private Guid AV10DynamicFormTranslationId ;
      private Guid wcpOAV10DynamicFormTranslationId ;
      ...
      private Guid[] H00BE2_A585DynamicFormTranslationId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00BE3_A585DynamicFormTranslationId ;
      private int[] H00BE3_A586DynamicFormTranslationWWpFormI ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_dynamicformtranslationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00BE2;
          prmH00BE2 = new Object[] {
          new ParDef("AV10DynamicFormTranslationId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00BE3;
          prmH00BE3 = new Object[] {
          new ParDef("AV10DynamicFormTranslationId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00BE2", "SELECT DynamicFormTranslationId FROM Trn_DynamicFormTranslation WHERE DynamicFormTranslationId = :AV10DynamicFormTranslationId ORDER BY DynamicFormTranslationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BE2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00BE3", "SELECT DynamicFormTranslationId, DynamicFormTranslationWWpFormI FROM Trn_DynamicFormTranslation WHERE DynamicFormTranslationId = :AV10DynamicFormTranslationId ORDER BY DynamicFormTranslationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BE3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
