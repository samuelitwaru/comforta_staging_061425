   ...
   public class trn_mediaview : GXDataArea
   {
      ...
      protected void RF6X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A413MediaId = H006X2_A413MediaId[0];
               /* Execute user event: Load */
               E156X2 ();
      ...
      protected void E136X2( )
      {
         ...
         {
            A413MediaId = H006X3_A413MediaId[0];
            A414MediaName = H006X3_A414MediaName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A414MediaName;
      ...
      protected void E146X2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Media",  StringUtil.Trim( A413MediaId.ToString())) )
         {
      ...
      protected void E116X2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Media",(short)2,StringUtil.Trim( A413MediaId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E126X2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Media",StringUtil.Trim( A413MediaId.ToString()),(string)AV14RecordDescription,formatLink("trn_mediaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256145425734", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_mediaview.js", "?20256145425735", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A413MediaId","fld":"MEDIAID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10MediaId","fld":"vMEDIAID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E116X2","iparms":[{"av":"A413MediaId","fld":"MEDIAID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E126X2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A413MediaId","fld":"MEDIAID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H006X2_A413MediaId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H006X3_A413MediaId = new Guid[] {Guid.Empty} ;
         H006X3_A414MediaName = new string[] {""} ;
         A414MediaName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_mediaview__default(),
            new Object[][] {
               ...
               , new Object[] {
               H006X3_A413MediaId, H006X3_A414MediaName
               }
            }
         );
      ...
      private Guid[] H006X2_A413MediaId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H006X3_A413MediaId ;
      private string[] H006X3_A414MediaName ;
   ...
   public class trn_mediaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006X2", "SELECT MediaId FROM Trn_Media WHERE MediaId = :AV10MediaId ORDER BY MediaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006X2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H006X3", "SELECT MediaId, MediaName FROM Trn_Media WHERE MediaId = :AV10MediaId ORDER BY MediaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006X3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
