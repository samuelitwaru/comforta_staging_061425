...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_MobileInfoPage.InfoContentItem" , Namespace="Comforta_version21" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_MobileInfoPage.InfoContentItem", Namespace="Comforta_version21")]
