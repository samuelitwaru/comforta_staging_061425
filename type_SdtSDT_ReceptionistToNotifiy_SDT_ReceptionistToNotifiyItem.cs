...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_ReceptionistToNotifiyItem" , Namespace="Comforta_version21" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_ReceptionistToNotifiyItem", Namespace="Comforta_version21")]
