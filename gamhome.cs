...
namespace GeneXus.Programs {
   public class gamhome : GXHttpHandler
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAPPLICATIONHOMEOBJECT", StringUtil.RTrim( AV36ApplicationHomeObject));
         GxWebStd.gx_hidden_field( context, "gxhash_vAPPLICATIONHOMEOBJECT", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV36ApplicationHomeObject, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISJAVAENVIRONMENT", AV39isJavaEnvironment);
         GxWebStd.gx_hidden_field( context, "gxhash_vISJAVAENVIRONMENT", GetSecureSignedToken( "", AV39isJavaEnvironment, context));
         GxWebStd.gx_hidden_field( context, "vHTTPREQUEST_Baseurl", StringUtil.RTrim( AV40HttpRequest.BaseURL));
      }
      ...
      protected void E110R2( )
      {
         /* Start Routine */
         returnInSub = false;
         if ( new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV37GAMSEssion, out  AV38GAMError) && ! AV37GAMSEssion.gxTpr_Isanonymous )
         {
            AV35GAMApplication = new GeneXus.Programs.genexussecurity.SdtGAMApplication(context).get();
            AV42Id = (short)(AV35GAMApplication.gxTpr_Id);
            AssignAttri("", false, "AV42Id", StringUtil.LTrimStr( (decimal)(AV42Id), 4, 0));
            GxWebStd.gx_hidden_field( context, "gxhash_vID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV42Id), "ZZZ9"), context));
            if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV35GAMApplication.gxTpr_Homeobject)) && ( StringUtil.StrCmp(StringUtil.Lower( AV35GAMApplication.gxTpr_Homeobject), "gamhome") != 0 ) )
            {
      ...
      protected void E120R2( )
      {
         /* 'Confirm' Routine */
         returnInSub = false;
         AV35GAMApplication.load( AV42Id);
         AV35GAMApplication.gxTpr_Homeobject = AV36ApplicationHomeObject;
         AV35GAMApplication.save();
         if ( AV35GAMApplication.success() )
         {
      ...
      protected void E130R2( )
      {
         /* 'GoDevMenu' Routine */
         returnInSub = false;
         if ( AV39isJavaEnvironment )
         {
            AV41Url = GxRegex.Replace(AV40HttpRequest.BaseURL,"/servlet/","") + "/static/developermenu.html";
            CallWebObject(formatLink(AV41Url) );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20257212532437", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gamhome.js", "?20257212532439", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV42Id","fld":"vID","pic":"ZZZ9","hsh":true},{"av":"AV36ApplicationHomeObject","fld":"vAPPLICATIONHOMEOBJECT","hsh":true},{"av":"AV39isJavaEnvironment","fld":"vISJAVAENVIRONMENT","hsh":true}]}""");
         setEventMetadata("'CONFIRM'","""{"handler":"E120R2","iparms":[{"av":"AV42Id","fld":"vID","pic":"ZZZ9","hsh":true},{"av":"AV36ApplicationHomeObject","fld":"vAPPLICATIONHOMEOBJECT","hsh":true}]}""");
         setEventMetadata("'GODEVMENU'","""{"handler":"E130R2","iparms":[{"av":"AV39isJavaEnvironment","fld":"vISJAVAENVIRONMENT","hsh":true},{"av":"AV40HttpRequest.BaseURL","ctrl":"vHTTPREQUEST","prop":"Baseurl"}]}""");
         setEventMetadata("'GOBACKEND'","""{"handler":"E140R2","iparms":[{"av":"AV39isJavaEnvironment","fld":"vISJAVAENVIRONMENT","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV38GAMError = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
      ...
      private string AV36ApplicationHomeObject ;
      ...
      private bool AV39isJavaEnvironment ;
      private bool wbLoad ;
      private bool Rfr0gs ;
      private bool wbErr ;
      private bool gxdyncontrolsrefreshing ;
      private bool returnInSub ;
      private string AV41Url ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV38GAMError ;
