   ...
   public class trn_residentwwgetfilterdata : GXProcedure
   {
      ...
      protected void S121( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            ( StringUtil.Like( context.GetMessage( context.GetMessage( "gx_emptyitemtext", ""), "") , StringUtil.PadR( "%" + StringUtil.Lower( AV64Trn_residentwwds_1_filterfulltext) , 255 , "%"),  ' ' ) && String.IsNullOrEmpty(StringUtil.RTrim( A68ResidentGender)) ) ||
