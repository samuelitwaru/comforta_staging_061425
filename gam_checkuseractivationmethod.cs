   ...
   public class gam_checkuseractivationmethod : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(AV13Repository.gxTpr_Useractivationmethod, "U") == 0 )
         {
            ...
            AV14User.sendemailtoactivateaccount( AV8Application,  AV10LinkURL, out  AV17GAMErrorCollection);
            if ( AV17GAMErrorCollection.Count == 0 )
            {
            ...
            {
               new gam_converterrorstomessages(context ).execute(  AV17GAMErrorCollection, out  AV12Messages) ;
            }
         }
