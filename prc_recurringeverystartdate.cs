...
namespace GeneXus.Programs {
   public class prc_recurringeverystartdate : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A438AgendaCalendarRecurringType = P008S2_A438AgendaCalendarRecurringType[0];
            A437AgendaCalendarRecurring = P008S2_A437AgendaCalendarRecurring[0];
            A29LocationId = P008S2_A29LocationId[0];
            A270AgendaCalendarStartDate = P008S2_A270AgendaCalendarStartDate[0];
      ...
      public override void initialize( )
      {
         ...
         P008S2_A437AgendaCalendarRecurring = new bool[] {false} ;
         P008S2_A29LocationId = new Guid[] {Guid.Empty} ;
         P008S2_A270AgendaCalendarStartDate = new DateTime[] {DateTime.MinValue} ;
         P008S2_A268AgendaCalendarId = new Guid[] {Guid.Empty} ;
         P008S2_A272AgendaCalendarAllDay = new bool[] {false} ;
         P008S2_A269AgendaCalendarTitle = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_recurringeverystartdate__default(),
            new Object[][] {
                new Object[] {
               P008S2_A438AgendaCalendarRecurringType, P008S2_A437AgendaCalendarRecurring, P008S2_A29LocationId, P008S2_A270AgendaCalendarStartDate, P008S2_A268AgendaCalendarId, P008S2_A272AgendaCalendarAllDay, P008S2_A269AgendaCalendarTitle
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWWP_Calendar_Events_Item> AV12CalendarEvents ;
      private IDataStoreProvider pr_default ;
      private string[] P008S2_A438AgendaCalendarRecurringType ;
      private bool[] P008S2_A437AgendaCalendarRecurring ;
      private Guid[] P008S2_A29LocationId ;
      private DateTime[] P008S2_A270AgendaCalendarStartDate ;
      private Guid[] P008S2_A268AgendaCalendarId ;
      private bool[] P008S2_A272AgendaCalendarAllDay ;
      private string[] P008S2_A269AgendaCalendarTitle ;
      private WorkWithPlus.workwithplus_web.SdtWWP_Calendar_Events_Item AV13CalendarEvent ;
