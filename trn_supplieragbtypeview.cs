   ...
   public class trn_supplieragbtypeview : GXDataArea
   {
      ...
      protected void WB4I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierAgbTypeView.htm");
            /* Div Control */
      ...
      protected void RF4I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A255SupplierAgbTypeId = H004I2_A255SupplierAgbTypeId[0];
               /* Execute user event: Load */
               E164I2 ();
      ...
      protected void E144I2( )
      {
         ...
         {
            A255SupplierAgbTypeId = H004I3_A255SupplierAgbTypeId[0];
            A256SupplierAgbTypeName = H004I3_A256SupplierAgbTypeName[0];
            AV17GXLvl8 = 1;
            Form.Caption = A256SupplierAgbTypeName;
      ...
      protected void E154I2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_SupplierAgbType",  StringUtil.Trim( A255SupplierAgbTypeId.ToString())) )
         {
      ...
      protected void E114I2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_SupplierAgbType",(short)2,StringUtil.Trim( A255SupplierAgbTypeId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E124I2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_SupplierAgbType",StringUtil.Trim( A255SupplierAgbTypeId.ToString()),(string)AV14RecordDescription,formatLink("trn_supplieragbtypeview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Trn_SupplierAgbTypeGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_supplieragbtypegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Trn_SupplierAgbTypeGeneral";
               WebComp_Generalwc_Component = "Trn_SupplierAgbTypeGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0027",(string)"",(Guid)AV10SupplierAgbTypeId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256201781222", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragbtypeview.js", "?20256201781222", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E114I2","iparms":[{"av":"A255SupplierAgbTypeId","fld":"SUPPLIERAGBTYPEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E124I2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A255SupplierAgbTypeId","fld":"SUPPLIERAGBTYPEID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E134I2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10SupplierAgbTypeId","fld":"vSUPPLIERAGBTYPEID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H004I2_A255SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H004I3_A255SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         H004I3_A256SupplierAgbTypeName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_supplieragbtypeview__default(),
            new Object[][] {
                new Object[] {
               H004I2_A255SupplierAgbTypeId
               }
               , new Object[] {
               H004I3_A255SupplierAgbTypeId, H004I3_A256SupplierAgbTypeName
               }
            }
         );
      ...
      private Guid[] H004I2_A255SupplierAgbTypeId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H004I3_A255SupplierAgbTypeId ;
      private string[] H004I3_A256SupplierAgbTypeName ;
   ...
   public class trn_supplieragbtypeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004I2", "SELECT SupplierAgbTypeId FROM Trn_SupplierAgbType WHERE SupplierAgbTypeId = :AV10SupplierAgbTypeId ORDER BY SupplierAgbTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004I2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004I3", "SELECT SupplierAgbTypeId, SupplierAgbTypeName FROM Trn_SupplierAgbType WHERE SupplierAgbTypeId = :AV10SupplierAgbTypeId ORDER BY SupplierAgbTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004I3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
