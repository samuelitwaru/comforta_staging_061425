   ...
   public class gamwwappmenus : GXDataArea
   {
      ...
      protected void WB840( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_23_842( true) ;
         }
         else
         {
            wb_table1_23_842( false) ;
         }
         return  ;
      }

      protected void wb_table1_23_842e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV33GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV12FilName)),  0,  AV12FilName,  AV12FilName,  false,  "",  "") ;
      ...
      protected void wb_table1_23_842( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_28_842( true) ;
         }
         else
         {
            wb_table2_28_842( false) ;
         }
         return  ;
      }

      protected void wb_table2_28_842e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_23_842e( true) ;
         }
         else
         {
            wb_table1_23_842e( false) ;
         }
      }

      protected void wb_table2_28_842( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_28_842e( true) ;
         }
         else
         {
            wb_table2_28_842e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309485595", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwappmenus.js", "?20256309485597", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOBACK'","""{"handler":"E15842","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV53ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV47ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV73Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV12FilName","fld":"vFILNAME"},{"av":"edtavMenuoptions_Title","ctrl":"vMENUOPTIONS","prop":"Title"},{"av":"AV6ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV66IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV68IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV70IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV21IsAuthorized_MenuOptions","fld":"vISAUTHORIZED_MENUOPTIONS","hsh":true},{"av":"AV24IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV71IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV72IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
