   ...
   public class wp_createorganisationandmanager : GXDataArea
   {
      ...
      protected void E113X2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
         {
            ...
            WebComp_Steptitles.componentprepare(new Object[] {(string)"W0012",(string)"",(string)AV16Pgmname+"_Data",(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV13WizardSteps,(string)AV12CurrentStepAux});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256201774685", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createorganisationandmanager.js", "?20256201774685", false, true);
