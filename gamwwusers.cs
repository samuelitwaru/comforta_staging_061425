   ...
   public class gamwwusers : GXDataArea
   {
      ...
      protected void WB870( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_24_872( true) ;
         }
         else
         {
            wb_table1_24_872( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_872e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector AV17ColumnsSelector ,
                                       string AV110Pgmname ,
      ...
      protected void E17872( )
      {
         ...
         edtavName_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV17ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavName_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavName_Visible), 5, 0), !bGXsfl_55_Refreshing);
         edtavEmail_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV17ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavEmail_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavEmail_Visible), 5, 0), !bGXsfl_55_Refreshing);
         edtavFirstname_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV17ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavLastname_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV17ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavAuthenticationtypename_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV17ColumnsSelector.gxTpr_Columns.Item(5)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavStatus_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV17ColumnsSelector.gxTpr_Columns.Item(6)).gxTpr_Isvisible ? 1 : 0);
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV110Pgmname, out  GXt_char3) ;
      ...
      protected void E14872( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "GAMWWUsersColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV19ColumnsSelectorXML)) ? "" : AV17ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11872( )
      {
         ...
         else
         {
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV110Pgmname+"GridState",  AV82ManageFiltersXml) ;
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV17ColumnsSelector = new WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector(context);
         if ( StringUtil.StrCmp(AV88Repository.gxTpr_Useridentification, "email") != 0 )
         {
            new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "&Name",  "",  "WWP_GAM_Name",  true,  "") ;
         }
         else
         {
            new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "",  "",  "",  false,  "") ;
         }
         if ( StringUtil.StrCmp(AV88Repository.gxTpr_Useridentification, "name") != 0 )
         {
            new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "&Email",  "",  "WWP_GAM_Email",  true,  "") ;
         }
         else
         {
            new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "",  "",  "",  false,  "") ;
         }
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "&FirstName",  "",  "WWP_GAM_FirstName",  true,  "") ;
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "&LastName",  "",  "WWP_GAM_LastName",  true,  "") ;
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "&AuthenticationTypeName",  "",  "WWP_GAM_Authentication",  true,  "") ;
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV17ColumnsSelector,  "&Status",  "",  "Status",  true,  "") ;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV101UserCustomValue)) ) )
         {
            ...
            new WorkWithPlus.workwithplus_web.wwp_columnselector_updatecolumns(context ).execute( ref  AV18ColumnsSelectorAux, ref  AV17ColumnsSelector) ;
         }
      }
      ...
      protected void S232( )
      {
         ...
         if ( AV100User.gxTpr_Isblocked )
         {
            ...
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "User succesfully unblocked!", ""),  "success",  "",  "true",  ""));
         }
         else
         {
            AV100User.gxTpr_Isblocked = true;
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "User succesfully blocked!", ""),  "success",  "",  "true",  ""));
         }
         AV100User.save();
      ...
      protected void S252( )
      {
         ...
         if ( AV100User.gxTpr_Isenabledinrepository )
         {
            ...
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "User successfully disabled in repository!", ""),  "success",  "",  "true",  ""));
         }
         else
         {
            AV6isOK = AV100User.repositoryenable(out  AV5GAMErrorCollection);
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  context.GetMessage( "User successfully enabled in repository!", ""),  "success",  "",  "true",  ""));
         }
         if ( AV6isOK )
         {
            context.CommitDataStores("gamwwusers",pr_default);
      ...
      protected void S122( )
      {
         ...
         {
            AV56GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV110Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S172( )
      {
         ...
         {
            AV57GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV56GridState.gxTpr_Filtervalues.Item(AV113GXV5));
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV56GridState,  "SEARCH",  context.GetMessage( "WWP_GAM_Search", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV91Search)),  0,  AV91Search,  AV91Search,  false,  "",  "") ;
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV56GridState,  "FILAUTTYPE",  context.GetMessage( "WWP_GAM_Authentication", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV35FilAutType)),  0,  AV35FilAutType,  AV35FilAutType,  false,  "",  "") ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV56GridState,  "FILROL",  context.GetMessage( "WWP_GAM_Role", ""),  !(0==AV36FilRol),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV36FilRol), 12, 0)),  StringUtil.Trim( context.localUtil.Format( (decimal)(AV36FilRol), "ZZZZZZZZZZZ9")),  false,  "",  "") ;
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV110Pgmname+"GridState",  AV56GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_24_872( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_872e( true) ;
         }
         else
         {
            wb_table1_24_872e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017114445", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwusers.js", "?202562017114451", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18872","iparms":[{"av":"AV41FirstIndex","fld":"vFIRSTINDEX","pic":"ZZZ9","hsh":true},{"av":"AV69IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV65IsAuthorized_BtnRole","fld":"vISAUTHORIZED_BTNROLE","hsh":true},{"av":"AV64IsAuthorized_BtnPermissions","fld":"vISAUTHORIZED_BTNPERMISSIONS","hsh":true},{"av":"AV66IsAuthorized_BtnSetPwd","fld":"vISAUTHORIZED_BTNSETPWD","hsh":true},{"av":"AV62IsAuthorized_Authenticator","fld":"vISAUTHORIZED_AUTHENTICATOR","hsh":true},{"av":"AV73IsAuthorized_UDelete","fld":"vISAUTHORIZED_UDELETE","hsh":true},{"av":"AV107IsAuthorized_ApplicationAPIKeys","fld":"vISAUTHORIZED_APPLICATIONAPIKEYS","hsh":true},{"av":"AV72IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV70IsAuthorized_Email","fld":"vISAUTHORIZED_EMAIL","hsh":true}]""");
         ...
         setEventMetadata("VGRIDACTIONGROUP1.CLICK","""{"handler":"E19872","iparms":[{"av":"cmbavGridactiongroup1"},{"av":"AV48GridActionGroup1","fld":"vGRIDACTIONGROUP1","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV79ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV17ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV110Pgmname","fld":"vPGMNAME","hsh":true},{"av":"cmbavFilusergender"},{"av":"AV40FilUserGender","fld":"vFILUSERGENDER"},{"av":"cmbavFilauttype"},{"av":"AV35FilAutType","fld":"vFILAUTTYPE"},{"av":"AV91Search","fld":"vSEARCH"},{"av":"cmbavFilrol"},{"av":"AV36FilRol","fld":"vFILROL","pic":"ZZZZZZZZZZZ9"},{"av":"edtavBtnrole_Title","ctrl":"vBTNROLE","prop":"Title"},{"av":"AV41FirstIndex","fld":"vFIRSTINDEX","pic":"ZZZ9","hsh":true},{"av":"AV69IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV65IsAuthorized_BtnRole","fld":"vISAUTHORIZED_BTNROLE","hsh":true},{"av":"AV64IsAuthorized_BtnPermissions","fld":"vISAUTHORIZED_BTNPERMISSIONS","hsh":true},{"av":"AV66IsAuthorized_BtnSetPwd","fld":"vISAUTHORIZED_BTNSETPWD","hsh":true},{"av":"AV62IsAuthorized_Authenticator","fld":"vISAUTHORIZED_AUTHENTICATOR","hsh":true},{"av":"AV73IsAuthorized_UDelete","fld":"vISAUTHORIZED_UDELETE","hsh":true},{"av":"AV107IsAuthorized_ApplicationAPIKeys","fld":"vISAUTHORIZED_APPLICATIONAPIKEYS","hsh":true},{"av":"AV72IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV70IsAuthorized_Email","fld":"vISAUTHORIZED_EMAIL","hsh":true},{"av":"AV71IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"AV58GUID","fld":"vGUID"}]""");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV77ManageFiltersData = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         ...
         AV56GridState = new WorkWithPlus.workwithplus_web.SdtWWPGridState(context);
         ...
         GXt_char3 = "";
         AV18ColumnsSelectorAux = new WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector(context);
         ...
         AV57GridStateFilterValue = new WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue(context);
         AV106AuxText = "";
      ...
      private WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector AV17ColumnsSelector ;
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item> AV77ManageFiltersData ;
      private WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsTitleSettingsIcons AV27DDO_TitleSettingsIcons ;
      private WorkWithPlus.workwithplus_web.SdtWWPGridState AV56GridState ;
      ...
      private WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector AV18ColumnsSelectorAux ;
      ...
      private WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue AV57GridStateFilterValue ;
