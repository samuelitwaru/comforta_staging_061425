...
namespace GeneXus.Programs {
   public class trn_environmentvariableview : GXDataArea
   {
      public trn_environmentvariableview( )
      {
      ...
      public trn_environmentvariableview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_EnvironmentVariableId ,
                           string aP1_TabCode )
      {
         this.AV9EnvironmentVariableId = aP0_EnvironmentVariableId;
      ...
      {
         get {
            return "trn_environmentvariableview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_environmentvariableview.aspx"+UrlEncode(AV9EnvironmentVariableId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_environmentvariableview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV13RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV15IsAuthorized_Discussions);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISCUSSIONS", GetSecureSignedToken( "", AV15IsAuthorized_Discussions, context));
         GxWebStd.gx_hidden_field( context, "vENVIRONMENTVARIABLEID", AV9EnvironmentVariableId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vENVIRONMENTVARIABLEID", GetSecureSignedToken( "", AV9EnvironmentVariableId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_environmentvariableview.aspx"+UrlEncode(AV9EnvironmentVariableId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         return formatLink("trn_environmentvariableview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_EnvironmentVariableView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Environment Variable View", "") ;
      }
      ...
      protected void WBBO0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Trn_Environment Variable", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_EnvironmentVariableView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_environmentvariablegeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void STARTBO2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Environment Variable View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PABO2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_environmentvariableview.aspx")), "trn_environmentvariableview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_environmentvariableview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV9EnvironmentVariableId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV9EnvironmentVariableId", AV9EnvironmentVariableId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vENVIRONMENTVARIABLEID", GetSecureSignedToken( "", AV9EnvironmentVariableId, context));
      ...
      protected void RFBO2( )
      {
         ...
         {
            /* Using cursor H00BO2 */
            pr_default.execute(0, new Object[] {AV9EnvironmentVariableId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A632EnvironmentVariableId = H00BO2_A632EnvironmentVariableId[0];
               /* Execute user event: Load */
               E15BO2 ();
      ...
      protected void send_integrity_lvl_hashesBO2( )
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV13RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV15IsAuthorized_Discussions);
      ...
      protected void E13BO2( )
      {
         /* Start Routine */
         returnInSub = false;
         new GeneXus.Programs.wwpbaseobjects.loadwwpcontext(context ).execute( out  AV6WWPContext) ;
         lblWorkwithlink_Link = formatLink("trn_environmentvariableww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00BO3 */
         pr_default.execute(1, new Object[] {AV9EnvironmentVariableId});
         ...
         AV13RecordDescription = Form.Caption;
         AssignAttri("", false, "AV13RecordDescription", AV13RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13RecordDescription, "")), context));
         if ( StringUtil.StrCmp(AV14Session.Get("DiscussionThreadIdToOpen"), "") != 0 )
         {
            this.executeUsercontrolMethod("", false, "DDC_DISCUSSIONSContainer", "Open", "", new Object[] {});
         }
      }

      protected void E14BO2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_EnvironmentVariable",  StringUtil.Trim( A632EnvironmentVariableId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_EnvironmentVariable",  2) )
         {
         ...
         GXt_boolean1 = AV15IsAuthorized_Discussions;
         ...
         AV15IsAuthorized_Discussions = GXt_boolean1;
         AssignAttri("", false, "AV15IsAuthorized_Discussions", AV15IsAuthorized_Discussions);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISCUSSIONS", GetSecureSignedToken( "", AV15IsAuthorized_Discussions, context));
         if ( AV15IsAuthorized_Discussions )
         {
      ...
      protected void E11BO2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_EnvironmentVariable",(short)2,StringUtil.Trim( A632EnvironmentVariableId.ToString()),(string)AV13RecordDescription});
      ...
      protected void E12BO2( )
      {
         ...
         if ( AV15IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_EnvironmentVariable",StringUtil.Trim( A632EnvironmentVariableId.ToString()),(string)AV13RecordDescription,formatLink("trn_environmentvariableview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_EnvironmentVariableGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_environmentvariablegeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_EnvironmentVariableGeneral";
            WebComp_Webcomponent_general_Component = "Trn_EnvironmentVariableGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV9EnvironmentVariableId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9EnvironmentVariableId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV9EnvironmentVariableId", AV9EnvironmentVariableId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vENVIRONMENTVARIABLEID", GetSecureSignedToken( "", AV9EnvironmentVariableId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256146441570", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_environmentvariableview.js", "?20256146441570", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_environmentvariablegeneral_cell_Internalname = "TRN_ENVIRONMENTVARIABLEGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Environment Variable View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A632EnvironmentVariableId","fld":"ENVIRONMENTVARIABLEID"},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV15IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV9EnvironmentVariableId","fld":"vENVIRONMENTVARIABLEID","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"Ddc_discussions_Icon","ctrl":"DDC_DISCUSSIONS","prop":"Icon"},{"av":"Ddc_subscriptions_Visible","ctrl":"DDC_SUBSCRIPTIONS","prop":"Visible"},{"av":"AV15IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"Ddc_discussions_Visible","ctrl":"DDC_DISCUSSIONS","prop":"Visible"}]}""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11BO2","iparms":[{"av":"A632EnvironmentVariableId","fld":"ENVIRONMENTVARIABLEID"},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12BO2","iparms":[{"av":"AV15IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A632EnvironmentVariableId","fld":"ENVIRONMENTVARIABLEID"}]""");
      ...
      {
         wcpOAV9EnvironmentVariableId = Guid.Empty;
         wcpOAV7TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_environmentvariableview__default(),
            new Object[][] {
                new Object[] {
      ...
      private string divTrn_environmentvariablegeneral_cell_Internalname ;
      ...
      private bool AV15IsAuthorized_Discussions ;
   ...
   public class trn_environmentvariableview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00BO2;
          prmH00BO2 = new Object[] {
          new ParDef("AV9EnvironmentVariableId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00BO3;
          prmH00BO3 = new Object[] {
          new ParDef("AV9EnvironmentVariableId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
