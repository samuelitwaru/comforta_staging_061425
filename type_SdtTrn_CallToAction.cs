...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Trn_CallToAction" , Namespace = "Comforta_version21" )]
   [Serializable]
   public class SdtTrn_CallToAction : GxSilentTrnSdt
   {
      ...
      public void Load( Guid AV339CallToActionId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(Guid)AV339CallToActionId});
         return  ;
      }
   ...
   [DataContract(Name = @"Trn_CallToAction", Namespace = "Comforta_version21")]
