   ...
   public class gamroleselect : GXDataArea
   {
      ...
      protected void WB8P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8P2( true) ;
         }
         else
         {
            wb_table1_14_8P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8P2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E168P2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV41Pgmname, out  GXt_char1) ;
      ...
      protected void E118P2( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "GAMRoleSelectFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char1) ;
            ...
            else
            {
               ...
               S142 ();
               if (returnInSub) return;
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV41Pgmname+"GridState",  AV34ManageFiltersXml) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMRoleSelectFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item2) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV30GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV41Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S152( )
      {
         ...
         {
            AV31GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV30GridState.gxTpr_Filtervalues.Item(AV46GXV4));
      ...
      protected void S132( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV30GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV11FilName)),  0,  AV11FilName,  AV11FilName,  false,  "",  "") ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV30GridState,  "FILEXTERNALID",  context.GetMessage( "WWP_GAM_ExternalId", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV10FilExternalId)),  0,  AV10FilExternalId,  AV10FilExternalId,  false,  "",  "") ;
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV41Pgmname+"GridState",  AV30GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_14_8P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_19_8P2( true) ;
         }
         else
         {
            wb_table2_19_8P2( false) ;
         }
         return  ;
      }

      protected void wb_table2_19_8P2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_8P2e( true) ;
         }
         else
         {
            wb_table1_14_8P2e( false) ;
         }
      }

      protected void wb_table2_19_8P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_19_8P2e( true) ;
         }
         else
         {
            wb_table2_19_8P2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017105115", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamroleselect.js", "?202562017105117", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E178P2","iparms":[{"av":"AV21RoleIdAux","fld":"vROLEIDAUX","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"AV10FilExternalId","fld":"vFILEXTERNALID"}]""");
         ...
         setEventMetadata("'DOADD'","""{"handler":"E148P2","iparms":[{"av":"AV21RoleIdAux","fld":"vROLEIDAUX","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV22Select","fld":"vSELECT","grid":38},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_38","ctrl":"GRID","grid":38,"prop":"GridRC","grid":38},{"av":"AV15Id","fld":"vID","grid":38,"pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV16isOK","fld":"vISOK"}]""");
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV37ManageFiltersData = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
      ...
      private GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTDropDownOptionsData_Item> AV37ManageFiltersData ;
