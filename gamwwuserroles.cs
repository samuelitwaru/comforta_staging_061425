   ...
   public class gamwwuserroles : GXDataArea
   {
      ...
      protected void WB890( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_21_892( true) ;
         }
         else
         {
            wb_table1_21_892( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_892e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table1_21_892( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_26_892( true) ;
         }
         else
         {
            wb_table2_26_892( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_892e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_892e( true) ;
         }
         else
         {
            wb_table1_21_892e( false) ;
         }
      }

      protected void wb_table2_26_892( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_892e( true) ;
         }
         else
         {
            wb_table2_26_892e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017102071", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwuserroles.js", "?202562017102074", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18892","iparms":[{"av":"AV28UserId","fld":"vUSERID","hsh":true},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11DisplayInheritRoles","fld":"vDISPLAYINHERITROLES"}]""");
         ...
         setEventMetadata("'DOBACK'","""{"handler":"E14892","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV57ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV69Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11DisplayInheritRoles","fld":"vDISPLAYINHERITROLES"},{"av":"AV28UserId","fld":"vUSERID","hsh":true},{"av":"AV67IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"AV27RolesId","fld":"vROLESID","pic":"ZZZZZZZZZZZ9","hsh":true}]""");
