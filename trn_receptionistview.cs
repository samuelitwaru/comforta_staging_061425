   ...
   public class trn_receptionistview : GXDataArea
   {
      ...
      protected void WB470( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ReceptionistView.htm");
            /* Div Control */
      ...
      protected void RF472( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A89ReceptionistId = H00472_A89ReceptionistId[0];
               /* Execute user event: Load */
               E16472 ();
      ...
      protected void E14472( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A89ReceptionistId = H00473_A89ReceptionistId[0];
            A90ReceptionistGivenName = H00473_A90ReceptionistGivenName[0];
            AV19GXLvl8 = 1;
      ...
      protected void E11472( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_Receptionist",(short)2,StringUtil.Trim( A89ReceptionistId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString()),(string)AV15RecordDescription});
      ...
      protected void E12472( )
      {
         ...
         if ( AV18IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"Trn_Receptionist",StringUtil.Trim( A89ReceptionistId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString()),(string)AV15RecordDescription,formatLink("trn_receptionistview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV12LoadAllTabs || ( StringUtil.StrCmp(AV13SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV13SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Trn_ReceptionistGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_receptionistgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Trn_ReceptionistGeneral";
               WebComp_Generalwc_Component = "Trn_ReceptionistGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0027",(string)"",(Guid)AV10ReceptionistId,(Guid)AV17OrganisationId,(Guid)AV11LocationId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309455185", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_receptionistview.js", "?20256309455185", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11472","iparms":[{"av":"A89ReceptionistId","fld":"RECEPTIONISTID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12472","iparms":[{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A89ReceptionistId","fld":"RECEPTIONISTID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"A29LocationId","fld":"LOCATIONID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13472","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV12LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV13SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10ReceptionistId","fld":"vRECEPTIONISTID","hsh":true},{"av":"AV17OrganisationId","fld":"vORGANISATIONID","hsh":true},{"av":"AV11LocationId","fld":"vLOCATIONID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV13SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV12LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"GENERALWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H00473_A89ReceptionistId = new Guid[] {Guid.Empty} ;
         H00473_A90ReceptionistGivenName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_receptionistview__default(),
            new Object[][] {
                new Object[] {
               H00472_A29LocationId, H00472_A11OrganisationId, H00472_A89ReceptionistId
               }
               , new Object[] {
               H00473_A29LocationId, H00473_A11OrganisationId, H00473_A89ReceptionistId, H00473_A90ReceptionistGivenName
               }
            }
         );
      ...
      private Guid[] H00473_A89ReceptionistId ;
      private string[] H00473_A90ReceptionistGivenName ;
