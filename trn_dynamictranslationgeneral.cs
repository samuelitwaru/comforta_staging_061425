...
namespace GeneXus.Programs {
   public class trn_dynamictranslationgeneral : GXWebComponent
   {
      public trn_dynamictranslationgeneral( )
      {
      ...
      public trn_dynamictranslationgeneral( IGxContext context )
      {
      ...
      {
         this.A578DynamicTranslationId = aP0_DynamicTranslationId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A578DynamicTranslationId", A578DynamicTranslationId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A578DynamicTranslationId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "Trn_DynamicTranslationGeneral";
               WSBA2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Trn_Dynamic Translation General", "")) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA578DynamicTranslationId", wcpOA578DynamicTranslationId.ToString());
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      {
         return "Trn_DynamicTranslationGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Dynamic Translation General", "") ;
      }
      ...
      protected void WBBA0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_dynamictranslationgeneral.aspx");
            }
            ...
            GxWebStd.gx_single_line_edit( context, edtDynamicTranslationTrnName_Internalname, A579DynamicTranslationTrnName, StringUtil.RTrim( context.localUtil.Format( A579DynamicTranslationTrnName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDynamicTranslationTrnName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtDynamicTranslationTrnName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_DynamicTranslationGeneral.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtDynamicTranslationAttributeNam_Internalname, A581DynamicTranslationAttributeNam, StringUtil.RTrim( context.localUtil.Format( A581DynamicTranslationAttributeNam, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDynamicTranslationAttributeNam_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtDynamicTranslationAttributeNam_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_DynamicTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDynamicTranslationEnglish_Internalname, A582DynamicTranslationEnglish, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,24);\"", 0, 1, edtDynamicTranslationEnglish_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_DynamicTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDynamicTranslationDutch_Internalname, A583DynamicTranslationDutch, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", 0, 1, edtDynamicTranslationDutch_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_DynamicTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtDynamicTranslationId_Internalname, A578DynamicTranslationId.ToString(), A578DynamicTranslationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDynamicTranslationId_Jsonclick, 0, "Attribute", "", "", "", "", edtDynamicTranslationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_DynamicTranslationGeneral.htm");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtDynamicTranslationPrimaryKey_Internalname, A580DynamicTranslationPrimaryKey.ToString(), A580DynamicTranslationPrimaryKey.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDynamicTranslationPrimaryKey_Jsonclick, 0, "Attribute", "", "", "", "", edtDynamicTranslationPrimaryKey_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_DynamicTranslationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STARTBA2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Trn_Dynamic Translation General", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void RFBA2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A581DynamicTranslationAttributeNam = H00BA2_A581DynamicTranslationAttributeNam[0];
               AssignAttri(sPrefix, false, "A581DynamicTranslationAttributeNam", A581DynamicTranslationAttributeNam);
               A579DynamicTranslationTrnName = H00BA2_A579DynamicTranslationTrnName[0];
      ...
      protected void send_integrity_lvl_hashesBA2( )
      {
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtDynamicTranslationTrnName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtDynamicTranslationTrnName_Enabled), 5, 0), true);
         edtDynamicTranslationAttributeNam_Enabled = 0;
         AssignProp(sPrefix, false, edtDynamicTranslationAttributeNam_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtDynamicTranslationAttributeNam_Enabled), 5, 0), true);
         ...
         AssignProp(sPrefix, false, edtDynamicTranslationPrimaryKey_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtDynamicTranslationPrimaryKey_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void E12BA2( )
      {
         ...
         AssignProp(sPrefix, false, edtDynamicTranslationId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtDynamicTranslationId_Visible), 5, 0), true);
         edtDynamicTranslationPrimaryKey_Visible = 0;
         AssignProp(sPrefix, false, edtDynamicTranslationPrimaryKey_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtDynamicTranslationPrimaryKey_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "Trn_DynamicTranslation";
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA578DynamicTranslationId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_dynamictranslationgeneral", GetJustCreated( ));
         ...
         {
            A578DynamicTranslationId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A578DynamicTranslationId", A578DynamicTranslationId.ToString());
         }
         wcpOA578DynamicTranslationId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA578DynamicTranslationId"));
         if ( ! GetJustCreated( ) && ( ( A578DynamicTranslationId != wcpOA578DynamicTranslationId ) ) )
         {
            setjustcreated();
         }
         wcpOA578DynamicTranslationId = A578DynamicTranslationId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA578DynamicTranslationId = cgiGet( sPrefix+"A578DynamicTranslationId_CTRL");
         if ( StringUtil.Len( sCtrlA578DynamicTranslationId) > 0 )
         {
            A578DynamicTranslationId = StringUtil.StrToGuid( cgiGet( sCtrlA578DynamicTranslationId));
            AssignAttri(sPrefix, false, "A578DynamicTranslationId", A578DynamicTranslationId.ToString());
         }
         else
         {
            A578DynamicTranslationId = StringUtil.StrToGuid( cgiGet( sPrefix+"A578DynamicTranslationId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A578DynamicTranslationId_PARM", A578DynamicTranslationId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA578DynamicTranslationId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A578DynamicTranslationId_CTRL", StringUtil.RTrim( sCtrlA578DynamicTranslationId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309432959", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_dynamictranslationgeneral.js", "?20256309432959", false, true);
      ...
      {
         edtDynamicTranslationTrnName_Internalname = sPrefix+"DYNAMICTRANSLATIONTRNNAME";
         ...
         edtDynamicTranslationId_Internalname = sPrefix+"DYNAMICTRANSLATIONID";
         edtDynamicTranslationPrimaryKey_Internalname = sPrefix+"DYNAMICTRANSLATIONPRIMARYKEY";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","""{"handler":"E13BA2","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A578DynamicTranslationId","fld":"DYNAMICTRANSLATIONID"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E14BA2","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A578DynamicTranslationId","fld":"DYNAMICTRANSLATIONID"}]""");
      ...
      {
         wcpOA578DynamicTranslationId = Guid.Empty;
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV14Pgmname = "";
         ...
         H00BA2_A579DynamicTranslationTrnName = new string[] {""} ;
      ...
      private Guid wcpOA578DynamicTranslationId ;
      ...
      private string[] H00BA2_A579DynamicTranslationTrnName ;
   ...
   public class trn_dynamictranslationgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
