...
namespace GeneXus.Programs {
   public class prc_deletecascadesuppliergen : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            GXTC12 = 0;
            A601SG_OrganisationSupplierId = P00C12_A601SG_OrganisationSupplierId[0];
            n601SG_OrganisationSupplierId = P00C12_n601SG_OrganisationSupplierId[0];
            A42SupplierGenId = P00C12_A42SupplierGenId[0];
            new prc_deletecascadeproductservice(context ).execute(  Guid.Empty,  A42SupplierGenId,  Guid.Empty,  A601SG_OrganisationSupplierId) ;
      ...
      public override void initialize( )
      {
         ...
         P00C12_A601SG_OrganisationSupplierId = new Guid[] {Guid.Empty} ;
         P00C12_n601SG_OrganisationSupplierId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_deletecascadesuppliergen__default(),
            new Object[][] {
                new Object[] {
               P00C12_A601SG_OrganisationSupplierId, P00C12_n601SG_OrganisationSupplierId, P00C12_A42SupplierGenId
               }
               , new Object[] {
               }
            }
      ...
      private Guid[] P00C12_A601SG_OrganisationSupplierId ;
      private bool[] P00C12_n601SG_OrganisationSupplierId ;
...
public class prc_deletecascadesuppliergen__default : DataStoreHelperBase, IDataStoreHelper
{
                                          ...
                                          Guid A601SG_OrganisationSupplierId )
   {
      ...
      scmdbuf = "SELECT SG_OrganisationSupplierId, SupplierGenId FROM Trn_SupplierGen";
      ...
      {
         AddWhere(sWhereString, "(SG_OrganisationSupplierId = :AV8OrganisationId)");
      }
      else
      {
         GXv_int1[1] = 1;
