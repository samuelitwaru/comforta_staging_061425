   ...
   public class wp_productservice : GXDataArea
   {
               ...
               if ( nGotPars == 0 )
               {
                  ...
                  if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
                  {
                     ...
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        ...
                        GxWebStd.gx_hidden_field( context, "gxhash_vGOINGBACK", GetSecureSignedToken( "", AV9GoingBack, context));
                        AV17IsPopup = StringUtil.StrToBool( GetPar( "IsPopup"));
      ...
      protected void E116A2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV11CurrentStep)) )
         {
            ...
            GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEPAUX", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV12CurrentStepAux, "")), context));
            AV7WebSession.Remove(AV22Pgmname+"_Data");
         }
         else
         {
         ...
         if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
         {
            ...
            WebComp_Steptitles.componentprepare(new Object[] {(string)"W0012",(string)"",(string)AV22Pgmname+"_Data",(GXBaseCollection<WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem>)AV13WizardSteps,(string)AV12CurrentStepAux});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step1") == 0 )
         {
            ...
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               ...
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0018",(string)"",(string)AV22Pgmname+"_Data",(string)AV10PreviousStep,(bool)AV9GoingBack,(bool)AV17IsPopup,(Guid)AV19FromToolBox_ProductServiceId,(string)AV20PageType});
      ...
      protected void E126A2( )
      {
         ...
         AV15StepNumber = 1;
         AV23GXV1 = 1;
         while ( AV23GXV1 <= AV13WizardSteps.Count )
         {
            AV14WizardStep = ((WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem)AV13WizardSteps.Item(AV23GXV1));
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV9GoingBack", AV9GoingBack);
         GxWebStd.gx_hidden_field( context, "gxhash_vGOINGBACK", GetSecureSignedToken( "", AV9GoingBack, context));
         AV17IsPopup = (bool)getParm(obj,3);
         AssignAttri("", false, "AV17IsPopup", AV17IsPopup);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309471863", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_productservice.js", "?20256309471864", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV14WizardStep = new WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem(context);
      ...
      private WorkWithPlus.workwithplus_web.SdtWizardSteps_WizardStepsItem AV14WizardStep ;
