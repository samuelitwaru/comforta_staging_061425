...
namespace GeneXus.Programs {
   public class trn_pageview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_pageview.aspx"+UrlEncode(AV10Trn_PageId.ToString()) + "," + UrlEncode(AV12LocationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
      ...
      protected void WB9C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to App builder pages", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_PageView.htm");
      ...
      protected void RF9C2( )
      {
         ...
         {
            /* Using cursor H009C2 */
            pr_default.execute(0, new Object[] {AV10Trn_PageId, AV12LocationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A29LocationId = H009C2_A29LocationId[0];
               A392Trn_PageId = H009C2_A392Trn_PageId[0];
               /* Execute user event: Load */
               E159C2 ();
      ...
      protected void E139C2( )
      {
         ...
         AV19GXLvl9 = 0;
         /* Using cursor H009C3 */
         pr_default.execute(1, new Object[] {AV10Trn_PageId, AV12LocationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A29LocationId = H009C3_A29LocationId[0];
            A392Trn_PageId = H009C3_A392Trn_PageId[0];
            A397Trn_PageName = H009C3_A397Trn_PageName[0];
            AV19GXLvl9 = 1;
            Form.Caption = A397Trn_PageName;
      ...
      protected void E149C2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Page",  StringUtil.Trim( A392Trn_PageId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())) )
         {
      ...
      protected void E119C2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Page",(short)2,StringUtil.Trim( A392Trn_PageId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString()),(string)AV16RecordDescription});
      ...
      protected void E129C2( )
      {
         ...
         if ( AV18IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Page",StringUtil.Trim( A392Trn_PageId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString()),(string)AV16RecordDescription,formatLink("trn_pageview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            ...
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10Trn_PageId,(Guid)AV12LocationId});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV10Trn_PageId", AV10Trn_PageId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_PAGEID", GetSecureSignedToken( "", AV10Trn_PageId, context));
         AV12LocationId = (Guid)getParm(obj,1);
         AssignAttri("", false, "AV12LocationId", AV12LocationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV12LocationId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017131147", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_pageview.js", "?202562017131147", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E119C2","iparms":[{"av":"A392Trn_PageId","fld":"TRN_PAGEID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV16RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E129C2","iparms":[{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV16RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A392Trn_PageId","fld":"TRN_PAGEID"},{"av":"A29LocationId","fld":"LOCATIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H009C2_A29LocationId = new Guid[] {Guid.Empty} ;
         H009C2_A392Trn_PageId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H009C3_A29LocationId = new Guid[] {Guid.Empty} ;
         H009C3_A392Trn_PageId = new Guid[] {Guid.Empty} ;
         H009C3_A397Trn_PageName = new string[] {""} ;
         A397Trn_PageName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_pageview__default(),
            new Object[][] {
                new Object[] {
               H009C2_A29LocationId, H009C2_A392Trn_PageId
               }
               , new Object[] {
               H009C3_A29LocationId, H009C3_A392Trn_PageId, H009C3_A397Trn_PageName
               }
            }
         );
      ...
      private Guid[] H009C2_A29LocationId ;
      private Guid[] H009C2_A392Trn_PageId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H009C3_A29LocationId ;
      private Guid[] H009C3_A392Trn_PageId ;
      private string[] H009C3_A397Trn_PageName ;
   ...
   public class trn_pageview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH009C3;
          prmH009C3 = new Object[] {
          new ParDef("AV10Trn_PageId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV12LocationId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H009C2", "SELECT LocationId, Trn_PageId FROM Trn_Page WHERE Trn_PageId = :AV10Trn_PageId and LocationId = :AV12LocationId ORDER BY Trn_PageId, LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009C2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H009C3", "SELECT LocationId, Trn_PageId, Trn_PageName FROM Trn_Page WHERE (Trn_PageId = :AV10Trn_PageId and LocationId = :AV12LocationId) AND (Trn_PageId = :AV10Trn_PageId and LocationId = :AV12LocationId) ORDER BY Trn_PageId, LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009C3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
