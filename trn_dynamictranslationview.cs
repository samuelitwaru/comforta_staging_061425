...
namespace GeneXus.Programs {
   public class trn_dynamictranslationview : GXDataArea
   {
      public trn_dynamictranslationview( )
      {
      ...
      public trn_dynamictranslationview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_DynamicTranslationId ,
                           string aP1_TabCode )
      {
         this.AV10DynamicTranslationId = aP0_DynamicTranslationId;
      ...
      {
         get {
            return "trn_dynamictranslationview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_dynamictranslationview.aspx"+UrlEncode(AV10DynamicTranslationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_dynamictranslationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vDYNAMICTRANSLATIONID", AV10DynamicTranslationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vDYNAMICTRANSLATIONID", GetSecureSignedToken( "", AV10DynamicTranslationId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_dynamictranslationview.aspx"+UrlEncode(AV10DynamicTranslationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_dynamictranslationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_DynamicTranslationView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Dynamic Translation View", "") ;
      }

      protected void WBB60( )
      {
         if ( context.isAjaxRequest( ) )
         {
            disableOutput();
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Trn_Dynamic Translation", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_DynamicTranslationView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_dynamictranslationgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void STARTB62( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Dynamic Translation View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void WSB62( )
      {
         STARTB62( ) ;
         EVTB62( ) ;
      }

      protected void EVTB62( )
      {
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
      ...
      protected void PAB62( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_dynamictranslationview.aspx")), "trn_dynamictranslationview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_dynamictranslationview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10DynamicTranslationId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10DynamicTranslationId", AV10DynamicTranslationId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vDYNAMICTRANSLATIONID", GetSecureSignedToken( "", AV10DynamicTranslationId, context));
      ...
      protected void RFB62( )
      {
         ...
         {
            /* Using cursor H00B62 */
            pr_default.execute(0, new Object[] {AV10DynamicTranslationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A578DynamicTranslationId = H00B62_A578DynamicTranslationId[0];
               /* Execute user event: Load */
               E15B62 ();
      ...
      protected void send_integrity_lvl_hashesB62( )
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV14RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV16IsAuthorized_Discussions);
      ...
      protected void E13B62( )
      {
         /* Start Routine */
         returnInSub = false;
         new GeneXus.Programs.wwpbaseobjects.loadwwpcontext(context ).execute( out  AV6WWPContext) ;
         lblWorkwithlink_Link = formatLink("trn_dynamictranslationww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00B63 */
         pr_default.execute(1, new Object[] {AV10DynamicTranslationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A578DynamicTranslationId = H00B63_A578DynamicTranslationId[0];
            A579DynamicTranslationTrnName = H00B63_A579DynamicTranslationTrnName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A579DynamicTranslationTrnName;
      ...
      protected void E14B62( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_DynamicTranslation",  StringUtil.Trim( A578DynamicTranslationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_DynamicTranslation",  2) )
         {
      ...
      protected void E15B62( )
      {
         /* Load Routine */
         returnInSub = false;
      }

      protected void E11B62( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_DynamicTranslation",(short)2,StringUtil.Trim( A578DynamicTranslationId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12B62( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_DynamicTranslation",StringUtil.Trim( A578DynamicTranslationId.ToString()),(string)AV14RecordDescription,formatLink("trn_dynamictranslationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_DynamicTranslationGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_dynamictranslationgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_DynamicTranslationGeneral";
            WebComp_Webcomponent_general_Component = "Trn_DynamicTranslationGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10DynamicTranslationId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10DynamicTranslationId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10DynamicTranslationId", AV10DynamicTranslationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vDYNAMICTRANSLATIONID", GetSecureSignedToken( "", AV10DynamicTranslationId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017144183", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_dynamictranslationview.js", "?202562017144184", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_dynamictranslationgeneral_cell_Internalname = "TRN_DYNAMICTRANSLATIONGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Dynamic Translation View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A578DynamicTranslationId","fld":"DYNAMICTRANSLATIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10DynamicTranslationId","fld":"vDYNAMICTRANSLATIONID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11B62","iparms":[{"av":"A578DynamicTranslationId","fld":"DYNAMICTRANSLATIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12B62","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A578DynamicTranslationId","fld":"DYNAMICTRANSLATIONID"}]""");
      ...
      {
         wcpOAV10DynamicTranslationId = Guid.Empty;
         wcpOAV8TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00B62_A578DynamicTranslationId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00B63_A578DynamicTranslationId = new Guid[] {Guid.Empty} ;
         H00B63_A579DynamicTranslationTrnName = new string[] {""} ;
         A579DynamicTranslationTrnName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_dynamictranslationview__default(),
            new Object[][] {
                new Object[] {
               H00B62_A578DynamicTranslationId
               }
               , new Object[] {
               H00B63_A578DynamicTranslationId, H00B63_A579DynamicTranslationTrnName
               }
            }
         );
      ...
      private string divTrn_dynamictranslationgeneral_cell_Internalname ;
      ...
      private Guid AV10DynamicTranslationId ;
      private Guid wcpOAV10DynamicTranslationId ;
      ...
      private Guid[] H00B62_A578DynamicTranslationId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00B63_A578DynamicTranslationId ;
      private string[] H00B63_A579DynamicTranslationTrnName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_dynamictranslationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH00B62;
          prmH00B62 = new Object[] {
          new ParDef("AV10DynamicTranslationId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00B63;
          prmH00B63 = new Object[] {
          new ParDef("AV10DynamicTranslationId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00B62", "SELECT DynamicTranslationId FROM Trn_DynamicTranslation WHERE DynamicTranslationId = :AV10DynamicTranslationId ORDER BY DynamicTranslationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B62,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00B63", "SELECT DynamicTranslationId, DynamicTranslationTrnName FROM Trn_DynamicTranslation WHERE DynamicTranslationId = :AV10DynamicTranslationId ORDER BY DynamicTranslationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00B63,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
