...
namespace GeneXus.Programs {
   public class trn_memocategoryww : GXDataArea
   {
      public trn_memocategoryww( )
      {
      ...
      public trn_memocategoryww( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV24TFMemoCategoryName = GetPar( "TFMemoCategoryName");
         AV25TFMemoCategoryName_Sel = GetPar( "TFMemoCategoryName_Sel");
         ...
         AV33IsAuthorized_MemoCategoryName = StringUtil.StrToBool( GetPar( "IsAuthorized_MemoCategoryName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedDsc, AV15FilterFullText, AV23ManageFiltersExecutionStep, AV18ColumnsSelector, AV39Pgmname, AV24TFMemoCategoryName, AV25TFMemoCategoryName_Sel, AV35IsAuthorized_Display, AV36IsAuthorized_Update, AV37IsAuthorized_Delete, AV33IsAuthorized_MemoCategoryName, AV38IsAuthorized_Insert) ;
      ...
      {
         get {
            return "trn_memocategoryww_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_memocategoryww.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_MEMOCATEGORYNAME", AV33IsAuthorized_MemoCategoryName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_MEMOCATEGORYNAME", GetSecureSignedToken( "", AV33IsAuthorized_MemoCategoryName, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV39Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV39Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vTFMEMOCATEGORYNAME", AV24TFMemoCategoryName);
         GxWebStd.gx_hidden_field( context, "vTFMEMOCATEGORYNAME_SEL", AV25TFMemoCategoryName_Sel);
      ...
      {
         return formatLink("trn_memocategoryww.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Trn_MemoCategoryWW" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( " Trn_Memo Category", "") ;
      }
      ...
      protected void WBAL0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV15FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV15FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,30);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_Trn_MemoCategoryWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void STARTAL2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( " Trn_Memo Category", ""), 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "VACTIONGROUP.CLICK") == 0 ) )
                           {
                              ...
                              A543MemoCategoryName = cgiGet( edtMemoCategoryName_Internalname);
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV39Pgmname ,
                                       string AV24TFMemoCategoryName ,
                                       string AV25TFMemoCategoryName_Sel ,
                                       bool AV35IsAuthorized_Display ,
                                       bool AV36IsAuthorized_Update ,
                                       bool AV37IsAuthorized_Delete ,
                                       bool AV33IsAuthorized_MemoCategoryName ,
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_MEMOCATEGORYID", GetSecureSignedToken( "", A542MemoCategoryId, context));
         GxWebStd.gx_hidden_field( context, "MEMOCATEGORYID", A542MemoCategoryId.ToString());
      }
      ...
      {
         /* GeneXus formulas. */
         AV39Pgmname = "Trn_MemoCategoryWW";
      }
      ...
      protected void RFAL2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV40Trn_memocategorywwds_1_filterfulltext ,
                                                 AV42Trn_memocategorywwds_3_tfmemocategoryname_sel ,
                                                 AV41Trn_memocategorywwds_2_tfmemocategoryname ,
            ...
            lV40Trn_memocategorywwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV40Trn_memocategorywwds_1_filterfulltext), "%", "");
            lV41Trn_memocategorywwds_2_tfmemocategoryname = StringUtil.Concat( StringUtil.RTrim( AV41Trn_memocategorywwds_2_tfmemocategoryname), "%", "");
            /* Using cursor H00AL2 */
            pr_default.execute(0, new Object[] {lV40Trn_memocategorywwds_1_filterfulltext, lV41Trn_memocategorywwds_2_tfmemocategoryname, AV42Trn_memocategorywwds_3_tfmemocategoryname_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A543MemoCategoryName = H00AL2_A543MemoCategoryName[0];
               A542MemoCategoryId = H00AL2_A542MemoCategoryId[0];
               /* Execute user event: Grid.Load */
               E20AL2 ();
      ...
      protected void send_integrity_lvl_hashesAL2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_MEMOCATEGORYNAME", AV33IsAuthorized_MemoCategoryName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_MEMOCATEGORYNAME", GetSecureSignedToken( "", AV33IsAuthorized_MemoCategoryName, context));
         GxWebStd.gx_hidden_field( context, "gxhash_MEMOCATEGORYID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sGXsfl_39_idx, A542MemoCategoryId, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV38IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV38IsAuthorized_Insert, context));
      }
      ...
      {
         AV40Trn_memocategorywwds_1_filterfulltext = AV15FilterFullText;
         AV41Trn_memocategorywwds_2_tfmemocategoryname = AV24TFMemoCategoryName;
         AV42Trn_memocategorywwds_3_tfmemocategoryname_sel = AV25TFMemoCategoryName_Sel;
         ...
         lV41Trn_memocategorywwds_2_tfmemocategoryname = StringUtil.Concat( StringUtil.RTrim( AV41Trn_memocategorywwds_2_tfmemocategoryname), "%", "");
         /* Using cursor H00AL3 */
         pr_default.execute(1, new Object[] {lV40Trn_memocategorywwds_1_filterfulltext, lV41Trn_memocategorywwds_2_tfmemocategoryname, AV42Trn_memocategorywwds_3_tfmemocategoryname_sel});
      ...
      protected void E18AL2( )
      {
         ...
         GXt_boolean1 = AV33IsAuthorized_MemoCategoryName;
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memocategoryview_Execute", out  GXt_boolean1) ;
         AV33IsAuthorized_MemoCategoryName = GXt_boolean1;
         AssignAttri("", false, "AV33IsAuthorized_MemoCategoryName", AV33IsAuthorized_MemoCategoryName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_MEMOCATEGORYNAME", GetSecureSignedToken( "", AV33IsAuthorized_MemoCategoryName, context));
         ...
         Form.Caption = context.GetMessage( " Trn_Memo Category", "");
      ...
      protected void E19AL2( )
      {
         ...
         if ( StringUtil.StrCmp(AV20Session.Get("Trn_MemoCategoryWWColumnsSelector"), "") != 0 )
         {
            AV16ColumnsSelectorXML = AV20Session.Get("Trn_MemoCategoryWWColumnsSelector");
         ...
         edtMemoCategoryName_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtMemoCategoryName_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtMemoCategoryName_Visible), 5, 0), !bGXsfl_39_Refreshing);
      ...
      protected void E15AL2( )
      {
         ...
         {
            if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "MemoCategoryName") == 0 )
            {
               AV24TFMemoCategoryName = Ddo_grid_Filteredtext_get;
               AssignAttri("", false, "AV24TFMemoCategoryName", AV24TFMemoCategoryName);
               AV25TFMemoCategoryName_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri("", false, "AV25TFMemoCategoryName_Sel", AV25TFMemoCategoryName_Sel);
            }
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
      ...
      private void E20AL2( )
      {
         ...
         if ( AV33IsAuthorized_MemoCategoryName )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memocategoryview.aspx"+UrlEncode(A542MemoCategoryId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
            edtMemoCategoryName_Link = formatLink("trn_memocategoryview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E16AL2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "Trn_MemoCategoryWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV16ColumnsSelectorXML)) ? "" : AV18ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11AL2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_MemoCategoryWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV39Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("Trn_MemoCategoryWWFilters"));
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "Trn_MemoCategoryWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV39Pgmname+"GridState",  AV22ManageFiltersXml) ;
               AV11GridState.FromXml(AV22ManageFiltersXml, null, "", "");
      ...
      protected void E17AL2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memocategory.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(Guid.Empty.ToString());
            CallWebObject(formatLink("trn_memocategory.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
      ...
      protected void E14AL2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0054",(string)"",(string)"Trn_MemoCategory",(short)1,(string)"",(string)""});
      ...
      protected void S162( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "MemoCategoryName",  "",  "Category Name",  true,  "") ;
         GXt_char3 = AV17UserCustomValue;
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "Trn_MemoCategoryWWColumnsSelector", out  GXt_char3) ;
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memocategory_Update", out  GXt_boolean1) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memocategory_Delete", out  GXt_boolean1) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_memocategory_Insert", out  GXt_boolean1) ;
         ...
         if ( ! ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_MemoCategory",  1) ) )
         {
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_MemoCategoryWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S182( )
      {
         ...
         AV15FilterFullText = "";
         AssignAttri("", false, "AV15FilterFullText", AV15FilterFullText);
         AV24TFMemoCategoryName = "";
         AssignAttri("", false, "AV24TFMemoCategoryName", AV24TFMemoCategoryName);
         AV25TFMemoCategoryName_Sel = "";
         AssignAttri("", false, "AV25TFMemoCategoryName_Sel", AV25TFMemoCategoryName_Sel);
      ...
      protected void S202( )
      {
         ...
         if ( AV35IsAuthorized_Display )
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memocategoryview.aspx"+UrlEncode(A542MemoCategoryId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
            CallWebObject(formatLink("trn_memocategoryview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S212( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memocategory.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(A542MemoCategoryId.ToString());
            CallWebObject(formatLink("trn_memocategory.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S222( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_memocategory.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(A542MemoCategoryId.ToString());
            CallWebObject(formatLink("trn_memocategory.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV20Session.Get(AV39Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV39Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV20Session.Get(AV39Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
         AssignAttri("", false, "AV13OrderedDsc", AV13OrderedDsc);
         /* Execute user subroutine: 'SETDDOSORTEDSTATUS' */
      ...
      protected void S192( )
      {
         ...
         {
            AV12GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV43GXV1));
            if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "FILTERFULLTEXT") == 0 )
            {
               AV15FilterFullText = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV15FilterFullText", AV15FilterFullText);
            }
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFMEMOCATEGORYNAME") == 0 )
            {
               AV24TFMemoCategoryName = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV24TFMemoCategoryName", AV24TFMemoCategoryName);
            }
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFMEMOCATEGORYNAME_SEL") == 0 )
            {
               AV25TFMemoCategoryName_Sel = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV25TFMemoCategoryName_Sel", AV25TFMemoCategoryName_Sel);
            }
            AV43GXV1 = (int)(AV43GXV1+1);
         }
         GXt_char3 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV25TFMemoCategoryName_Sel)),  AV25TFMemoCategoryName_Sel, out  GXt_char3) ;
         Ddo_grid_Selectedvalue_set = GXt_char3;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char3 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV24TFMemoCategoryName)),  AV24TFMemoCategoryName, out  GXt_char3) ;
      ...
      protected void S122( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Trn_MemoCategory";
         AV20Session.Set("TrnContext", AV9TrnContext.ToXml(false, true, "", ""));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017145677", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_memocategoryww.js", "?202562017145680", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtMemoCategoryId_Internalname = "MEMOCATEGORYID_"+sGXsfl_39_idx;
         edtMemoCategoryName_Internalname = "MEMOCATEGORYNAME_"+sGXsfl_39_idx;
         cmbavActiongroup_Internalname = "vACTIONGROUP_"+sGXsfl_39_idx;
      }

      protected void SubsflControlProps_fel_392( )
      {
         edtMemoCategoryId_Internalname = "MEMOCATEGORYID_"+sGXsfl_39_fel_idx;
         edtMemoCategoryName_Internalname = "MEMOCATEGORYNAME_"+sGXsfl_39_fel_idx;
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMemoCategoryId_Internalname,A542MemoCategoryId.ToString(),A542MemoCategoryId.ToString(),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtMemoCategoryId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)39,(short)0,(short)0,(short)0,(bool)true,(string)"Id",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+((edtMemoCategoryName_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMemoCategoryName_Internalname,(string)A543MemoCategoryName,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtMemoCategoryName_Link,(string)"",(string)"",(string)"",(string)edtMemoCategoryName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(int)edtMemoCategoryName_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl39( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A542MemoCategoryId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A543MemoCategoryName));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtMemoCategoryName_Link));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtMemoCategoryName_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtMemoCategoryName_Internalname = "MEMOCATEGORYNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistproc = "Trn_MemoCategoryWWGetFilterData";
         ...
         Ddo_grid_Columnids = "1:MemoCategoryName";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"AV30GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV31GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV32GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12AL2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13AL2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E15AL2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E20AL2","iparms":[{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"A542MemoCategoryId","fld":"MEMOCATEGORYID","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV34ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"edtMemoCategoryName_Link","ctrl":"MEMOCATEGORYNAME","prop":"Link"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E16AL2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"AV30GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV31GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV32GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11AL2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"AV30GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV31GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV32GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E21AL2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV34ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A542MemoCategoryId","fld":"MEMOCATEGORYID","hsh":true}]""");
         setEventMetadata("VACTIONGROUP.CLICK",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV34ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"AV30GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV31GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV32GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E17AL2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV24TFMemoCategoryName","fld":"vTFMEMOCATEGORYNAME"},{"av":"AV25TFMemoCategoryName_Sel","fld":"vTFMEMOCATEGORYNAME_SEL"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV33IsAuthorized_MemoCategoryName","fld":"vISAUTHORIZED_MEMOCATEGORYNAME","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A542MemoCategoryId","fld":"MEMOCATEGORYID","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV23ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV18ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMemoCategoryName_Visible","ctrl":"MEMOCATEGORYNAME","prop":"Visible"},{"av":"AV30GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV31GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV32GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV35IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV36IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV37IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV21ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E14AL2","iparms":[]""");
      ...
      public override void initialize( )
      {
         ...
         A543MemoCategoryName = "";
         lV40Trn_memocategorywwds_1_filterfulltext = "";
         lV41Trn_memocategorywwds_2_tfmemocategoryname = "";
         AV40Trn_memocategorywwds_1_filterfulltext = "";
         AV42Trn_memocategorywwds_3_tfmemocategoryname_sel = "";
         AV41Trn_memocategorywwds_2_tfmemocategoryname = "";
         H00AL2_A543MemoCategoryName = new string[] {""} ;
         H00AL2_A542MemoCategoryId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memocategoryww__default(),
            new Object[][] {
                new Object[] {
               H00AL2_A543MemoCategoryName, H00AL2_A542MemoCategoryId
               }
               , new Object[] {
      ...
      private int edtMemoCategoryName_Enabled ;
      private int edtMemoCategoryName_Visible ;
      ...
      private string edtMemoCategoryName_Internalname ;
      private string cmbavActiongroup_Internalname ;
      private string cmbavActiongroup_Class ;
      private string edtMemoCategoryName_Link ;
      ...
      private string edtMemoCategoryName_Jsonclick ;
      ...
      private bool AV33IsAuthorized_MemoCategoryName ;
      ...
      private string AV24TFMemoCategoryName ;
      private string AV25TFMemoCategoryName_Sel ;
      private string AV32GridAppliedFilters ;
      private string A543MemoCategoryName ;
      private string lV40Trn_memocategorywwds_1_filterfulltext ;
      private string lV41Trn_memocategorywwds_2_tfmemocategoryname ;
      private string AV40Trn_memocategorywwds_1_filterfulltext ;
      private string AV42Trn_memocategorywwds_3_tfmemocategoryname_sel ;
      private string AV41Trn_memocategorywwds_2_tfmemocategoryname ;
      ...
      private string[] H00AL2_A543MemoCategoryName ;
      private Guid[] H00AL2_A542MemoCategoryId ;
   ...
   public class trn_memocategoryww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00AL2( IGxContext context ,
                                             string AV40Trn_memocategorywwds_1_filterfulltext ,
                                             string AV42Trn_memocategorywwds_3_tfmemocategoryname_sel ,
                                             string AV41Trn_memocategorywwds_2_tfmemocategoryname ,
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40Trn_memocategorywwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(MemoCategoryName) like '%' || LOWER(:lV40Trn_memocategorywwds_1_filterfulltext)))");
         }
         else
         {
            GXv_int5[0] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV42Trn_memocategorywwds_3_tfmemocategoryname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41Trn_memocategorywwds_2_tfmemocategoryname)) ) )
         {
            AddWhere(sWhereString, "(MemoCategoryName like :lV41Trn_memocategorywwds_2_tfmemocategoryname)");
         }
         else
         {
            GXv_int5[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV42Trn_memocategorywwds_3_tfmemocategoryname_sel)) && ! ( StringUtil.StrCmp(AV42Trn_memocategorywwds_3_tfmemocategoryname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(MemoCategoryName = ( :AV42Trn_memocategorywwds_3_tfmemocategoryname_sel))");
         }
         else
         {
            GXv_int5[2] = 1;
         }
         if ( StringUtil.StrCmp(AV42Trn_memocategorywwds_3_tfmemocategoryname_sel, "<#Empty#>") == 0 )
         {
         ...
         {
            sOrderString += " ORDER BY MemoCategoryName DESC, MemoCategoryId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY MemoCategoryId";
         }
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM Trn_MemoCategory";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40Trn_memocategorywwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(MemoCategoryName) like '%' || LOWER(:lV40Trn_memocategorywwds_1_filterfulltext)))");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00AL2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H00AL3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV40Trn_memocategorywwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV41Trn_memocategorywwds_2_tfmemocategoryname",GXType.VarChar,100,0) ,
          new ParDef("AV42Trn_memocategorywwds_3_tfmemocategoryname_sel",GXType.VarChar,100,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00AL2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AL2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00AL3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AL3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
