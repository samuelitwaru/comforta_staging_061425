...
namespace GeneXus.Programs {
   public class trn_residentpackage : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_label_element( context, edtResidentPackageName_Internalname, context.GetMessage( "Group Name", ""), "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 20,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtResidentPackageName_Internalname, A531ResidentPackageName, StringUtil.RTrim( context.localUtil.Format( A531ResidentPackageName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentPackageName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtResidentPackageName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_ResidentPackage.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockresidentpackagemodules_Internalname, context.GetMessage( "Group Access Rights", ""), "", "", lblTextblockresidentpackagemodules_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentPackage.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtResidentPackageModules_Internalname, A532ResidentPackageModules, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", 0, 1, edtResidentPackageModules_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_ResidentPackage.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               A533ResidentPackageDefault = StringUtil.StrToBool( cgiGet( edtResidentPackageDefault_Internalname));
               AssignAttri("", false, "A533ResidentPackageDefault", A533ResidentPackageDefault);
      ...
      protected void E111M2( )
      {
         ...
         edtResidentPackageDefault_Visible = 0;
         AssignProp("", false, edtResidentPackageDefault_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtResidentPackageDefault_Visible), 5, 0), true);
         GXt_char2 = AV36ResidentTitle;
         new prc_getorganisationdefinition(context ).execute(  "Resident", out  GXt_char2) ;
         AV36ResidentTitle = GXt_char2;
         AssignAttri("", false, "AV36ResidentTitle", AV36ResidentTitle);
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTTITLE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV36ResidentTitle, "")), context));
         Combo_residentpackagemodules_Tooltip = context.GetMessage( "Select which modules this group has access to", "");
         ucCombo_residentpackagemodules.SendProperty(context, "", false, Combo_residentpackagemodules_Internalname, "Tooltip", Combo_residentpackagemodules_Tooltip);
      }
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         GXt_objcol_SdtDVB_SDTComboData_Item3 = AV35ListOfResidents_Data;
         new trn_residentpackageloaddvcombo(context ).execute(  "ListOfResidents",  Gx_mode,  AV7ResidentPackageId, out  AV20ComboSelectedValue, out  AV21ComboSelectedText, out  GXt_objcol_SdtDVB_SDTComboData_Item3) ;
         AV35ListOfResidents_Data = GXt_objcol_SdtDVB_SDTComboData_Item3;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         GXt_objcol_SdtDVB_SDTComboData_Item3 = AV18ResidentPackageModules_Data;
         new trn_residentpackageloaddvcombo(context ).execute(  "ResidentPackageModules",  Gx_mode,  AV7ResidentPackageId, out  AV20ComboSelectedValue, out  AV21ComboSelectedText, out  GXt_objcol_SdtDVB_SDTComboData_Item3) ;
         AV18ResidentPackageModules_Data = GXt_objcol_SdtDVB_SDTComboData_Item3;
      ...
      protected void standaloneNotModal( )
      {
         ...
         AV38Pgmname = "Trn_ResidentPackage";
      ...
      protected void standaloneModal( )
      {
         ...
         {
            GXt_guid4 = A529SG_OrganisationId;
            new prc_getuserorganisationid(context ).execute( out  GXt_guid4) ;
            A529SG_OrganisationId = GXt_guid4;
            AssignAttri("", false, "A529SG_OrganisationId", A529SG_OrganisationId.ToString());
         }
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (Guid.Empty==AV32Insert_SG_LocationId) )
         {
      ...
      protected void DisableAttributes1M96( )
      {
         ...
         edtSG_LocationId_Enabled = 0;
         AssignProp("", false, edtSG_LocationId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSG_LocationId_Enabled), 5, 0), true);
         edtResidentPackageDefault_Enabled = 0;
         AssignProp("", false, edtResidentPackageDefault_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentPackageDefault_Enabled), 5, 0), true);
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vRESIDENTTITLE", AV36ResidentTitle);
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTTITLE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV36ResidentTitle, "")), context));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202572585691", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentpackage.js", "?202572585694", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtResidentPackageDefault_Internalname = "RESIDENTPACKAGEDEFAULT";
      ...
      public override void initialize_properties( )
      {
         ...
         edtResidentPackageDefault_Visible = 1;
      ...
      public void Valid_Residentpackagedefault( )
      {
         n527ResidentPackageId = false;
         if ( A533ResidentPackageDefault )
         {
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV36ResidentTitle","fld":"vRESIDENTTITLE","hsh":true},{"av":"AV8WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV11TrnContext","fld":"vTRNCONTEXT","hsh":true},{"av":"AV7ResidentPackageId","fld":"vRESIDENTPACKAGEID","hsh":true}]}""");
         setEventMetadata("AFTER TRN","""{"handler":"E121M2","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV36ResidentTitle","fld":"vRESIDENTTITLE","hsh":true},{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"AV34ListOfResidents","fld":"vLISTOFRESIDENTS"},{"av":"AV8WWPContext","fld":"vWWPCONTEXT","hsh":true},{"av":"AV11TrnContext","fld":"vTRNCONTEXT","hsh":true}]}""");
         ...
         setEventMetadata("VALID_SG_ORGANISATIONID","""{"handler":"Valid_Sg_organisationid","iparms":[]}""");
         setEventMetadata("VALID_SG_LOCATIONID","""{"handler":"Valid_Sg_locationid","iparms":[{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A529SG_OrganisationId","fld":"SG_ORGANISATIONID"}]}""");
         setEventMetadata("VALID_RESIDENTPACKAGEDEFAULT","""{"handler":"Valid_Residentpackagedefault","iparms":[{"av":"A527ResidentPackageId","fld":"RESIDENTPACKAGEID"},{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"},{"av":"A533ResidentPackageDefault","fld":"RESIDENTPACKAGEDEFAULT"}]""");
         setEventMetadata("VALID_RESIDENTPACKAGEDEFAULT",""","oparms":[{"av":"A528SG_LocationId","fld":"SG_LOCATIONID"}]}""");
         return  ;
      }
      ...
      private int edtResidentPackageDefault_Visible ;
