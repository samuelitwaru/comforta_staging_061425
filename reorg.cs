...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTrn_DynamicTranslation( )
      {
         string cmdBuffer = "";
         /* Indices for table Trn_DynamicTranslation */
         cmdBuffer=" ALTER TABLE Trn_DynamicTranslation ADD DynamicTranslationEnglishPubli TEXT NOT NULL DEFAULT '', ADD DynamicTranslationDutchPublish TEXT NOT NULL DEFAULT '' "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE Trn_DynamicTranslation ALTER COLUMN DynamicTranslationEnglishPubli DROP DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE Trn_DynamicTranslation ALTER COLUMN DynamicTranslationDutchPublish DROP DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE INDEX UTRN_DYNAMICTRANSLATION ON Trn_DynamicTranslation (DynamicTranslationPrimaryKey ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX UTRN_DYNAMICTRANSLATION "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         ...
         try
         {
            cmdBuffer=" CREATE INDEX UTRN_DYNAMICTRANSLATION1 ON Trn_DynamicTranslation (DynamicTranslationTrnName ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX UTRN_DYNAMICTRANSLATION1 "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE INDEX UTRN_DYNAMICTRANSLATION2 ON Trn_DynamicTranslation (DynamicTranslationAttributeNam ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX UTRN_DYNAMICTRANSLATION2 "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            Trn_DynamicTranslationCount = P00012_ATrn_DynamicTranslationCount[0];
            pr_default.close(0);
            PrintRecordCount ( "Trn_DynamicTranslation" ,  Trn_DynamicTranslationCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Trn_DynamicTranslation",sSchemaVar,"DynamicTranslationEnglishPubli") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"DynamicTranslationEnglishPubli", "Trn_DynamicTranslation"}) ) ;
            return false ;
         }
         if ( ColumnExist("Trn_DynamicTranslation",sSchemaVar,"DynamicTranslationDutchPublish") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"DynamicTranslationDutchPublish", "Trn_DynamicTranslation"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeTrn_DynamicTranslation" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"Trn_DynamicTranslation", ""}) );
      }
      ...
      {
         P00012_ATrn_DynamicTranslationCount = new int[1] ;
         sSchemaVar = "";
         sTableName = "";
         sMySchemaName = "";
         sMyColumnName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reorg__default(),
            new Object[][] {
                new Object[] {
               P00012_ATrn_DynamicTranslationCount
               }
               , new Object[] {
      ...
      protected int Trn_DynamicTranslationCount ;
      ...
      protected int[] P00012_ATrn_DynamicTranslationCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM Trn_DynamicTranslation ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
