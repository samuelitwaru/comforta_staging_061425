...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTrn_Media( )
      {
         ...
         cmdBuffer=" ALTER TABLE Trn_Media ALTER COLUMN MediaId DROP DEFAULT "
         ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" DROP TABLE GXA0076 CASCADE "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               try
               {
                  cmdBuffer=" DROP VIEW GXA0076 CASCADE "
                  ;
                  RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                  RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
                  RGZ.ExecuteStmt() ;
               ...
               catch
               {
                  try
                  {
                     cmdBuffer=" DROP FUNCTION GXA0076 CASCADE "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         ...
         /* API remote call */
         new trn_mediaconversion(context ).execute( ) ;
         try
         {
         ...
         cmdBuffer=" ALTER TABLE GXA0076 RENAME TO Trn_Media "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE Trn_Media ADD CONSTRAINT Trn_Media_pkey PRIMARY KEY(MediaId) "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ! tableexist("Trn_Media",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_not_exist", new   object[]  {"Trn_Media"}) ) ;
            return false ;
         }
         if ( tableexist("Trn_CroppedMedia",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"Trn_CroppedMedia"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "RITrn_CroppedMediaTrn_Media" , new Object[]{ });
      }
      ...
      private void SetPrecedencetables( )
      {
         ...
         ReorgExecute.RegisterPrecedence( "CreateTrn_CroppedMedia" ,  "ReorganizeTrn_Media" );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_CROPPEDMEDIA1"}) );
         ReorgExecute.RegisterPrecedence( "RITrn_CroppedMediaTrn_Media" ,  "CreateTrn_CroppedMedia" );
         ReorgExecute.RegisterPrecedence( "RITrn_CroppedMediaTrn_Media" ,  "ReorganizeTrn_Media" );
      }
