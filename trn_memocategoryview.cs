...
namespace GeneXus.Programs {
   public class trn_memocategoryview : GXDataArea
   {
      public trn_memocategoryview( )
      {
      ...
      public trn_memocategoryview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_MemoCategoryId ,
                           string aP1_TabCode )
      {
         this.AV10MemoCategoryId = aP0_MemoCategoryId;
      ...
      {
         get {
            return "trn_memocategoryview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_memocategoryview.aspx"+UrlEncode(AV10MemoCategoryId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_memocategoryview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMEMOCATEGORYID", AV10MemoCategoryId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vMEMOCATEGORYID", GetSecureSignedToken( "", AV10MemoCategoryId, context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Trn_memowc == null ) )
         {
            WebComp_Trn_memowc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_memocategoryview.aspx"+UrlEncode(AV10MemoCategoryId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_memocategoryview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_MemoCategoryView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Memo Category View", "") ;
      }
      ...
      protected void WBAK0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_MemoCategoryView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_memo_title_Internalname, context.GetMessage( "Memo", ""), "", "", lblTrn_memo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_MemoCategoryView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Trn_Memo") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtabletrn_memo_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0035"+"", StringUtil.RTrim( WebComp_Trn_memowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0035"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Trn_memowc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_memowc), StringUtil.Lower( WebComp_Trn_memowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0035"+"");
                  }
                  WebComp_Trn_memowc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_memowc), StringUtil.Lower( WebComp_Trn_memowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void STARTAK2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Memo Category View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldTrn_memowc = cgiGet( "W0035");
                           if ( ( StringUtil.Len( OldTrn_memowc) == 0 ) || ( StringUtil.StrCmp(OldTrn_memowc, WebComp_Trn_memowc_Component) != 0 ) )
                           {
                              WebComp_Trn_memowc = getWebComponent(GetType(), "GeneXus.Programs", OldTrn_memowc, new Object[] {context} );
                              WebComp_Trn_memowc.ComponentInit();
                              WebComp_Trn_memowc.Name = "OldTrn_memowc";
                              WebComp_Trn_memowc_Component = OldTrn_memowc;
                           }
                           if ( StringUtil.Len( WebComp_Trn_memowc_Component) != 0 )
                           {
                              WebComp_Trn_memowc.componentprocess("W0035", "", sEvt);
                           }
                           WebComp_Trn_memowc_Component = OldTrn_memowc;
                        }
                        else if ( nCmpId == 40 )
      ...
      protected void PAAK2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_memocategoryview.aspx")), "trn_memocategoryview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_memocategoryview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10MemoCategoryId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10MemoCategoryId", AV10MemoCategoryId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vMEMOCATEGORYID", GetSecureSignedToken( "", AV10MemoCategoryId, context));
      ...
      protected void RFAK2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Trn_memowc_Component) != 0 )
               {
                  WebComp_Trn_memowc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         {
            /* Using cursor H00AK2 */
            pr_default.execute(0, new Object[] {AV10MemoCategoryId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A542MemoCategoryId = H00AK2_A542MemoCategoryId[0];
               /* Execute user event: Load */
               E16AK2 ();
      ...
      protected void send_integrity_lvl_hashesAK2( )
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV14RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV16IsAuthorized_Discussions);
      ...
      protected void E14AK2( )
      {
         ...
         AV17GXLvl8 = 0;
         /* Using cursor H00AK3 */
         pr_default.execute(1, new Object[] {AV10MemoCategoryId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A542MemoCategoryId = H00AK3_A542MemoCategoryId[0];
            A543MemoCategoryName = H00AK3_A543MemoCategoryName[0];
            AV17GXLvl8 = 1;
            Form.Caption = A543MemoCategoryName;
      ...
      protected void E15AK2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_MemoCategory",  StringUtil.Trim( A542MemoCategoryId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_MemoCategory",  2) )
         {
      ...
      protected void E11AK2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_MemoCategory",(short)2,StringUtil.Trim( A542MemoCategoryId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12AK2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0040",(string)"",(string)"Trn_MemoCategory",StringUtil.Trim( A542MemoCategoryId.ToString()),(string)AV14RecordDescription,formatLink("trn_memocategoryview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Trn_MemoCategoryGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_memocategorygeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Trn_MemoCategoryGeneral";
               WebComp_Generalwc_Component = "Trn_MemoCategoryGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0027",(string)"",(Guid)AV10MemoCategoryId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "Trn_Memo") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Trn_memowc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Trn_memowc_Component), StringUtil.Lower( "Trn_MemoCategoryTrn_MemoWC")) != 0 )
            {
               WebComp_Trn_memowc = getWebComponent(GetType(), "GeneXus.Programs", "trn_memocategorytrn_memowc", new Object[] {context} );
               WebComp_Trn_memowc.ComponentInit();
               WebComp_Trn_memowc.Name = "Trn_MemoCategoryTrn_MemoWC";
               WebComp_Trn_memowc_Component = "Trn_MemoCategoryTrn_MemoWC";
            }
            if ( StringUtil.Len( WebComp_Trn_memowc_Component) != 0 )
            {
               WebComp_Trn_memowc.setjustcreated();
               WebComp_Trn_memowc.componentprepare(new Object[] {(string)"W0035",(string)"",(Guid)AV10MemoCategoryId});
               WebComp_Trn_memowc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Trn_memowc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0035"+"");
               WebComp_Trn_memowc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10MemoCategoryId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10MemoCategoryId", AV10MemoCategoryId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vMEMOCATEGORYID", GetSecureSignedToken( "", AV10MemoCategoryId, context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Trn_memowc == null ) )
         {
            if ( StringUtil.Len( WebComp_Trn_memowc_Component) != 0 )
            {
               WebComp_Trn_memowc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017141981", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_memocategoryview.js", "?202562017141981", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTrn_memo_title_Internalname = "TRN_MEMO_TITLE";
         divUnnamedtabletrn_memo_Internalname = "UNNAMEDTABLETRN_MEMO";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Memo Category View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A542MemoCategoryId","fld":"MEMOCATEGORYID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10MemoCategoryId","fld":"vMEMOCATEGORYID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11AK2","iparms":[{"av":"A542MemoCategoryId","fld":"MEMOCATEGORYID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12AK2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A542MemoCategoryId","fld":"MEMOCATEGORYID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13AK2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10MemoCategoryId","fld":"vMEMOCATEGORYID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"GENERALWC"},{"ctrl":"TRN_MEMOWC"}]}""");
         return  ;
      }
      ...
      {
         wcpOAV10MemoCategoryId = Guid.Empty;
         wcpOAV8TabCode = "";
         ...
         OldGeneralwc = "";
         lblTrn_memo_title_Jsonclick = "";
         WebComp_Trn_memowc_Component = "";
         OldTrn_memowc = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00AK2_A542MemoCategoryId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00AK3_A542MemoCategoryId = new Guid[] {Guid.Empty} ;
         H00AK3_A543MemoCategoryName = new string[] {""} ;
         A543MemoCategoryName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_memocategoryview__default(),
            new Object[][] {
                new Object[] {
               H00AK2_A542MemoCategoryId
               }
               , new Object[] {
               H00AK3_A542MemoCategoryId, H00AK3_A543MemoCategoryName
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Trn_memowc = new GeneXus.Http.GXNullWebComponent();
      ...
      private string lblTrn_memo_title_Internalname ;
      private string lblTrn_memo_title_Jsonclick ;
      private string divUnnamedtabletrn_memo_Internalname ;
      private string WebComp_Trn_memowc_Component ;
      private string OldTrn_memowc ;
      ...
      private Guid[] H00AK2_A542MemoCategoryId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00AK3_A542MemoCategoryId ;
      private string[] H00AK3_A543MemoCategoryName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_memocategoryview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10MemoCategoryId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00AK3;
          ...
          def= new CursorDef[] {
              new CursorDef("H00AK2", "SELECT MemoCategoryId FROM Trn_MemoCategory WHERE MemoCategoryId = :AV10MemoCategoryId ORDER BY MemoCategoryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00AK3", "SELECT MemoCategoryId, MemoCategoryName FROM Trn_MemoCategory WHERE MemoCategoryId = :AV10MemoCategoryId ORDER BY MemoCategoryId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00AK3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
