   ...
   public class gamwwrepositories : GXDataArea
   {
      ...
      protected void WB910( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_21_912( true) ;
         }
         else
         {
            wb_table1_21_912( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_912e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E16912( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "gamrepositoryconfiguration_Execute", out  GXt_boolean1) ;
      ...
      protected void E17912( )
      {
         ...
         edtavId_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV47ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavId_Visible), 5, 0), !bGXsfl_40_Refreshing);
         edtavName_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV47ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV70Pgmname, out  GXt_char3) ;
      ...
      protected void E14912( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "GAMWWRepositoriesColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV35ColumnsSelectorXML)) ? "" : AV47ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11912( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "GAMWWRepositoriesFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               S172 ();
               if (returnInSub) return;
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV70Pgmname+"GridState",  AV53ManageFiltersXml) ;
      ...
      protected void S152( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV47ColumnsSelector,  "&Id",  "",  "WWP_GAM_Id",  true,  "") ;
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV47ColumnsSelector,  "&Name",  "",  "WWP_GAM_Name",  true,  "") ;
         GXt_char3 = AV42UserCustomValue;
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "GAMWWRepositoriesColumnsSelector", out  GXt_char3) ;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV42UserCustomValue)) ) )
         {
            ...
            new WorkWithPlus.workwithplus_web.wwp_columnselector_updatecolumns(context ).execute( ref  AV61ColumnsSelectorAux, ref  AV47ColumnsSelector) ;
         }
      }
      ...
      protected void S132( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "gamrepositoryentry_Execute", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMWWRepositoriesFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV33GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV70Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S182( )
      {
         ...
         {
            AV34GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV33GridState.gxTpr_Filtervalues.Item(AV72GXV2));
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV33GridState,  "SEARCH",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV69Search)),  0,  AV69Search,  AV69Search,  false,  "",  "") ;
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV70Pgmname+"GridState",  AV33GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void wb_table1_21_912( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_26_912( true) ;
         }
         else
         {
            wb_table2_26_912( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_912e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_912e( true) ;
         }
         else
         {
            wb_table1_21_912e( false) ;
         }
      }

      protected void wb_table2_26_912( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_912e( true) ;
         }
         else
         {
            wb_table2_26_912e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017131314", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwrepositories.js", "?202562017131321", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18912","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV69Search","fld":"vSEARCH"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV21IsAuthorized_Id","fld":"vISAUTHORIZED_ID","hsh":true}]""");
