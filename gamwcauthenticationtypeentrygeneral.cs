...
namespace GeneXus.Programs {
   public class gamwcauthenticationtypeentrygeneral : GXWebComponent
   {
      ...
      protected void RenderHtmlCloseForm8I2( )
      {
      ...
      protected void WB8I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_258_8I2( true) ;
         }
         else
         {
            wb_table1_258_8I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_258_8I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table2_314_8I2( true) ;
         }
         else
         {
            wb_table2_314_8I2( false) ;
         }
         return  ;
      }

      protected void wb_table2_314_8I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S252( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_Name", ""), "", "", "", "", "", "", "", ""),  "error",  edtavName_Internalname,  "true",  ""));
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_ClientId", ""), "", "", "", "", "", "", "", ""),  "error",  edtavClientid_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_ClientSecret", ""), "", "", "", "", "", "", "", ""),  "error",  edtavClientsecret_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_LocalSiteURL", ""), "", "", "", "", "", "", "", ""),  "error",  edtavSiteurl_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_AutocompleteVirtualDirectory", ""), "", "", "", "", "", "", "", ""),  "error",  chkavAutocompletevirtualdirectory_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_RemoteServerURL", ""), "", "", "", "", "", "", "", ""),  "error",  edtavGamrserverurl_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         if ( ( ( StringUtil.StrCmp(AV69TypeId, "ExternalWebService") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV76WSServerName)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_Servername", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWsservername_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         if ( ( ( StringUtil.StrCmp(AV69TypeId, "ExternalWebService") == 0 ) ) && (0==AV77WSServerPort) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_Serverport", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWsserverport_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         if ( ( ( StringUtil.StrCmp(AV69TypeId, "ExternalWebService") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV72WSName)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_WebServiceName", ""), "", "", "", "", "", "", "", ""),  "error",  edtavWsname_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         if ( ( ( StringUtil.StrCmp(AV69TypeId, "Custom") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV29CusFileName)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_FileName", ""), "", "", "", "", "", "", "", ""),  "error",  edtavCusfilename_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
         if ( ( ( StringUtil.StrCmp(AV69TypeId, "Custom") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV28CusClassName)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_ClassName", ""), "", "", "", "", "", "", "", ""),  "error",  edtavCusclassname_Internalname,  "true",  ""));
            AV83CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV83CheckRequiredFieldsResult", AV83CheckRequiredFieldsResult);
         }
      }
      ...
      protected void wb_table2_314_8I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_314_8I2e( true) ;
         }
         else
         {
            wb_table2_314_8I2e( false) ;
         }
      }

      protected void wb_table1_258_8I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_258_8I2e( true) ;
         }
         else
         {
            wb_table1_258_8I2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256201735857", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("gamwcauthenticationtypeentrygeneral.js", "?20256201735865", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VOTPGENERATIONTYPE.CLICK","""{"handler":"E168I2","iparms":[{"av":"cmbavOtpgenerationtype"},{"av":"AV54OTPGenerationType","fld":"vOTPGENERATIONTYPE"},{"av":"cmbavOtpgenerationtype_customeventgeneratecode"},{"av":"AV55OTPGenerationType_CustomEventGenerateCode","fld":"vOTPGENERATIONTYPE_CUSTOMEVENTGENERATECODE"},{"av":"AV69TypeId","fld":"vTYPEID"},{"av":"AV66TFAEnable","fld":"vTFAENABLE"}]""");
