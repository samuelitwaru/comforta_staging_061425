   ...
   public class wwp_dfc_file_wc : GXWebComponent
   {
      ...
      protected void WB340( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDatatitle_Internalname, lblDatatitle_Caption, "", "", lblDatatitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock AttributeWeightBold", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DFC_File_WC.htm");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", edtavData_Visible, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtavData_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavData_Internalname, context.GetMessage( "Data", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divUcimagescell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            wb_table1_20_342( true) ;
         }
         else
         {
            wb_table1_20_342( false) ;
         }
         return  ;
      }

      protected void wb_table1_20_342e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_33_342( true) ;
         }
         else
         {
            wb_table2_33_342( false) ;
         }
         return  ;
      }

      protected void wb_table2_33_342e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_38_342( true) ;
         }
         else
         {
            wb_table3_38_342( false) ;
         }
         return  ;
      }

      protected void wb_table3_38_342e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void E14342( )
      {
         /* Start Routine */
         returnInSub = false;
         AV25SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformid = AV12WWPForm.gxTpr_Wwpformid;
         AV25SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformversionnumber = AV12WWPForm.gxTpr_Wwpformversionnumber;
         AV25SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformelementid = AV14WWPFormElementId;
         new prc_getdynamicformtranslation(context ).execute( ref  AV25SDT_DynamicFormTranslation) ;
         ...
         S122 ();
         if (returnInSub) return;
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV25SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue)) )
         {
         ...
         {
            lblDatatitle_Caption = AV25SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue;
            AssignProp(sPrefix, false, lblDatatitle_Internalname, "Caption", lblDatatitle_Caption, true);
            divDatatitlecell_Visible = 1;
            AssignProp(sPrefix, false, divDatatitlecell_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divDatatitlecell_Visible), 5, 0), true);
         }
      ...
      protected void wb_table3_38_342( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_38_342e( true) ;
         }
         else
         {
            wb_table3_38_342e( false) ;
         }
      }

      protected void wb_table2_33_342( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_33_342e( true) ;
         }
         else
         {
            wb_table2_33_342e( false) ;
         }
      }

      protected void wb_table1_20_342( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_20_342e( true) ;
         }
         else
         {
            wb_table1_20_342e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256145243033", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_file_wc.js", "?20256145243033", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divUcimagescell_Internalname = sPrefix+"UCIMAGESCELL";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavData_Enabled = 1;
         edtavData_Visible = 1;
         divDatacellname_Class = "col-xs-12 DataContentCell CellDynamicFormImagePaddingLeft DscTop";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV12WWPForm","fld":"vWWPFORM"},{"av":"AV13WWPFormElement","fld":"vWWPFORMELEMENT"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC"},{"av":"AV10WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA"},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"edtavData_Visible","ctrl":"vDATA","prop":"Visible"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV20UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version21");
         AV21FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version21");
         ...
         sEvtType = "";
         GXDecQS = "";
         AV25SDT_DynamicFormTranslation = new SdtSDT_DynamicFormTranslation(context);
      ...
      private string divUcimagescell_Internalname ;
      ...
      private SdtSDT_DynamicFormTranslation AV25SDT_DynamicFormTranslation ;
