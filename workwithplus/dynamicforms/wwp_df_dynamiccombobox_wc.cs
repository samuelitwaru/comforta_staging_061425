...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_dynamiccombobox_wc : GXWebComponent
   {
      ...
      protected void E12212( )
      {
         /* Start Routine */
         returnInSub = false;
         AV43SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformid = AV32WWPFormInstance.gxTpr_Wwpformid;
         AV43SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformversionnumber = AV32WWPFormInstance.gxTpr_Wwpformversionnumber;
         AV43SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformelementid = AV30WWPFormElementId;
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV18HasReferenceId, context));
         AV44GXV1 = 1;
         while ( AV44GXV1 <= AV32WWPFormInstance.gxTpr_Element.Count )
         {
            AV33WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV32WWPFormInstance.gxTpr_Element.Item(AV44GXV1));
      ...
      protected void S152( )
      {
         ...
         AV45GXV2 = 1;
         while ( AV45GXV2 <= AV32WWPFormInstance.gxTpr_Element.Count )
         {
            AV33WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV32WWPFormInstance.gxTpr_Element.Item(AV45GXV2));
            if ( ( AV33WWPFormInstanceElement.gxTpr_Wwpformelementid == AV30WWPFormElementId ) && ( AV33WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV8WWPFormInstanceElementId ) )
            {
      ...
      protected void S162( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), AV31WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV16ElementInternalName,  "true",  ""));
            AV21IsValid = false;
         }
         else
         {
            if ( AV26Validations.Count > 0 )
            {
               ...
               AV46GXV3 = 1;
               while ( AV46GXV3 <= AV23Messages.Count )
               {
                  AV22Message = ((GeneXus.Utils.SdtMessages_Message)AV23Messages.Item(AV46GXV3));
                  GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  AV22Message.gxTpr_Description,  ((AV22Message.gxTpr_Type==1) ? "error" : "info"),  AV16ElementInternalName,  "true",  ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256145243325", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_dynamiccombobox_wc.js", "?20256145243329", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
