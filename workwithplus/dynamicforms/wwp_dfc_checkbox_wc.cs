...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_dfc_checkbox_wc : GXWebComponent
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vSDT_DYNAMICFORMTRANSLATION", AV21SDT_DynamicFormTranslation);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vSDT_DYNAMICFORMTRANSLATION", AV21SDT_DynamicFormTranslation);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSDT_DYNAMICFORMTRANSLATION", GetSecureSignedToken( sPrefix, AV21SDT_DynamicFormTranslation, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void E142U2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV21SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformid = AV6WWPForm.gxTpr_Wwpformid;
         AV21SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformversionnumber = AV6WWPForm.gxTpr_Wwpformversionnumber;
         AV21SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformelementid = AV9WWPFormElementId;
         new prc_getdynamicformtranslation(context ).execute( ref  AV21SDT_DynamicFormTranslation) ;
      ...
      protected void S112( )
      {
         ...
         AssignAttri(sPrefix, false, "AV5Data", AV5Data);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV21SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue)) )
         {
         ...
         {
            chkavData.Caption = AV21SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue;
            AssignProp(sPrefix, false, chkavData_Internalname, "TitleCaption", chkavData.Caption, true);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256201658132", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_checkbox_wc.js", "?20256201658132", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV21SDT_DynamicFormTranslation = new SdtSDT_DynamicFormTranslation(context);
         GX_FocusControl = "";
      ...
      private SdtSDT_DynamicFormTranslation AV21SDT_DynamicFormTranslation ;
