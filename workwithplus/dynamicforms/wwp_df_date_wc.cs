...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_date_wc : GXWebComponent
   {
      ...
      protected void E112N2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV35SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformid = AV30WWPFormInstance.gxTpr_Wwpformid;
         AV35SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformversionnumber = AV30WWPFormInstance.gxTpr_Wwpformversionnumber;
         AV35SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformelementid = AV27WWPFormElementId;
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_date_wc.js", "?202562016572381", false, true);
