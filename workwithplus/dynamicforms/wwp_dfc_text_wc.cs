...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_dfc_text_wc : GXWebComponent
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vSDT_DYNAMICFORMTRANSLATION", AV23SDT_DynamicFormTranslation);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vSDT_DYNAMICFORMTRANSLATION", AV23SDT_DynamicFormTranslation);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSDT_DYNAMICFORMTRANSLATION", GetSecureSignedToken( sPrefix, AV23SDT_DynamicFormTranslation, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      protected void E14332( )
      {
         /* Start Routine */
         returnInSub = false;
         AV23SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformid = AV17WWPForm.gxTpr_Wwpformid;
         AV23SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformversionnumber = AV17WWPForm.gxTpr_Wwpformversionnumber;
         AV23SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationwwpformelementid = AV19WWPFormElementId;
         new prc_getdynamicformtranslation(context ).execute( ref  AV23SDT_DynamicFormTranslation) ;
      ...
      protected void S112( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV23SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue)) )
         {
         ...
         {
            edtavData_Caption = AV23SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue;
            AssignProp(sPrefix, false, edtavData_Internalname, "Caption", edtavData_Caption, true);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562016574795", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_text_wc.js", "?202562016574795", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV7IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true},{"av":"AV8IsLastElement","fld":"vISLASTELEMENT","hsh":true},{"av":"AV10ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true},{"av":"AV15WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true},{"av":"AV23SDT_DynamicFormTranslation","fld":"vSDT_DYNAMICFORMTRANSLATION","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV23SDT_DynamicFormTranslation = new SdtSDT_DynamicFormTranslation(context);
      ...
      private SdtSDT_DynamicFormTranslation AV23SDT_DynamicFormTranslation ;
