...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_textarea_wc : GXWebComponent
   {
      ...
      protected void S182( )
      {
         ...
         {
            edtavData_Caption = AV35SDT_DynamicFormTranslation.gxTpr_Dynamicformtranslationvalue;
            AssignProp(sPrefix, false, edtavData_Internalname, "Caption", edtavData_Caption, true);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562016572765", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_textarea_wc.js", "?202562016572765", false, true);
