...
namespace GeneXus.Programs.workwithplus {
   public class wwp_editconfformattingvalues : GXWebComponent
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRIDS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV12GXV1 = (int)(nGXsfl_15_idx+GRIDS_nFirstRecordOnPage);
                              if ( ( AV6ConfFormattingVariables.Count >= AV12GXV1 ) && ( AV12GXV1 > 0 ) )
                              {
                                 AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV12GXV1));
      ...
      protected void STRUP1I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            while ( nGXsfl_15_fel_idx < nRC_GXsfl_15 )
            {
               ...
               AV12GXV1 = (int)(nGXsfl_15_fel_idx+GRIDS_nFirstRecordOnPage);
               if ( ( AV6ConfFormattingVariables.Count >= AV12GXV1 ) && ( AV12GXV1 > 0 ) )
               {
                  AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV12GXV1));
                  if ( ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999999999L )) ) )
      ...
      private void E151I2( )
      {
         ...
         returnInSub = false;
         AV12GXV1 = 1;
         while ( AV12GXV1 <= AV6ConfFormattingVariables.Count )
         {
            AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV12GXV1));
      ...
      {
         AV12GXV1 = (int)(nGXsfl_15_idx+GRIDS_nFirstRecordOnPage);
         if ( ( AV12GXV1 > 0 ) && ( AV6ConfFormattingVariables.Count >= AV12GXV1 ) )
         {
            AV6ConfFormattingVariables.CurrentItem = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV12GXV1));
         }
         ...
         returnInSub = false;
         AV14GXV3 = 1;
         while ( AV14GXV3 <= AV6ConfFormattingVariables.Count )
         {
            AV5ConfFormattingVariable = ((WorkWithPlus.workwithplus_web.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV14GXV3));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309333872", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?20256309333872", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
