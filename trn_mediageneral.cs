   ...
   public class trn_mediageneral : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A413MediaId", A413MediaId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A413MediaId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_mediageneral.aspx"+UrlEncode(A413MediaId.ToString());
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("MediaUrl", StringUtil.RTrim( context.localUtil.Format( A416MediaUrl, "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA413MediaId", wcpOA413MediaId.ToString());
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      protected void WB7F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtMediaId_Internalname, A413MediaId.ToString(), A413MediaId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMediaId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMediaId_Enabled, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_MediaGeneral.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtMediaName_Internalname, A414MediaName, StringUtil.RTrim( context.localUtil.Format( A414MediaName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMediaName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMediaName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_MediaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgMediaImage_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A415MediaImage_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_Trn_MediaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtMediaType_Internalname, StringUtil.RTrim( A418MediaType), StringUtil.RTrim( context.localUtil.Format( A418MediaType, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMediaType_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMediaType_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_MediaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtMediaUrl_Internalname, A416MediaUrl, StringUtil.RTrim( context.localUtil.Format( A416MediaUrl, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtMediaUrl_Link, edtMediaUrl_Linktarget, "", "", edtMediaUrl_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMediaUrl_Enabled, 0, "url", "", 80, "chr", 1, "row", 1000, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Url", "start", true, "", "HLP_Trn_MediaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", context.GetMessage( "Edit", ""), bttBtnupdate_Jsonclick, 5, context.GetMessage( "Edit", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOUPDATE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_MediaGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      protected void RF7F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A416MediaUrl = H007F2_A416MediaUrl[0];
               AssignAttri(sPrefix, false, "A416MediaUrl", A416MediaUrl);
               A418MediaType = H007F2_A418MediaType[0];
               AssignAttri(sPrefix, false, "A418MediaType", A418MediaType);
               A417MediaSize = H007F2_A417MediaSize[0];
               AssignAttri(sPrefix, false, "A417MediaSize", StringUtil.LTrimStr( (decimal)(A417MediaSize), 8, 0));
               A40000MediaImage_GXI = H007F2_A40000MediaImage_GXI[0];
               n40000MediaImage_GXI = H007F2_n40000MediaImage_GXI[0];
               AssignProp(sPrefix, false, imgMediaImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A415MediaImage)) ? A40000MediaImage_GXI : context.convertURL( context.PathToRelativeUrl( A415MediaImage))), true);
               AssignProp(sPrefix, false, imgMediaImage_Internalname, "SrcSet", context.GetImageSrcSet( A415MediaImage), true);
               A414MediaName = H007F2_A414MediaName[0];
               AssignAttri(sPrefix, false, "A414MediaName", A414MediaName);
               A415MediaImage = H007F2_A415MediaImage[0];
               n415MediaImage = H007F2_n415MediaImage[0];
               AssignAttri(sPrefix, false, "A415MediaImage", A415MediaImage);
               AssignProp(sPrefix, false, imgMediaImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A415MediaImage)) ? A40000MediaImage_GXI : context.convertURL( context.PathToRelativeUrl( A415MediaImage))), true);
               AssignProp(sPrefix, false, imgMediaImage_Internalname, "SrcSet", context.GetImageSrcSet( A415MediaImage), true);
               /* Execute user event: Load */
               E127F2 ();
      ...
      protected void STRUP7F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA413MediaId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA413MediaId"));
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA413MediaId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A413MediaId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A413MediaId", A413MediaId.ToString());
         }
         wcpOA413MediaId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA413MediaId"));
         if ( ! GetJustCreated( ) && ( ( A413MediaId != wcpOA413MediaId ) ) )
         {
            setjustcreated();
         }
         wcpOA413MediaId = A413MediaId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA413MediaId = cgiGet( sPrefix+"A413MediaId_CTRL");
         if ( StringUtil.Len( sCtrlA413MediaId) > 0 )
         {
            A413MediaId = StringUtil.StrToGuid( cgiGet( sCtrlA413MediaId));
            AssignAttri(sPrefix, false, "A413MediaId", A413MediaId.ToString());
         }
         else
         {
            A413MediaId = StringUtil.StrToGuid( cgiGet( sPrefix+"A413MediaId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A413MediaId_PARM", A413MediaId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA413MediaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A413MediaId_CTRL", StringUtil.RTrim( sCtrlA413MediaId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256145351839", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_mediageneral.js", "?20256145351839", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A413MediaId","fld":"MEDIAID"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A416MediaUrl","fld":"MEDIAURL"}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E137F2","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A413MediaId","fld":"MEDIAID"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E147F2","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A413MediaId","fld":"MEDIAID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H007F2_A413MediaId = new Guid[] {Guid.Empty} ;
         H007F2_A416MediaUrl = new string[] {""} ;
         H007F2_A418MediaType = new string[] {""} ;
         H007F2_A417MediaSize = new int[1] ;
         H007F2_A40000MediaImage_GXI = new string[] {""} ;
         H007F2_n40000MediaImage_GXI = new bool[] {false} ;
         H007F2_A414MediaName = new string[] {""} ;
         H007F2_A415MediaImage = new string[] {""} ;
         H007F2_n415MediaImage = new bool[] {false} ;
         hsh = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_mediageneral__default(),
            new Object[][] {
                new Object[] {
               H007F2_A413MediaId, H007F2_A416MediaUrl, H007F2_A418MediaType, H007F2_A417MediaSize, H007F2_A40000MediaImage_GXI, H007F2_n40000MediaImage_GXI, H007F2_A414MediaName, H007F2_A415MediaImage, H007F2_n415MediaImage
               }
            }
         );
         AV14Pgmname = "Trn_MediaGeneral";
      ...
      private string hsh ;
      private string sCtrlA413MediaId ;
      ...
      private Guid[] H007F2_A413MediaId ;
      private string[] H007F2_A416MediaUrl ;
      private string[] H007F2_A418MediaType ;
      private int[] H007F2_A417MediaSize ;
      private string[] H007F2_A40000MediaImage_GXI ;
      private bool[] H007F2_n40000MediaImage_GXI ;
      private string[] H007F2_A414MediaName ;
      private string[] H007F2_A415MediaImage ;
      private bool[] H007F2_n415MediaImage ;
   ...
   public class trn_mediageneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007F2", "SELECT MediaId, MediaUrl, MediaType, MediaSize, MediaImage_GXI, MediaName, MediaImage FROM Trn_Media WHERE MediaId = :MediaId ORDER BY MediaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007F2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
