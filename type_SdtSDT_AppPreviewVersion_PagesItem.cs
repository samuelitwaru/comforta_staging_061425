...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_AppPreviewVersion.PagesItem" , Namespace="Comforta_version2" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_AppPreviewVersion.PagesItem", Namespace="Comforta_version2")]
