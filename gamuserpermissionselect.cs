   ...
   public class gamuserpermissionselect : GXDataArea
   {
      ...
      protected void WB8E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_12_8E2( true) ;
         }
         else
         {
            wb_table1_12_8E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_8E2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void S132( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV38GridState,  "SEARCH",  context.GetMessage( "WWP_GAM_Search", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV26Search)),  0,  AV26Search,  AV26Search,  false,  "",  "") ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV38GridState,  "PERMISSIONACCESSTYPE",  context.GetMessage( "WWP_GAM_AccessType", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV21PermissionAccessType)),  0,  AV21PermissionAccessType,  AV21PermissionAccessType,  false,  "",  "") ;
      ...
      protected void wb_table1_12_8E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_17_8E2( true) ;
         }
         else
         {
            wb_table2_17_8E2( false) ;
         }
         return  ;
      }

      protected void wb_table2_17_8E2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_12_8E2e( true) ;
         }
         else
         {
            wb_table1_12_8E2e( false) ;
         }
      }

      protected void wb_table2_17_8E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_17_8E2e( true) ;
         }
         else
         {
            wb_table2_17_8E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017103373", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamuserpermissionselect.js", "?202562017103375", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
