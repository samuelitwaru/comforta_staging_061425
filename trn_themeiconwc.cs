...
namespace GeneXus.Programs {
   public class trn_themeiconwc : GXWebComponent
   {
      ...
      protected void RenderHtmlCloseForm7Q2( )
      {
      ...
      protected void WB7Q0( )
      {
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTrn_ThemeId_Internalname, A273Trn_ThemeId.ToString(), A273Trn_ThemeId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_ThemeId_Jsonclick, 0, "Attribute", "", "", "", "", edtTrn_ThemeId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ThemeIconWC.htm");
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A282IconId = StringUtil.StrToGuid( cgiGet( edtIconId_Internalname));
      ...
      protected void RF7Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A273Trn_ThemeId = H007Q2_A273Trn_ThemeId[0];
               AssignAttri(sPrefix, false, "A273Trn_ThemeId", A273Trn_ThemeId.ToString());
               A284IconSVG = H007Q2_A284IconSVG[0];
               A283IconName = H007Q2_A283IconName[0];
               A443IconCategory = H007Q2_A443IconCategory[0];
               A282IconId = H007Q2_A282IconId[0];
               /* Execute user event: Grid.Load */
               E167Q2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H007Q3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561716202668", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_themeiconwc.js", "?202561716202669", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl15( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A282IconId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A443IconCategory));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A283IconName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A284IconSVG));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E167Q2","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         A284IconSVG = "";
         GXDecQS = "";
         H007Q2_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         H007Q2_A284IconSVG = new string[] {""} ;
         H007Q2_A283IconName = new string[] {""} ;
         H007Q2_A443IconCategory = new string[] {""} ;
         H007Q2_A282IconId = new Guid[] {Guid.Empty} ;
         H007Q3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_themeiconwc__default(),
            new Object[][] {
                new Object[] {
               H007Q2_A273Trn_ThemeId, H007Q2_A284IconSVG, H007Q2_A283IconName, H007Q2_A443IconCategory, H007Q2_A282IconId
               }
               , new Object[] {
               H007Q3_AGRID_nRecordCount
               }
            }
         );
         AV23Pgmname = "Trn_ThemeIconWC";
      ...
      private Guid[] H007Q2_A273Trn_ThemeId ;
      private string[] H007Q2_A284IconSVG ;
      private string[] H007Q2_A283IconName ;
      private string[] H007Q2_A443IconCategory ;
      private Guid[] H007Q2_A282IconId ;
      private long[] H007Q3_AGRID_nRecordCount ;
   ...
   {
      protected Object[] conditional_H007Q2( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid AV8Trn_ThemeId ,
      ...
      protected Object[] conditional_H007Q3( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid AV8Trn_ThemeId ,
                                             Guid A273Trn_ThemeId )
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007Q2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 1 :
                     return conditional_H007Q3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007Q2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Q2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007Q3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Q3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
