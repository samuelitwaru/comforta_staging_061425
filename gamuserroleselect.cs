   ...
   public class gamuserroleselect : GXDataArea
   {
      ...
      protected void WB8D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8D2( true) ;
         }
         else
         {
            wb_table1_14_8D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E168D2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV48Pgmname, out  GXt_char1) ;
      ...
      protected void E118D2( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "GAMUserRoleSelectFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char1) ;
            ...
            else
            {
               ...
               S142 ();
               if (returnInSub) return;
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV48Pgmname+"GridState",  AV41ManageFiltersXml) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "GAMUserRoleSelectFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item2) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV37GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV48Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S152( )
      {
         ...
         {
            AV38GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV37GridState.gxTpr_Filtervalues.Item(AV55GXV6));
      ...
      protected void S132( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV37GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV12FilName)),  0,  AV12FilName,  AV12FilName,  false,  "",  "") ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV37GridState,  "GAMDESCRIPTIONLONG",  context.GetMessage( "WWP_GAM_ExternalId", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV28GAMDescriptionLong)),  0,  AV28GAMDescriptionLong,  AV28GAMDescriptionLong,  false,  "",  "") ;
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV48Pgmname+"GridState",  AV37GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void wb_table1_14_8D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_19_8D2( true) ;
         }
         else
         {
            wb_table2_19_8D2( false) ;
         }
         return  ;
      }

      protected void wb_table2_19_8D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_8D2e( true) ;
         }
         else
         {
            wb_table1_14_8D2e( false) ;
         }
      }

      protected void wb_table2_19_8D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_19_8D2e( true) ;
         }
         else
         {
            wb_table2_19_8D2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256201710564", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamuserroleselect.js", "?202562017105610", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOADDSELECTED'","""{"handler":"E148D2","iparms":[{"av":"AV22UserId","fld":"vUSERID","hsh":true},{"av":"AV21Select","fld":"vSELECT","grid":38},{"av":"GRID_nFirstRecordOnPage"},{"av":"nRC_GXsfl_38","ctrl":"GRID","grid":38,"prop":"GridRC","grid":38},{"av":"AV16Id","fld":"vID","grid":38,"pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV17isOK","fld":"vISOK"}]""");
