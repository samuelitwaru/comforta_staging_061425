...
namespace GeneXus.Programs {
   public class dp_residentprovisioning : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<SdtSDT_ResidentProvisioning_SDT_ResidentProvisioningItem>( context, "SDT_ResidentProvisioningItem", "Comforta_version21") ;
         initialize();
         ExecuteImpl();
