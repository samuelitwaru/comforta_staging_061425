...
namespace GeneXus.Programs {
   public class trn_calltoactionloaddvcombo : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A13OrganisationName = P007G2_A13OrganisationName[0];
               A11OrganisationId = P007G2_A11OrganisationId[0];
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  {
                     A339CallToActionId = P007G3_A339CallToActionId[0];
                     A11OrganisationId = P007G3_A11OrganisationId[0];
                     A13OrganisationName = P007G3_A13OrganisationName[0];
                     A13OrganisationName = P007G3_A13OrganisationName[0];
               ...
               else
               {
                  ...
                  {
                     A11OrganisationId = P007G4_A11OrganisationId[0];
                     A13OrganisationName = P007G4_A13OrganisationName[0];
                     AV23SelectedText = A13OrganisationName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      public override void initialize( )
      {
         ...
         lV14SearchTxt = "";
         A13OrganisationName = "";
         P007G2_A13OrganisationName = new string[] {""} ;
         P007G2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         A11OrganisationId = Guid.Empty;
         AV16Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         AV15Combo_Data = new GXBaseCollection<WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item>( context, "Item", "");
         P007G3_A339CallToActionId = new Guid[] {Guid.Empty} ;
         P007G3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P007G3_A13OrganisationName = new string[] {""} ;
         A339CallToActionId = Guid.Empty;
         AV28OrganisationId = Guid.Empty;
         P007G4_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P007G4_A13OrganisationName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_calltoactionloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P007G2_A13OrganisationName, P007G2_A11OrganisationId
               }
               , new Object[] {
               P007G3_A339CallToActionId, P007G3_A11OrganisationId, P007G3_A13OrganisationName
               }
               , new Object[] {
               P007G4_A11OrganisationId, P007G4_A13OrganisationName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P007G2_A13OrganisationName ;
      private Guid[] P007G2_A11OrganisationId ;
      ...
      private Guid[] P007G3_A339CallToActionId ;
      private Guid[] P007G3_A11OrganisationId ;
      private string[] P007G3_A13OrganisationName ;
      private Guid[] P007G4_A11OrganisationId ;
      private string[] P007G4_A13OrganisationName ;
   ...
   public class trn_calltoactionloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P007G2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P007G2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007G2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P007G3", "SELECT T1.CallToActionId, T1.OrganisationId, T2.OrganisationName FROM (Trn_CallToAction T1 INNER JOIN Trn_Organisation T2 ON T2.OrganisationId = T1.OrganisationId) WHERE T1.CallToActionId = :AV20CallToActionId ORDER BY T1.CallToActionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007G3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007G4", "SELECT OrganisationId, OrganisationName FROM Trn_Organisation WHERE OrganisationId = :AV28OrganisationId ORDER BY OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007G4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
