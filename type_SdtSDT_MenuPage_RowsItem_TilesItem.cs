...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_MenuPage.RowsItem.TilesItem" , Namespace="Comforta_version21" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_MenuPage.RowsItem.TilesItem", Namespace="Comforta_version21")]
