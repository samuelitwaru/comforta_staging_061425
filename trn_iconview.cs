...
namespace GeneXus.Programs {
   public class trn_iconview : GXDataArea
   {
      public trn_iconview( )
      {
      ...
      public trn_iconview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_Trn_IconId ,
                           string aP1_TabCode )
      {
         this.AV9Trn_IconId = aP0_Trn_IconId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_iconview.aspx"+UrlEncode(AV9Trn_IconId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_iconview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTRN_ICONID", AV9Trn_IconId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_ICONID", GetSecureSignedToken( "", AV9Trn_IconId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_iconview.aspx"+UrlEncode(AV9Trn_IconId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode));
         return formatLink("trn_iconview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "Trn_Icon View", "") ;
      }
      ...
      protected void WBBT0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Trn_Icon", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_IconView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_icongeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void STARTBT2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Icon View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PABT2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_iconview.aspx")), "trn_iconview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_iconview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV9Trn_IconId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV9Trn_IconId", AV9Trn_IconId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vTRN_ICONID", GetSecureSignedToken( "", AV9Trn_IconId, context));
      ...
      protected void RFBT2( )
      {
         ...
         {
            /* Using cursor H00BT2 */
            pr_default.execute(0, new Object[] {AV9Trn_IconId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A649Trn_IconId = H00BT2_A649Trn_IconId[0];
               /* Execute user event: Load */
               E15BT2 ();
      ...
      protected void send_integrity_lvl_hashesBT2( )
      {
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV13RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13RecordDescription, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV15IsAuthorized_Discussions);
      ...
      protected void E13BT2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_iconww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00BT3 */
         pr_default.execute(1, new Object[] {AV9Trn_IconId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A649Trn_IconId = H00BT3_A649Trn_IconId[0];
            AV16GXLvl9 = 1;
            AV8Exists = true;
            /* Exiting from a For First loop. */
            if (true) break;
      ...
      protected void E14BT2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Icon",  StringUtil.Trim( A649Trn_IconId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Icon",  2) )
         {
      ...
      protected void E11BT2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Icon",(short)2,StringUtil.Trim( A649Trn_IconId.ToString()),(string)AV13RecordDescription});
      ...
      protected void E12BT2( )
      {
         ...
         if ( AV15IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Icon",StringUtil.Trim( A649Trn_IconId.ToString()),(string)AV13RecordDescription,formatLink("trn_iconview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_IconGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_icongeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_IconGeneral";
            WebComp_Webcomponent_general_Component = "Trn_IconGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV9Trn_IconId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9Trn_IconId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV9Trn_IconId", AV9Trn_IconId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_ICONID", GetSecureSignedToken( "", AV9Trn_IconId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562611245233", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_iconview.js", "?202562611245233", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_icongeneral_cell_Internalname = "TRN_ICONGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Icon View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A649Trn_IconId","fld":"TRN_ICONID"},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV15IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV9Trn_IconId","fld":"vTRN_ICONID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11BT2","iparms":[{"av":"A649Trn_IconId","fld":"TRN_ICONID"},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12BT2","iparms":[{"av":"AV15IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV13RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A649Trn_IconId","fld":"TRN_ICONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00BT2_A649Trn_IconId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00BT3_A649Trn_IconId = new Guid[] {Guid.Empty} ;
         AV14Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_iconview__default(),
            new Object[][] {
                new Object[] {
               H00BT2_A649Trn_IconId
               }
               , new Object[] {
               H00BT3_A649Trn_IconId
               }
            }
         );
      ...
      private string divTrn_icongeneral_cell_Internalname ;
      ...
      private Guid AV9Trn_IconId ;
      private Guid wcpOAV9Trn_IconId ;
      ...
      private Guid[] H00BT2_A649Trn_IconId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00BT3_A649Trn_IconId ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_iconview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV9Trn_IconId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00BT3;
          ...
          def= new CursorDef[] {
              new CursorDef("H00BT2", "SELECT Trn_IconId FROM Trn_Icon WHERE Trn_IconId = :AV9Trn_IconId ORDER BY Trn_IconId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BT2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00BT3", "SELECT Trn_IconId FROM Trn_Icon WHERE Trn_IconId = :AV9Trn_IconId ORDER BY Trn_IconId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BT3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
