...
namespace GeneXus.Programs {
   public class prc_subscribereceptioniststodiscussion : GXProcedure
   {
      public prc_subscribereceptioniststodiscussion( )
      {
      ...
      public prc_subscribereceptioniststodiscussion( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A128WWPNotificationDefinitionId = P009I2_A128WWPNotificationDefinitionId[0];
            A125WWPEntityId = P009I2_A125WWPEntityId[0];
            A164WWPNotificationDefinitionName = P009I2_A164WWPNotificationDefinitionName[0];
            AV16GXLvl2 = 1;
            AV18GXV1 = 1;
         ...
         context.CommitDataStores("prc_subscribereceptioniststodiscussion",pr_default);
         cleanup();
      }
      ...
      public override void initialize( )
      {
         ...
         P009I2_A128WWPNotificationDefinitionId = new long[1] ;
         P009I2_A125WWPEntityId = new long[1] ;
         P009I2_A164WWPNotificationDefinitionName = new string[] {""} ;
         A164WWPNotificationDefinitionName = "";
         AV13WWPUserExtendedId = "";
         AV10WWPSubscription = new GeneXus.Programs.wwpbaseobjects.subscriptions.SdtWWP_Subscription(context);
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.prc_subscribereceptioniststodiscussion__datastore1(),
            new Object[][] {
            }
         );
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.prc_subscribereceptioniststodiscussion__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_subscribereceptioniststodiscussion__default(),
            new Object[][] {
                new Object[] {
               P009I2_A128WWPNotificationDefinitionId, P009I2_A125WWPEntityId, P009I2_A164WWPNotificationDefinitionName
               }
               , new Object[] {
               }
            }
      ...
      private long[] P009I2_A128WWPNotificationDefinitionId ;
      private long[] P009I2_A125WWPEntityId ;
      private string[] P009I2_A164WWPNotificationDefinitionName ;
      private GeneXus.Programs.wwpbaseobjects.subscriptions.SdtWWP_Subscription AV10WWPSubscription ;
      private IDataStoreProvider pr_datastore1 ;
      private IDataStoreProvider pr_gam ;
   }

   public class prc_subscribereceptioniststodiscussion__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class prc_subscribereceptioniststodiscussion__gam : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
...
public class prc_subscribereceptioniststodiscussion__default : DataStoreHelperBase, IDataStoreHelper
{
   public ICursor[] getCursors( )
   {
      cursorDefinitions();
