...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="WP_CreateLocationAndLicenseData" , Namespace="Comforta_version21" )]
	[Serializable]
	...
	[DataContract(Name=@"WP_CreateLocationAndLicenseData", Namespace="Comforta_version21")]
