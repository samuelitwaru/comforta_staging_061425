   ...
   public class gamwwroleroles : GXDataArea
   {
      ...
      protected void WB8M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_21_8M2( true) ;
         }
         else
         {
            wb_table1_21_8M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_8M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S152( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV33GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV10FilName)),  0,  AV10FilName,  AV10FilName,  false,  "",  "") ;
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV33GridState,  "FILEXTERNALID",  context.GetMessage( "WWP_GAM_ExternalId", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV9FilExternalId)),  0,  AV9FilExternalId,  AV9FilExternalId,  false,  "",  "") ;
      ...
      protected void wb_table1_21_8M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_26_8M2( true) ;
         }
         else
         {
            wb_table2_26_8M2( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_8M2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_8M2e( true) ;
         }
         else
         {
            wb_table1_21_8M2e( false) ;
         }
      }

      protected void wb_table2_26_8M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_8M2e( true) ;
         }
         else
         {
            wb_table2_26_8M2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017123336", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwroleroles.js", "?202562017123337", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E188M2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV21RoleIdAux","fld":"vROLEIDAUX","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV10FilName","fld":"vFILNAME"},{"av":"AV52SearchFilter","fld":"vSEARCHFILTER","hsh":true},{"av":"AV9FilExternalId","fld":"vFILEXTERNALID"},{"av":"AV51IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true}]""");
         ...
         setEventMetadata("'DOBACK'","""{"handler":"E148M2","iparms":[{"av":"AV53ListCount","fld":"vLISTCOUNT","pic":"ZZZ9","hsh":true},{"av":"AV48RoleList","fld":"vROLELIST"},{"av":"AV20RoleId","fld":"vROLEID","pic":"ZZZZZZZZZZZ9","hsh":true}]""");
