   ...
   public class gamwwroles : GXDataArea
   {
      ...
      protected void WB8L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_19_8L2( true) ;
         }
         else
         {
            wb_table1_19_8L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_19_8L2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E168L2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV59Pgmname, out  GXt_char2) ;
      ...
      private void E178L2( )
      {
         ...
         while ( AV60GXV1 <= AV27GAMRoles.Count )
         {
            ...
            {
               cmbavGridactions.addItem("2", StringUtil.Format( "%1;%2", context.GetMessage( "Edit", ""), "fa fa-pen", "", "", "", "", "", "", ""), 0);
            }
      ...
      protected void E118L2( )
      {
         ...
         else
         {
            ...
            else
            {
               ...
               S152 ();
               if (returnInSub) return;
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV59Pgmname+"GridState",  AV43ManageFiltersXml) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV39GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV59Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S162( )
      {
         ...
         {
            AV40GridStateFilterValue = ((WorkWithPlus.workwithplus_web.SdtWWPGridState_FilterValue)AV39GridState.gxTpr_Filtervalues.Item(AV61GXV2));
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV39GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV14FilName)),  0,  AV14FilName,  AV14FilName,  false,  "",  "") ;
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV59Pgmname+"GridState",  AV39GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void wb_table1_19_8L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_24_8L2( true) ;
         }
         else
         {
            wb_table2_24_8L2( false) ;
         }
         return  ;
      }

      protected void wb_table2_24_8L2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_19_8L2e( true) ;
         }
         else
         {
            wb_table1_19_8L2e( false) ;
         }
      }

      protected void wb_table2_24_8L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_24_8L2e( true) ;
         }
         else
         {
            wb_table2_24_8L2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017113651", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwroles.js", "?202562017113655", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E178L2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14FilName","fld":"vFILNAME"},{"av":"AV13FilExternalId","fld":"vFILEXTERNALID","hsh":true},{"av":"AV53IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV54IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV55IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnRole","fld":"vISAUTHORIZED_BTNROLE","hsh":true},{"av":"AV19IsAuthorized_BtnPrm","fld":"vISAUTHORIZED_BTNPRM","hsh":true},{"av":"AV22IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true}]""");
         ...
         setEventMetadata("VBTNTRANSLATIONS.CLICK","""{"handler":"E198L2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV42ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV59Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV14FilName","fld":"vFILNAME"},{"av":"edtavBtnrole_Title","ctrl":"vBTNROLE","prop":"Title"},{"av":"edtavBtnprm_Title","ctrl":"vBTNPRM","prop":"Title"},{"av":"edtavBtnsaveas_Title","ctrl":"vBTNSAVEAS","prop":"Title"},{"av":"edtavBtntranslations_Title","ctrl":"vBTNTRANSLATIONS","prop":"Title"},{"av":"AV13FilExternalId","fld":"vFILEXTERNALID","hsh":true},{"av":"AV53IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV54IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV55IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnRole","fld":"vISAUTHORIZED_BTNROLE","hsh":true},{"av":"AV19IsAuthorized_BtnPrm","fld":"vISAUTHORIZED_BTNPRM","hsh":true},{"av":"AV22IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV58IsAuthorized_BtnTranslations","fld":"vISAUTHORIZED_BTNTRANSLATIONS","hsh":true},{"av":"AV56IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"AV17Id","fld":"vID","pic":"ZZZZZZZZZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E148L2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV42ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV59Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV14FilName","fld":"vFILNAME"},{"av":"edtavBtnrole_Title","ctrl":"vBTNROLE","prop":"Title"},{"av":"edtavBtnprm_Title","ctrl":"vBTNPRM","prop":"Title"},{"av":"edtavBtnsaveas_Title","ctrl":"vBTNSAVEAS","prop":"Title"},{"av":"edtavBtntranslations_Title","ctrl":"vBTNTRANSLATIONS","prop":"Title"},{"av":"AV13FilExternalId","fld":"vFILEXTERNALID","hsh":true},{"av":"AV53IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV54IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV55IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnRole","fld":"vISAUTHORIZED_BTNROLE","hsh":true},{"av":"AV19IsAuthorized_BtnPrm","fld":"vISAUTHORIZED_BTNPRM","hsh":true},{"av":"AV22IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV58IsAuthorized_BtnTranslations","fld":"vISAUTHORIZED_BTNTRANSLATIONS","hsh":true},{"av":"AV56IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV42ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV48GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV50GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV53IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV54IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV55IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnRole","fld":"vISAUTHORIZED_BTNROLE","hsh":true},{"av":"edtavBtnrole_Visible","ctrl":"vBTNROLE","prop":"Visible"},{"av":"AV19IsAuthorized_BtnPrm","fld":"vISAUTHORIZED_BTNPRM","hsh":true},{"av":"edtavBtnprm_Visible","ctrl":"vBTNPRM","prop":"Visible"},{"av":"AV58IsAuthorized_BtnTranslations","fld":"vISAUTHORIZED_BTNTRANSLATIONS","hsh":true},{"av":"edtavBtntranslations_Visible","ctrl":"vBTNTRANSLATIONS","prop":"Visible"},{"av":"AV56IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV46ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV39GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("VBTNSAVEAS.CLICK","""{"handler":"E208L2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV42ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV59Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV14FilName","fld":"vFILNAME"},{"av":"edtavBtnrole_Title","ctrl":"vBTNROLE","prop":"Title"},{"av":"edtavBtnprm_Title","ctrl":"vBTNPRM","prop":"Title"},{"av":"edtavBtnsaveas_Title","ctrl":"vBTNSAVEAS","prop":"Title"},{"av":"edtavBtntranslations_Title","ctrl":"vBTNTRANSLATIONS","prop":"Title"},{"av":"AV13FilExternalId","fld":"vFILEXTERNALID","hsh":true},{"av":"AV53IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV54IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV55IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnRole","fld":"vISAUTHORIZED_BTNROLE","hsh":true},{"av":"AV19IsAuthorized_BtnPrm","fld":"vISAUTHORIZED_BTNPRM","hsh":true},{"av":"AV22IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV58IsAuthorized_BtnTranslations","fld":"vISAUTHORIZED_BTNTRANSLATIONS","hsh":true},{"av":"AV56IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"AV17Id","fld":"vID","pic":"ZZZZZZZZZZZ9"}]""");
