...
namespace GeneXus.Programs {
   public class trn_theme_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtTrn_Theme>( context, "Trn_Theme", "Comforta_version21") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtTrn_Theme>( context, "Trn_Theme", "Comforta_version21");
         /* GeneXus formulas. */
      }
