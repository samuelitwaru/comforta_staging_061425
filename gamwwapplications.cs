   ...
   public class gamwwapplications : GXDataArea
   {
      ...
      protected void WB810( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_19_812( true) ;
         }
         else
         {
            wb_table1_19_812( false) ;
         }
         return  ;
      }

      protected void wb_table1_19_812e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV35GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV11FilName)),  0,  AV11FilName,  AV11FilName,  false,  "",  "") ;
      ...
      protected void wb_table1_19_812( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_24_812( true) ;
         }
         else
         {
            wb_table2_24_812( false) ;
         }
         return  ;
      }

      protected void wb_table2_24_812e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_19_812e( true) ;
         }
         else
         {
            wb_table1_19_812e( false) ;
         }
      }

      protected void wb_table2_24_812( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_24_812e( true) ;
         }
         else
         {
            wb_table2_24_812e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256201710764", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwapplications.js", "?20256201710769", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E14812","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavGamactionpermission_Title","ctrl":"vGAMACTIONPERMISSION","prop":"Title"},{"av":"edtavUamenus_Title","ctrl":"vUAMENUS","prop":"Title"},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV20IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV52IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
