...
namespace GeneXus.Programs {
   public class wp_createorganisationandmanagerstep2 : GXWebComponent
   {
      ...
      {
         cmbavManagersalutation = new GXCombobox();
         cmbavManagergender = new GXCombobox();
         chkavManagerismainmanager = new GXCheckbox();
         cmbavSdt_managers__managersalutation = new GXCombobox();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            if ( ( GxWebError == 0 ) && ! isAjaxCallMode( ) )
            {
               ...
               AssignProp(sPrefix, false, edtavSdt_managers__managerid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managerid_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__organisationid_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__organisationid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__organisationid_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               cmbavSdt_managers__managersalutation.Enabled = 0;
               AssignProp(sPrefix, false, cmbavSdt_managers__managersalutation_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavSdt_managers__managersalutation.Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managertitle_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managertitle_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managertitle_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managergivenname_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managergivenname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managergivenname_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managerlastname_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managerlastname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managerlastname_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managerinitials_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managerinitials_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managerinitials_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__manageremail_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__manageremail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__manageremail_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managerphone_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managerphone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managerphone_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managerphonecode_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managerphonecode_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managerphonecode_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managerphonenumber_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managerphonenumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managerphonenumber_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               cmbavSdt_managers__managergender.Enabled = 0;
               AssignProp(sPrefix, false, cmbavSdt_managers__managergender_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavSdt_managers__managergender.Enabled), 5, 0), !bGXsfl_87_Refreshing);
               edtavSdt_managers__managergamguid_Enabled = 0;
               AssignProp(sPrefix, false, edtavSdt_managers__managergamguid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdt_managers__managergamguid_Enabled), 5, 0), !bGXsfl_87_Refreshing);
               chkavSdt_managers__managerismainmanager.Enabled = 0;
               AssignProp(sPrefix, false, chkavSdt_managers__managerismainmanager_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(chkavSdt_managers__managerismainmanager.Enabled), 5, 0), !bGXsfl_87_Refreshing);
               WS3Z2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void WB3Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+cmbavManagersalutation_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavManagersalutation_Internalname, context.GetMessage( "Salutation", ""), "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 24,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavManagersalutation, cmbavManagersalutation_Internalname, StringUtil.RTrim( AV73ManagerSalutation), 1, cmbavManagersalutation_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavManagersalutation.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,24);\"", "", true, 0, "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            cmbavManagersalutation.CurrentValue = StringUtil.RTrim( AV73ManagerSalutation);
            AssignProp(sPrefix, false, cmbavManagersalutation_Internalname, "Values", (string)(cmbavManagersalutation.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divManagertitle_cell_Internalname, 1, 0, "px", 0, "px", divManagertitle_cell_Class, "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", edtavManagertitle_Visible, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtavManagertitle_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavManagertitle_Internalname, context.GetMessage( "Title", ""), "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 29,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagertitle_Internalname, AV74ManagerTitle, StringUtil.RTrim( context.localUtil.Format( AV74ManagerTitle, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "Please specify salutation", ""), edtavManagertitle_Jsonclick, 0, "Attribute", "", "", "", "", edtavManagertitle_Visible, edtavManagertitle_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavManagerlastname_Internalname, AV15ManagerLastName, StringUtil.RTrim( context.localUtil.Format( AV15ManagerLastName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagerlastname_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavManagerlastname_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavManagergender, cmbavManagergender_Internalname, StringUtil.RTrim( AV11ManagerGender), 1, cmbavManagergender_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavManagergender.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "", true, 0, "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 51,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManageremail_Internalname, AV9ManagerEmail, StringUtil.RTrim( context.localUtil.Format( AV9ManagerEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "johndoe@gmail.com", ""), edtavManageremail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavManageremail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 71,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagerphonenumber_Internalname, AV52ManagerPhoneNumber, StringUtil.RTrim( context.localUtil.Format( AV52ManagerPhoneNumber, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,71);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagerphonenumber_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavManagerphonenumber_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 87 )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 113,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagerphonecode_Internalname, AV49ManagerPhoneCode, StringUtil.RTrim( context.localUtil.Format( AV49ManagerPhoneCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,113);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagerphonecode_Jsonclick, 0, "Attribute", "", "", "", "", edtavManagerphonecode_Visible, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 114,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagerinitials_Internalname, StringUtil.RTrim( AV14ManagerInitials), StringUtil.RTrim( context.localUtil.Format( AV14ManagerInitials, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,114);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagerinitials_Jsonclick, 0, "Attribute", "", "", "", "", edtavManagerinitials_Visible, 1, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 115,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagerphone_Internalname, StringUtil.RTrim( AV16ManagerPhone), StringUtil.RTrim( context.localUtil.Format( AV16ManagerPhone, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,115);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagerphone_Jsonclick, 0, "Attribute", "", "", "", "", edtavManagerphone_Visible, 1, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 116,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagerid_Internalname, AV13ManagerId.ToString(), AV13ManagerId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,116);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagerid_Jsonclick, 0, "Attribute", "", "", "", "", edtavManagerid_Visible, 1, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 117,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManagergamguid_Internalname, AV10ManagerGAMGUID, StringUtil.RTrim( context.localUtil.Format( AV10ManagerGAMGUID, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,117);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavManagergamguid_Jsonclick, 0, "Attribute", "", "", "", "", edtavManagergamguid_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, 0, 0, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "GRIDSDT_MANAGERSS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "VGRIDACTIONGROUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "VGRIDACTIONGROUP.CLICK") == 0 ) )
                           {
                              ...
                              AV75GXV1 = (int)(nGXsfl_87_idx+GRIDSDT_MANAGERSS_nFirstRecordOnPage);
                              if ( ( AV26SDT_Managers.Count >= AV75GXV1 ) && ( AV75GXV1 > 0 ) )
                              {
                                 AV26SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1));
      ...
      protected void PA3Z2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = cmbavManagersalutation_Internalname;
               AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
            }
            nDonePA = 1;
         }
      ...
      protected void gxnrGridsdt_managerss_newrow( )
      {
         ...
         {
            sendrow_872( ) ;
            nGXsfl_87_idx = ((subGridsdt_managerss_Islastpage==1)&&(nGXsfl_87_idx+1>subGridsdt_managerss_fnc_Recordsperpage( )) ? 1 : nGXsfl_87_idx+1);
            sGXsfl_87_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_87_idx), 4, 0), 4, "0");
            SubsflControlProps_872( ) ;
         }
      ...
      {
         if ( cmbavManagersalutation.ItemCount > 0 )
         {
            AV73ManagerSalutation = cmbavManagersalutation.getValidValue(AV73ManagerSalutation);
            AssignAttri(sPrefix, false, "AV73ManagerSalutation", AV73ManagerSalutation);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavManagersalutation.CurrentValue = StringUtil.RTrim( AV73ManagerSalutation);
            AssignProp(sPrefix, false, cmbavManagersalutation_Internalname, "Values", cmbavManagersalutation.ToJavascriptSource(), true);
         }
      ...
      protected void RF3Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Execute user event: Gridsdt_managerss.Load */
            E173Z2 ();
            if ( ( subGridsdt_managerss_Islastpage == 0 ) && ( GRIDSDT_MANAGERSS_nCurrentRecord > 0 ) && ( GRIDSDT_MANAGERSS_nGridOutOfScope == 0 ) && ( nGXsfl_87_idx == 1 ) )
            {
               GRIDSDT_MANAGERSS_nCurrentRecord = 0;
      ...
      protected void STRUP3Z0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               nGXsfl_87_fel_idx = ((subGridsdt_managerss_Islastpage==1)&&(nGXsfl_87_fel_idx+1>subGridsdt_managerss_fnc_Recordsperpage( )) ? 1 : nGXsfl_87_fel_idx+1);
               sGXsfl_87_fel_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_87_fel_idx), 4, 0), 4, "0");
               SubsflControlProps_fel_872( ) ;
               AV75GXV1 = (int)(nGXsfl_87_fel_idx+GRIDSDT_MANAGERSS_nFirstRecordOnPage);
               if ( ( AV26SDT_Managers.Count >= AV75GXV1 ) && ( AV75GXV1 > 0 ) )
               {
                  AV26SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1));
                  cmbavGridactiongroup.Name = cmbavGridactiongroup_Internalname;
            ...
            cmbavManagersalutation.Name = cmbavManagersalutation_Internalname;
            cmbavManagersalutation.CurrentValue = cgiGet( cmbavManagersalutation_Internalname);
            AV73ManagerSalutation = cgiGet( cmbavManagersalutation_Internalname);
            AssignAttri(sPrefix, false, "AV73ManagerSalutation", AV73ManagerSalutation);
            AV74ManagerTitle = cgiGet( edtavManagertitle_Internalname);
            AssignAttri(sPrefix, false, "AV74ManagerTitle", AV74ManagerTitle);
      ...
      private void E173Z2( )
      {
         ...
         returnInSub = false;
         AV75GXV1 = 1;
         while ( AV75GXV1 <= AV26SDT_Managers.Count )
         {
            AV26SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1));
            ...
            {
               DoAjaxLoad(87, Gridsdt_managerssRow);
            }
      ...
      {
         AV75GXV1 = (int)(nGXsfl_87_idx+GRIDSDT_MANAGERSS_nFirstRecordOnPage);
         if ( ( AV75GXV1 > 0 ) && ( AV26SDT_Managers.Count >= AV75GXV1 ) )
         {
            AV26SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1));
         }
         /* Enter Routine */
      ...
      protected void E133Z2( )
      {
         ...
         if ( AV33CheckRequiredFieldsResult && ! AV7HasValidationErrors )
         {
            ...
            AV90GXV16 = 1;
            while ( AV90GXV16 <= AV26SDT_Managers.Count )
            {
               AV25SDT_Manager = ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV90GXV16));
               if ( StringUtil.StrCmp(AV25SDT_Manager.gxTpr_Manageremail, AV9ManagerEmail) == 0 )
               {
                  AV38isAlreadyAdded = true;
                  if (true) break;
               }
               AV90GXV16 = (int)(AV90GXV16+1);
            }
            /* Using cursor H003Z2 */
            ...
            else
            {
               ...
               else
               {
                  ...
                  AV25SDT_Manager.gxTpr_Managersalutation = AV73ManagerSalutation;
      ...
      protected void S112( )
      {
         ...
         AssignAttri(sPrefix, false, "AV10ManagerGAMGUID", AV10ManagerGAMGUID);
         AV73ManagerSalutation = AV32WizardData.gxTpr_Step2.gxTpr_Managersalutation;
         AssignAttri(sPrefix, false, "AV73ManagerSalutation", AV73ManagerSalutation);
         AV74ManagerTitle = AV32WizardData.gxTpr_Step2.gxTpr_Managertitle;
         AssignAttri(sPrefix, false, "AV74ManagerTitle", AV74ManagerTitle);
      ...
      protected void S152( )
      {
         ...
         AV32WizardData.gxTpr_Step2.gxTpr_Managersalutation = AV73ManagerSalutation;
         AV32WizardData.gxTpr_Step2.gxTpr_Managertitle = AV74ManagerTitle;
      ...
      protected void S172( )
      {
         ...
         AssignAttri(sPrefix, false, "AV49ManagerPhoneCode", AV49ManagerPhoneCode);
         AV73ManagerSalutation = ((SdtSDT_Managers_SDT_ManagersItem)(AV26SDT_Managers.CurrentItem)).gxTpr_Managersalutation;
         AssignAttri(sPrefix, false, "AV73ManagerSalutation", AV73ManagerSalutation);
         if ( StringUtil.StrCmp(((SdtSDT_Managers_SDT_ManagersItem)(AV26SDT_Managers.CurrentItem)).gxTpr_Managersalutation, "Other") == 0 )
         {
            AV74ManagerTitle = ((SdtSDT_Managers_SDT_ManagersItem)(AV26SDT_Managers.CurrentItem)).gxTpr_Managertitle;
            AssignAttri(sPrefix, false, "AV74ManagerTitle", AV74ManagerTitle);
         }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( ! ( ( StringUtil.StrCmp(AV73ManagerSalutation, "Other") == 0 ) ) )
         {
            edtavManagertitle_Visible = 0;
            AssignProp(sPrefix, false, edtavManagertitle_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavManagertitle_Visible), 5, 0), true);
            divManagertitle_cell_Class = "Invisible";
            AssignProp(sPrefix, false, divManagertitle_cell_Internalname, "Class", divManagertitle_cell_Class, true);
         }
         else
         {
            edtavManagertitle_Visible = 1;
            AssignProp(sPrefix, false, edtavManagertitle_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavManagertitle_Visible), 5, 0), true);
            divManagertitle_cell_Class = "col-xs-12 DataContentCell";
            AssignProp(sPrefix, false, divManagertitle_cell_Internalname, "Class", divManagertitle_cell_Class, true);
         }
      }
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV93GXV18 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem3 = AV92GXV17;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem3) ;
         AV92GXV17 = GXt_objcol_SdtSDT_Country_SDT_CountryItem3;
         while ( AV93GXV18 <= AV92GXV17.Count )
         {
            AV51ManagerPhoneCode_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV92GXV17.Item(AV93GXV18));
      ...
      protected void S142( )
      {
         ...
         AV94GXV19 = 1;
         while ( AV94GXV19 <= AV26SDT_Managers.Count )
         {
            AV25SDT_Manager = ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV94GXV19));
            if ( AV25SDT_Manager.gxTpr_Managerismainmanager )
            {
               AV70hasMainManager = true;
               AssignAttri(sPrefix, false, "AV70hasMainManager", AV70hasMainManager);
            }
            AV94GXV19 = (int)(AV94GXV19+1);
         }
      }
      ...
      protected void S202( )
      {
         ...
         returnInSub = false;
         AV95GXV20 = 1;
         while ( AV95GXV20 <= AV35ErrorMessages.Count )
         {
            AV34Error = ((GeneXus.Utils.SdtMessages_Message)AV35ErrorMessages.Item(AV95GXV20));
            GX_msglist.addItem(context.GetMessage( "Error: ", "")+AV34Error.gxTpr_Description);
            AV95GXV20 = (int)(AV95GXV20+1);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202571111455413", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createorganisationandmanagerstep2.js", "?202571111455416", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         edtavSdt_managers__managerid_Internalname = sPrefix+"SDT_MANAGERS__MANAGERID_"+sGXsfl_87_idx;
         edtavSdt_managers__organisationid_Internalname = sPrefix+"SDT_MANAGERS__ORGANISATIONID_"+sGXsfl_87_idx;
         cmbavSdt_managers__managersalutation_Internalname = sPrefix+"SDT_MANAGERS__MANAGERSALUTATION_"+sGXsfl_87_idx;
         edtavSdt_managers__managertitle_Internalname = sPrefix+"SDT_MANAGERS__MANAGERTITLE_"+sGXsfl_87_idx;
         edtavSdt_managers__managergivenname_Internalname = sPrefix+"SDT_MANAGERS__MANAGERGIVENNAME_"+sGXsfl_87_idx;
         edtavSdt_managers__managerlastname_Internalname = sPrefix+"SDT_MANAGERS__MANAGERLASTNAME_"+sGXsfl_87_idx;
         edtavSdt_managers__managerinitials_Internalname = sPrefix+"SDT_MANAGERS__MANAGERINITIALS_"+sGXsfl_87_idx;
         edtavSdt_managers__manageremail_Internalname = sPrefix+"SDT_MANAGERS__MANAGEREMAIL_"+sGXsfl_87_idx;
         edtavSdt_managers__managerphone_Internalname = sPrefix+"SDT_MANAGERS__MANAGERPHONE_"+sGXsfl_87_idx;
         edtavSdt_managers__managerphonecode_Internalname = sPrefix+"SDT_MANAGERS__MANAGERPHONECODE_"+sGXsfl_87_idx;
         edtavSdt_managers__managerphonenumber_Internalname = sPrefix+"SDT_MANAGERS__MANAGERPHONENUMBER_"+sGXsfl_87_idx;
         cmbavSdt_managers__managergender_Internalname = sPrefix+"SDT_MANAGERS__MANAGERGENDER_"+sGXsfl_87_idx;
         edtavSdt_managers__managergamguid_Internalname = sPrefix+"SDT_MANAGERS__MANAGERGAMGUID_"+sGXsfl_87_idx;
         chkavSdt_managers__managerismainmanager_Internalname = sPrefix+"SDT_MANAGERS__MANAGERISMAINMANAGER_"+sGXsfl_87_idx;
         cmbavGridactiongroup_Internalname = sPrefix+"vGRIDACTIONGROUP_"+sGXsfl_87_idx;
      }

      protected void SubsflControlProps_fel_872( )
      {
         edtavSdt_managers__managerid_Internalname = sPrefix+"SDT_MANAGERS__MANAGERID_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__organisationid_Internalname = sPrefix+"SDT_MANAGERS__ORGANISATIONID_"+sGXsfl_87_fel_idx;
         cmbavSdt_managers__managersalutation_Internalname = sPrefix+"SDT_MANAGERS__MANAGERSALUTATION_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managertitle_Internalname = sPrefix+"SDT_MANAGERS__MANAGERTITLE_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managergivenname_Internalname = sPrefix+"SDT_MANAGERS__MANAGERGIVENNAME_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managerlastname_Internalname = sPrefix+"SDT_MANAGERS__MANAGERLASTNAME_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managerinitials_Internalname = sPrefix+"SDT_MANAGERS__MANAGERINITIALS_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__manageremail_Internalname = sPrefix+"SDT_MANAGERS__MANAGEREMAIL_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managerphone_Internalname = sPrefix+"SDT_MANAGERS__MANAGERPHONE_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managerphonecode_Internalname = sPrefix+"SDT_MANAGERS__MANAGERPHONECODE_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managerphonenumber_Internalname = sPrefix+"SDT_MANAGERS__MANAGERPHONENUMBER_"+sGXsfl_87_fel_idx;
         cmbavSdt_managers__managergender_Internalname = sPrefix+"SDT_MANAGERS__MANAGERGENDER_"+sGXsfl_87_fel_idx;
         edtavSdt_managers__managergamguid_Internalname = sPrefix+"SDT_MANAGERS__MANAGERGAMGUID_"+sGXsfl_87_fel_idx;
         chkavSdt_managers__managerismainmanager_Internalname = sPrefix+"SDT_MANAGERS__MANAGERISMAINMANAGER_"+sGXsfl_87_fel_idx;
         cmbavGridactiongroup_Internalname = sPrefix+"vGRIDACTIONGROUP_"+sGXsfl_87_fel_idx;
      }
      ...
      protected void sendrow_872( )
      {
         ...
         SubsflControlProps_872( ) ;
         WB3Z0( ) ;
         if ( ( subGridsdt_managerss_Rows * 1 == 0 ) || ( nGXsfl_87_idx <= subGridsdt_managerss_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Gridsdt_managerssRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_managers__managerid_Internalname,((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managerid.ToString(),((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managerid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_managers__managerid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_managers__managerid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)87,(short)0,(short)0,(short)0,(bool)true,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Gridsdt_managerssRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_managers__organisationid_Internalname,((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Organisationid.ToString(),((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Organisationid.ToString(),""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_managers__organisationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_managers__organisationid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)87,(short)0,(short)0,(short)0,(bool)true,(string)"",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            }
            if ( ( cmbavSdt_managers__managersalutation.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "SDT_MANAGERS__MANAGERSALUTATION_" + sGXsfl_87_idx;
               cmbavSdt_managers__managersalutation.Name = GXCCtl;
               cmbavSdt_managers__managersalutation.WebTags = "";
               cmbavSdt_managers__managersalutation.addItem("", context.GetMessage( "GX_EmptyItemText", ""), 0);
               cmbavSdt_managers__managersalutation.addItem("Mr", context.GetMessage( "Mr", ""), 0);
               cmbavSdt_managers__managersalutation.addItem("Mrs", context.GetMessage( "Mrs", ""), 0);
               cmbavSdt_managers__managersalutation.addItem("Ms", context.GetMessage( "Ms", ""), 0);
               cmbavSdt_managers__managersalutation.addItem("Other", context.GetMessage( "Other", ""), 0);
               if ( cmbavSdt_managers__managersalutation.ItemCount > 0 )
               {
                  if ( ( AV75GXV1 > 0 ) && ( AV26SDT_Managers.Count >= AV75GXV1 ) && String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managersalutation)) )
                  {
                     ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managersalutation = cmbavSdt_managers__managersalutation.getValidValue(((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managersalutation);
                  }
               }
            }
            /* ComboBox */
            Gridsdt_managerssRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavSdt_managers__managersalutation,(string)cmbavSdt_managers__managersalutation_Internalname,StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managersalutation),(short)1,(string)cmbavSdt_managers__managersalutation_Jsonclick,(short)0,(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"char",(string)"",(short)0,cmbavSdt_managers__managersalutation.Enabled,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"",(bool)true,(short)0});
            cmbavSdt_managers__managersalutation.CurrentValue = StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managersalutation);
            AssignProp(sPrefix, false, cmbavSdt_managers__managersalutation_Internalname, "Values", (string)(cmbavSdt_managers__managersalutation.ToJavascriptSource()), !bGXsfl_87_Refreshing);
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Gridsdt_managerssRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_managers__managertitle_Internalname,((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managertitle,(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_managers__managertitle_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_managers__managertitle_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)87,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 96,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',87)\"";
            ROClassString = "Attribute";
            Gridsdt_managerssRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_managers__managerphone_Internalname,StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managerphone),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,96);\"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_managers__managerphone_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(int)edtavSdt_managers__managerphone_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)87,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Gridsdt_managerssRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdt_managers__managerphonenumber_Internalname,((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managerphonenumber,(string)"",""+" onchange=\""+""+";gx.evt.onchange(this, event)\" ",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdt_managers__managerphonenumber_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdt_managers__managerphonenumber_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)87,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            }
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 99,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',87)\"";
            if ( ( cmbavSdt_managers__managergender.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "SDT_MANAGERS__MANAGERGENDER_" + sGXsfl_87_idx;
               ...
               {
                  if ( ( AV75GXV1 > 0 ) && ( AV26SDT_Managers.Count >= AV75GXV1 ) && String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managergender)) )
                  {
                     ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managergender = cmbavSdt_managers__managergender.getValidValue(((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managergender);
                  }
               }
            }
            /* ComboBox */
            Gridsdt_managerssRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavSdt_managers__managergender,(string)cmbavSdt_managers__managergender_Internalname,StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managergender),(short)1,(string)cmbavSdt_managers__managergender_Jsonclick,(short)0,(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",(short)-1,cmbavSdt_managers__managergender.Enabled,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,99);\"",(string)"",(bool)true,(short)0});
            cmbavSdt_managers__managergender.CurrentValue = StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managergender);
            AssignProp(sPrefix, false, cmbavSdt_managers__managergender_Internalname, "Values", (string)(cmbavSdt_managers__managergender.ToJavascriptSource()), !bGXsfl_87_Refreshing);
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 101,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',87)\"";
            ClassString = "AttributeCheckBox";
            StyleString = "";
            GXCCtl = "SDT_MANAGERS__MANAGERISMAINMANAGER_" + sGXsfl_87_idx;
            ...
            AssignProp(sPrefix, false, chkavSdt_managers__managerismainmanager_Internalname, "TitleCaption", chkavSdt_managers__managerismainmanager.Caption, !bGXsfl_87_Refreshing);
            chkavSdt_managers__managerismainmanager.CheckedValue = "false";
            Gridsdt_managerssRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkavSdt_managers__managerismainmanager_Internalname,StringUtil.BoolToStr( ((SdtSDT_Managers_SDT_ManagersItem)AV26SDT_Managers.Item(AV75GXV1)).gxTpr_Managerismainmanager),(string)"",(string)"",(short)-1,chkavSdt_managers__managerismainmanager.Enabled,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn",(string)"",TempTags+" onclick="+"\"gx.fn.checkboxClick(101, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,101);\""});
            /* Subfile cell */
            if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            }
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 102,'" + sPrefix + "',false,'" + sGXsfl_87_idx + "',87)\"";
            if ( ( cmbavGridactiongroup.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "vGRIDACTIONGROUP_" + sGXsfl_87_idx;
               cmbavGridactiongroup.Name = GXCCtl;
               cmbavGridactiongroup.WebTags = "";
               if ( cmbavGridactiongroup.ItemCount > 0 )
               {
                  if ( ( AV75GXV1 > 0 ) && ( AV26SDT_Managers.Count >= AV75GXV1 ) && (0==AV71GridActionGroup) )
                  {
      ...
      {
         cmbavManagersalutation.Name = "vMANAGERSALUTATION";
         cmbavManagersalutation.WebTags = "";
         cmbavManagersalutation.addItem("", context.GetMessage( "GX_EmptyItemText", ""), 0);
         cmbavManagersalutation.addItem("Mr", context.GetMessage( "Mr", ""), 0);
         cmbavManagersalutation.addItem("Mrs", context.GetMessage( "Mrs", ""), 0);
         cmbavManagersalutation.addItem("Ms", context.GetMessage( "Ms", ""), 0);
         cmbavManagersalutation.addItem("Other", context.GetMessage( "Other", ""), 0);
         if ( cmbavManagersalutation.ItemCount > 0 )
         {
         }
      ...
      protected void StartGridControl87( )
      {
         if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<div id=\""+sPrefix+"Gridsdt_managerssContainer"+"DivS\" data-gxgridid=\"87\">") ;
            sStyleString = "";
            ...
            context.SendWebValue( context.GetMessage( "Manager Salutation", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Manager Title", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            Gridsdt_managerssContainer.AddColumnProperties(Gridsdt_managerssColumn);
            Gridsdt_managerssColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            Gridsdt_managerssColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(cmbavSdt_managers__managersalutation.Enabled), 5, 0, ".", "")));
            Gridsdt_managerssContainer.AddColumnProperties(Gridsdt_managerssColumn);
            Gridsdt_managerssColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            Gridsdt_managerssColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavSdt_managers__managertitle_Enabled), 5, 0, ".", "")));
            Gridsdt_managerssContainer.AddColumnProperties(Gridsdt_managerssColumn);
            Gridsdt_managerssColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         cmbavManagersalutation_Internalname = sPrefix+"vMANAGERSALUTATION";
         edtavManagertitle_Internalname = sPrefix+"vMANAGERTITLE";
         divManagertitle_cell_Internalname = sPrefix+"MANAGERTITLE_CELL";
         ...
         cmbavSdt_managers__managersalutation_Internalname = sPrefix+"SDT_MANAGERS__MANAGERSALUTATION";
         edtavSdt_managers__managertitle_Internalname = sPrefix+"SDT_MANAGERS__MANAGERTITLE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavSdt_managers__managergivenname_Enabled = 0;
         edtavSdt_managers__managertitle_Jsonclick = "";
         edtavSdt_managers__managertitle_Enabled = 0;
         cmbavSdt_managers__managersalutation_Jsonclick = "";
         cmbavSdt_managers__managersalutation.Enabled = 0;
         ...
         edtavManagertitle_Jsonclick = "";
         edtavManagertitle_Enabled = 1;
         edtavManagertitle_Visible = 1;
         divManagertitle_cell_Class = "col-xs-12";
         cmbavManagersalutation_Jsonclick = "";
         cmbavManagersalutation.Enabled = 1;
         ...
         edtavSdt_managers__managertitle_Enabled = -1;
         cmbavSdt_managers__managersalutation.Enabled = -1;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDSDT_MANAGERSS_nFirstRecordOnPage"},{"av":"GRIDSDT_MANAGERSS_nEOF"},{"av":"AV26SDT_Managers","fld":"vSDT_MANAGERS","grid":87},{"av":"nGXsfl_87_idx","ctrl":"GRID","prop":"GridCurrRow","grid":87},{"av":"nRC_GXsfl_87","ctrl":"GRIDSDT_MANAGERSS","prop":"GridRC","grid":87},{"av":"subGridsdt_managerss_Rows","ctrl":"GRIDSDT_MANAGERSS","prop":"Rows"},{"av":"sPrefix"},{"av":"AV43ManagerIsMainManager","fld":"vMANAGERISMAINMANAGER"},{"av":"AV7HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true}]}""");
         ...
         setEventMetadata("ENTER","""{"handler":"E113Z2","iparms":[{"av":"AV26SDT_Managers","fld":"vSDT_MANAGERS","grid":87},{"av":"nGXsfl_87_idx","ctrl":"GRID","prop":"GridCurrRow","grid":87},{"av":"GRIDSDT_MANAGERSS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_87","ctrl":"GRIDSDT_MANAGERSS","prop":"GridRC","grid":87},{"av":"AV70hasMainManager","fld":"vHASMAINMANAGER"},{"av":"AV33CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT"},{"av":"AV7HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true},{"av":"AV31WebSessionKey","fld":"vWEBSESSIONKEY"},{"av":"AV9ManagerEmail","fld":"vMANAGEREMAIL"},{"av":"AV14ManagerInitials","fld":"vMANAGERINITIALS"},{"av":"AV16ManagerPhone","fld":"vMANAGERPHONE"},{"av":"AV43ManagerIsMainManager","fld":"vMANAGERISMAINMANAGER"},{"av":"AV52ManagerPhoneNumber","fld":"vMANAGERPHONENUMBER"},{"av":"AV49ManagerPhoneCode","fld":"vMANAGERPHONECODE"},{"av":"AV13ManagerId","fld":"vMANAGERID"},{"av":"AV10ManagerGAMGUID","fld":"vMANAGERGAMGUID"},{"av":"cmbavManagersalutation"},{"av":"AV73ManagerSalutation","fld":"vMANAGERSALUTATION"},{"av":"AV74ManagerTitle","fld":"vMANAGERTITLE"},{"av":"AV12ManagerGivenName","fld":"vMANAGERGIVENNAME"},{"av":"AV15ManagerLastName","fld":"vMANAGERLASTNAME"},{"av":"cmbavManagergender"},{"av":"AV11ManagerGender","fld":"vMANAGERGENDER"}]""");
         ...
         setEventMetadata("VALIDV_MANAGERSALUTATION","""{"handler":"Validv_Managersalutation","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         GXt_char2 = "";
         AV92GXV17 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
      ...
      private int edtavSdt_managers__managertitle_Enabled ;
      ...
      private int edtavManagertitle_Visible ;
      private int edtavManagertitle_Enabled ;
      ...
      private int AV90GXV16 ;
      private int AV93GXV18 ;
      private int AV94GXV19 ;
      private int AV95GXV20 ;
      private int idxLst ;
      ...
      private string cmbavSdt_managers__managersalutation_Internalname ;
      private string edtavSdt_managers__managertitle_Internalname ;
      ...
      private string cmbavManagersalutation_Internalname ;
      private string TempTags ;
      private string AV73ManagerSalutation ;
      private string cmbavManagersalutation_Jsonclick ;
      private string divManagertitle_cell_Internalname ;
      private string divManagertitle_cell_Class ;
      private string edtavManagertitle_Internalname ;
      private string edtavManagertitle_Jsonclick ;
      ...
      private string cmbavSdt_managers__managersalutation_Jsonclick ;
      private string edtavSdt_managers__managertitle_Jsonclick ;
      ...
      private string AV74ManagerTitle ;
      ...
      private GXCombobox cmbavManagersalutation ;
      private GXCombobox cmbavManagergender ;
      private GXCheckbox chkavManagerismainmanager ;
      private GXCombobox cmbavSdt_managers__managersalutation ;
      ...
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV92GXV17 ;
