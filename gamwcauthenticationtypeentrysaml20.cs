...
namespace GeneXus.Programs {
   public class gamwcauthenticationtypeentrysaml20 : GXWebComponent
   {
      ...
      protected void S132( )
      {
         ...
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_LocalSiteURL", ""), "", "", "", "", "", "", "", ""),  "error",  edtavLocalsiteurl_Internalname,  "true",  ""));
            AV70CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV70CheckRequiredFieldsResult", AV70CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV37ServiceProviderEntityId)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_ServiceProviderEntityID", ""), "", "", "", "", "", "", "", ""),  "error",  edtavServiceproviderentityid_Internalname,  "true",  ""));
            AV70CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV70CheckRequiredFieldsResult", AV70CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV36SamlEndpointLocation)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_SamlEndpointLocation", ""), "", "", "", "", "", "", "", ""),  "error",  edtavSamlendpointlocation_Internalname,  "true",  ""));
            AV70CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV70CheckRequiredFieldsResult", AV70CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV39SingleLogoutendpoint)) )
         {
            GX_msglist.addItem(new WorkWithPlus.workwithplus_web.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "WWP_GAM_SingleLogoutEndpoint", ""), "", "", "", "", "", "", "", ""),  "error",  edtavSinglelogoutendpoint_Internalname,  "true",  ""));
            AV70CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV70CheckRequiredFieldsResult", AV70CheckRequiredFieldsResult);
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562016571699", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("gamwcauthenticationtypeentrysaml20.js", "?202562016571699", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E148H2","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]""");
         ...
         setEventMetadata("'DOADD'","""{"handler":"E118H2","iparms":[]""");
