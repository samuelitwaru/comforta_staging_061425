...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_PageStructure.ChildrenItem" , Namespace="Comforta_version21" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_PageStructure.ChildrenItem", Namespace="Comforta_version21")]
