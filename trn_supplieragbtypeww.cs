...
namespace GeneXus.Programs {
   public class trn_supplieragbtypeww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedDsc, AV14FilterFullText, AV18ManageFiltersExecutionStep, AV40ColumnsSelector, AV42Pgmname, AV19TFSupplierAgbTypeName, AV20TFSupplierAgbTypeName_Sel, AV30IsAuthorized_Display, AV32IsAuthorized_Update, AV34IsAuthorized_Delete, AV28IsAuthorized_SupplierAgbTypeName, AV35IsAuthorized_Insert) ;
      ...
      protected void WB4B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV14FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV14FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,30);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "WWP_Search", ""), edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WorkWithPlus_Web\\WWPFullTextFilter", "start", true, "", "HLP_Trn_SupplierAgbTypeWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIERAGBTYPEID", GetSecureSignedToken( "", A255SupplierAgbTypeId, context));
         GxWebStd.gx_hidden_field( context, "SUPPLIERAGBTYPEID", A255SupplierAgbTypeId.ToString());
      }
      ...
      protected void RF4B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A256SupplierAgbTypeName = H004B2_A256SupplierAgbTypeName[0];
               A255SupplierAgbTypeId = H004B2_A255SupplierAgbTypeId[0];
               /* Execute user event: Grid.Load */
               E204B2 ();
      ...
      protected void send_integrity_lvl_hashes4B2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_SUPPLIERAGBTYPENAME", AV28IsAuthorized_SupplierAgbTypeName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_SUPPLIERAGBTYPENAME", GetSecureSignedToken( "", AV28IsAuthorized_SupplierAgbTypeName, context));
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIERAGBTYPEID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sGXsfl_39_idx, A255SupplierAgbTypeId, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV35IsAuthorized_Insert, context));
      }
      ...
      protected void E184B2( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_supplieragbtypeview_Execute", out  GXt_boolean1) ;
      ...
      protected void E194B2( )
      {
         ...
         edtSupplierAgbTypeName_Visible = (((WorkWithPlus.workwithplus_web.SdtWWPColumnsSelector_Column)AV40ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV42Pgmname, out  GXt_char3) ;
      ...
      private void E204B2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_supplieragbtypeview.aspx"+UrlEncode(A255SupplierAgbTypeId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
      ...
      protected void E164B2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savecolumnsselectorstate(context ).execute(  "Trn_SupplierAgbTypeWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV38ColumnsSelectorXML)) ? "" : AV40ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E114B2( )
      {
         ...
         else
         {
            ...
            new WorkWithPlus.workwithplus_web.getfilterbyname(context ).execute(  "Trn_SupplierAgbTypeWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV42Pgmname+"GridState",  AV17ManageFiltersXml) ;
      ...
      protected void E174B2( )
      {
         ...
         if ( AV35IsAuthorized_Insert )
         {
            ...
            context.PopUp(formatLink("trn_supplieragbtype.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
            context.DoAjaxRefresh();
         }
         else
         {
      ...
      protected void S162( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_columnsselector_add(context ).execute( ref  AV40ColumnsSelector,  "SupplierAgbTypeName",  "",  "Supplier Type Name",  true,  "") ;
         GXt_char3 = AV39UserCustomValue;
         new WorkWithPlus.workwithplus_web.loadcolumnsselectorstate(context ).execute(  "Trn_SupplierAgbTypeWWColumnsSelector", out  GXt_char3) ;
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_supplieragbtype_Update", out  GXt_boolean1) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_supplieragbtype_Delete", out  GXt_boolean1) ;
         ...
         new WorkWithPlus.workwithplus_commongam.secgamisauthbyfunctionalitykey(context ).execute(  "trn_supplieragbtype_Insert", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_SupplierAgbTypeWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S212( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_supplieragbtype.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(A255SupplierAgbTypeId.ToString());
            context.PopUp(formatLink("trn_supplieragbtype.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
            context.DoAjaxRefresh();
         }
         else
      ...
      protected void S222( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "trn_supplieragbtype.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(A255SupplierAgbTypeId.ToString());
      ...
      protected void S132( )
      {
         ...
         {
            AV11GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV42Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S192( )
      {
         ...
         GXt_char3 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV20TFSupplierAgbTypeName_Sel)),  AV20TFSupplierAgbTypeName_Sel, out  GXt_char3) ;
         Ddo_grid_Selectedvalue_set = GXt_char3;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char3 = "";
         new WorkWithPlus.workwithplus_web.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV19TFSupplierAgbTypeName)),  AV19TFSupplierAgbTypeName, out  GXt_char3) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20257212551312", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragbtypeww.js", "?20257212551315", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E204B2","iparms":[{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierAgbTypeName","fld":"vISAUTHORIZED_SUPPLIERAGBTYPENAME","hsh":true},{"av":"A255SupplierAgbTypeId","fld":"SUPPLIERAGBTYPEID","hsh":true}]""");
         ...
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E164B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierAgbTypeName","fld":"vTFSUPPLIERAGBTYPENAME"},{"av":"AV20TFSupplierAgbTypeName_Sel","fld":"vTFSUPPLIERAGBTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierAgbTypeName","fld":"vISAUTHORIZED_SUPPLIERAGBTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E214B2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierAgbTypeName","fld":"vTFSUPPLIERAGBTYPENAME"},{"av":"AV20TFSupplierAgbTypeName_Sel","fld":"vTFSUPPLIERAGBTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierAgbTypeName","fld":"vISAUTHORIZED_SUPPLIERAGBTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A255SupplierAgbTypeId","fld":"SUPPLIERAGBTYPEID","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E174B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierAgbTypeName","fld":"vTFSUPPLIERAGBTYPENAME"},{"av":"AV20TFSupplierAgbTypeName_Sel","fld":"vTFSUPPLIERAGBTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierAgbTypeName","fld":"vISAUTHORIZED_SUPPLIERAGBTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A255SupplierAgbTypeId","fld":"SUPPLIERAGBTYPEID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E144B2","iparms":[]""");
      ...
      public override void initialize( )
      {
         ...
         AV45Trn_supplieragbtypewwds_3_tfsupplieragbtypename_sel = "";
         AV44Trn_supplieragbtypewwds_2_tfsupplieragbtypename = "";
         H004B2_A256SupplierAgbTypeName = new string[] {""} ;
         H004B2_A255SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_supplieragbtypeww__default(),
            new Object[][] {
                new Object[] {
               H004B2_A256SupplierAgbTypeName, H004B2_A255SupplierAgbTypeId
               }
               , new Object[] {
      ...
      private string[] H004B2_A256SupplierAgbTypeName ;
      private Guid[] H004B2_A255SupplierAgbTypeId ;
   ...
   public class trn_supplieragbtypeww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004B2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H004B3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
         }
