export class ContentMapper {
  ...
  updateContentDescription(contentId: any, newDescription: string): boolean {
    ...
    const ContentItem = data.PageContentStructure.Content.find(
      (Content: any) => Content.ContentId === contentId
    );
  ...
  public removeContentCta(ctaId: any): any {
    ...
    if (data && data.PageContentStructure && data.PageContentStructure.Cta) {
      const ctaIndex = data.PageContentStructure.Cta.findIndex(
        (cta: any) => cta.CtaId === ctaId
      );
  ...
  public updateContentButtonType(
    ctaId: any,
    buttonType: any,
    imageUrl?: any
  ): any {
  ...
  public getContentCta(ctaId: any): any {
    ...
    if (data && data.PageContentStructure && data.PageContentStructure.Cta) {
      return data.PageContentStructure.Cta.find(
        (cta: any) => cta.CtaId === ctaId
      );
    }
  }
