  ...
  phoneCta(ctaButton: CallToAction, id: string) {
    return `
        ...
        "ctaColor1"
                        ...
                        <div ${DefaultAttributes} id="it1cq" data-gjs-type="default" class="cta-badge readonly-mode">
  ...
  emailCta(ctaButton: CallToAction, id: string) {
    return `
        ...
        "ctaColor1"
                        ...
                        <div ${DefaultAttributes} id="i2knu" data-gjs-type="default" class="cta-badge readonly-mode" >
  ...
  formCta(ctaButton: CallToAction, id: string) {
    return `
        ...
        "ctaColor1"
                        ...
                        <div ${DefaultAttributes} id="iina3" data-gjs-type="default" class="cta-badge readonly-mode">
