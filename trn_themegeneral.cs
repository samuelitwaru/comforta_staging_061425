...
namespace GeneXus.Programs {
   public class trn_themegeneral : GXWebComponent
   {
      ...
      {
         this.A273Trn_ThemeId = aP0_Trn_ThemeId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A273Trn_ThemeId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_themegeneral.aspx"+UrlEncode(A273Trn_ThemeId.ToString());
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA273Trn_ThemeId", wcpOA273Trn_ThemeId.ToString());
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      protected void WB7G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtTrn_ThemeId_Internalname, A273Trn_ThemeId.ToString(), A273Trn_ThemeId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_ThemeId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtTrn_ThemeId_Enabled, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ThemeGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", context.GetMessage( "Edit", ""), bttBtnupdate_Jsonclick, 5, context.GetMessage( "Edit", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOUPDATE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ThemeGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      protected void RF7G2( )
      {
         ...
         {
            /* Using cursor H007G2 */
            pr_default.execute(0, new Object[] {A273Trn_ThemeId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A405Trn_ThemeFontSize = H007G2_A405Trn_ThemeFontSize[0];
               AssignAttri(sPrefix, false, "A405Trn_ThemeFontSize", StringUtil.LTrimStr( (decimal)(A405Trn_ThemeFontSize), 4, 0));
               A281Trn_ThemeFontFamily = H007G2_A281Trn_ThemeFontFamily[0];
               AssignAttri(sPrefix, false, "A281Trn_ThemeFontFamily", A281Trn_ThemeFontFamily);
               A274Trn_ThemeName = H007G2_A274Trn_ThemeName[0];
      ...
      protected void STRUP7G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA273Trn_ThemeId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA273Trn_ThemeId"));
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA273Trn_ThemeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A273Trn_ThemeId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A273Trn_ThemeId", A273Trn_ThemeId.ToString());
         }
         wcpOA273Trn_ThemeId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA273Trn_ThemeId"));
         if ( ! GetJustCreated( ) && ( ( A273Trn_ThemeId != wcpOA273Trn_ThemeId ) ) )
         {
            setjustcreated();
         }
         wcpOA273Trn_ThemeId = A273Trn_ThemeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA273Trn_ThemeId = cgiGet( sPrefix+"A273Trn_ThemeId_CTRL");
         if ( StringUtil.Len( sCtrlA273Trn_ThemeId) > 0 )
         {
            A273Trn_ThemeId = StringUtil.StrToGuid( cgiGet( sCtrlA273Trn_ThemeId));
            AssignAttri(sPrefix, false, "A273Trn_ThemeId", A273Trn_ThemeId.ToString());
         }
         else
         {
            A273Trn_ThemeId = StringUtil.StrToGuid( cgiGet( sPrefix+"A273Trn_ThemeId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A273Trn_ThemeId_PARM", A273Trn_ThemeId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA273Trn_ThemeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A273Trn_ThemeId_CTRL", StringUtil.RTrim( sCtrlA273Trn_ThemeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309412999", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_themegeneral.js", "?20256309412999", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A273Trn_ThemeId","fld":"TRN_THEMEID"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E137G2","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A273Trn_ThemeId","fld":"TRN_THEMEID"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E147G2","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A273Trn_ThemeId","fld":"TRN_THEMEID"}]""");
      ...
      {
         wcpOA273Trn_ThemeId = Guid.Empty;
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV14Pgmname = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H007G2_A273Trn_ThemeId = new Guid[] {Guid.Empty} ;
         H007G2_A405Trn_ThemeFontSize = new short[1] ;
         H007G2_A281Trn_ThemeFontFamily = new string[] {""} ;
         H007G2_A274Trn_ThemeName = new string[] {""} ;
         ...
         sCtrlA273Trn_ThemeId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_themegeneral__default(),
            new Object[][] {
                new Object[] {
               H007G2_A273Trn_ThemeId, H007G2_A405Trn_ThemeFontSize, H007G2_A281Trn_ThemeFontFamily, H007G2_A274Trn_ThemeName
               }
            }
         );
         AV14Pgmname = "Trn_ThemeGeneral";
      ...
      private string sCtrlA273Trn_ThemeId ;
      ...
      private Guid wcpOA273Trn_ThemeId ;
      ...
      private Guid[] H007G2_A273Trn_ThemeId ;
      private short[] H007G2_A405Trn_ThemeFontSize ;
      private string[] H007G2_A281Trn_ThemeFontFamily ;
      private string[] H007G2_A274Trn_ThemeName ;
   ...
   public class trn_themegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007G2", "SELECT Trn_ThemeId, Trn_ThemeFontSize, Trn_ThemeFontFamily, Trn_ThemeName FROM Trn_Theme WHERE Trn_ThemeId = :Trn_ThemeId ORDER BY Trn_ThemeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007G2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
