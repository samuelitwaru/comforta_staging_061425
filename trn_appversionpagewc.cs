...
namespace GeneXus.Programs {
   public class trn_appversionpagewc : GXWebComponent
   {
      public trn_appversionpagewc( )
      {
      ...
      public trn_appversionpagewc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV8AppVersionId", AV8AppVersionId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)AV8AppVersionId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV8AppVersionId, AV23Pgmname, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV23Pgmname = "Trn_AppVersionPageWC";
               WSBC2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Trn_App Version Page WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_appversionpagewc.aspx"+UrlEncode(AV8AppVersionId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_appversionpagewc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8AppVersionId", wcpOAV8AppVersionId.ToString());
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV23Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV23Pgmname, "")), context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vAPPVERSIONID", AV8AppVersionId.ToString());
      ...
      protected void RenderHtmlCloseFormBC2( )
      {
      ...
      {
         return "Trn_AppVersionPageWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_App Version Page WC", "") ;
      }

      protected void WBBC0( )
      {
         if ( context.isAjaxRequest( ) )
         {
            disableOutput();
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_appversionpagewc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAppVersionId_Internalname, A523AppVersionId.ToString(), A523AppVersionId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAppVersionId_Jsonclick, 0, "Attribute", "", "", "", "", edtAppVersionId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_AppVersionPageWC.htm");
            /* User Defined Control */
      ...
      protected void STARTBC2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Trn_App Version Page WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void WSBC2( )
      {
         STARTBC2( ) ;
         EVTBC2( ) ;
      }

      protected void EVTBC2( )
      {
         sXEvt = cgiGet( "_EventName");
      ...
      protected void WEBC2( )
      {
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            if ( ! GxWebStd.gx_redirect( context) )
            {
               RenderHtmlCloseFormBC2( ) ;
            }
         }
      }

      protected void PABC2( )
      {
         if ( nDonePA == 0 )
         {
            if ( StringUtil.Len( sPrefix) != 0 )
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_appversionpagewc.aspx")), "trn_appversionpagewc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_appversionpagewc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RFBC2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00BC2 */
            pr_default.execute(0, new Object[] {AV8AppVersionId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A523AppVersionId = H00BC2_A523AppVersionId[0];
               AssignAttri(sPrefix, false, "A523AppVersionId", A523AppVersionId.ToString());
               A525PageType = H00BC2_A525PageType[0];
               A541IsPredefined = H00BC2_A541IsPredefined[0];
               A536PagePublishedStructure = H00BC2_A536PagePublishedStructure[0];
               A518PageStructure = H00BC2_A518PageStructure[0];
               A517PageName = H00BC2_A517PageName[0];
               A516PageId = H00BC2_A516PageId[0];
               /* Execute user event: Grid.Load */
               E16BC2 ();
      ...
      protected void send_integrity_lvl_hashesBC2( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV23Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV23Pgmname, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H00BC3 */
         pr_default.execute(1, new Object[] {AV8AppVersionId});
         GRID_nRecordCount = H00BC3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUPBC0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8AppVersionId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8AppVersionId"));
      ...
      protected void E14BC2( )
      {
         ...
         edtAppVersionId_Visible = 0;
         AssignProp(sPrefix, false, edtAppVersionId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtAppVersionId_Visible), 5, 0), true);
      ...
      protected void E15BC2( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_getappliedfiltersdescription(context ).execute(  AV23Pgmname, out  GXt_char2) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  AV23Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S142( )
      {
         ...
         new WorkWithPlus.workwithplus_web.savegridstate(context ).execute(  AV23Pgmname+"GridState",  AV12GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Trn_AppVersion";
         AV11TrnContextAtt = new WorkWithPlus.workwithplus_commonobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "AppVersionId";
         AV11TrnContextAtt.gxTpr_Attributevalue = AV8AppVersionId.ToString();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8AppVersionId = (Guid)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV8AppVersionId", AV8AppVersionId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8AppVersionId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_appversionpagewc", GetJustCreated( ));
         ...
         {
            AV8AppVersionId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV8AppVersionId", AV8AppVersionId.ToString());
         }
         wcpOAV8AppVersionId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8AppVersionId"));
         if ( ! GetJustCreated( ) && ( ( AV8AppVersionId != wcpOAV8AppVersionId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8AppVersionId = AV8AppVersionId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8AppVersionId = cgiGet( sPrefix+"AV8AppVersionId_CTRL");
         if ( StringUtil.Len( sCtrlAV8AppVersionId) > 0 )
         {
            AV8AppVersionId = StringUtil.StrToGuid( cgiGet( sCtrlAV8AppVersionId));
            AssignAttri(sPrefix, false, "AV8AppVersionId", AV8AppVersionId.ToString());
         }
         else
         {
            AV8AppVersionId = StringUtil.StrToGuid( cgiGet( sPrefix+"AV8AppVersionId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8AppVersionId_PARM", AV8AppVersionId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8AppVersionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8AppVersionId_CTRL", StringUtil.RTrim( sCtrlAV8AppVersionId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20257212514441", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_appversionpagewc.js", "?20257212514442", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtPageId_Internalname = sPrefix+"PAGEID_"+sGXsfl_15_idx;
         edtPageName_Internalname = sPrefix+"PAGENAME_"+sGXsfl_15_idx;
         edtPageStructure_Internalname = sPrefix+"PAGESTRUCTURE_"+sGXsfl_15_idx;
         edtPagePublishedStructure_Internalname = sPrefix+"PAGEPUBLISHEDSTRUCTURE_"+sGXsfl_15_idx;
         chkIsPredefined_Internalname = sPrefix+"ISPREDEFINED_"+sGXsfl_15_idx;
         cmbPageType_Internalname = sPrefix+"PAGETYPE_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtPageId_Internalname = sPrefix+"PAGEID_"+sGXsfl_15_fel_idx;
         edtPageName_Internalname = sPrefix+"PAGENAME_"+sGXsfl_15_fel_idx;
         edtPageStructure_Internalname = sPrefix+"PAGESTRUCTURE_"+sGXsfl_15_fel_idx;
         edtPagePublishedStructure_Internalname = sPrefix+"PAGEPUBLISHEDSTRUCTURE_"+sGXsfl_15_fel_idx;
         chkIsPredefined_Internalname = sPrefix+"ISPREDEFINED_"+sGXsfl_15_fel_idx;
         cmbPageType_Internalname = sPrefix+"PAGETYPE_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPagePublishedStructure_Internalname,(string)A536PagePublishedStructure,(string)A536PagePublishedStructure,(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPagePublishedStructure_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(int)2097152,(short)0,(short)0,(short)15,(short)0,(short)0,(short)-1,(bool)true,(string)"",(string)"start",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
            ...
            StyleString = "";
            GXCCtl = "ISPREDEFINED_" + sGXsfl_15_idx;
            chkIsPredefined.Name = GXCCtl;
            chkIsPredefined.WebTags = "";
            chkIsPredefined.Caption = "";
            AssignProp(sPrefix, false, chkIsPredefined_Internalname, "TitleCaption", chkIsPredefined.Caption, !bGXsfl_15_Refreshing);
            chkIsPredefined.CheckedValue = "false";
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkIsPredefined_Internalname,StringUtil.BoolToStr( A541IsPredefined),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            {
               GXCCtl = "PAGETYPE_" + sGXsfl_15_idx;
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbPageType,(string)cmbPageType_Internalname,StringUtil.RTrim( A525PageType),(short)1,(string)cmbPageType_Jsonclick,(short)0,(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",(short)-1,(short)0,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn hidden-xs",(string)"",(string)"",(string)"",(bool)true,(short)0});
            cmbPageType.CurrentValue = StringUtil.RTrim( A525PageType);
            AssignProp(sPrefix, false, cmbPageType_Internalname, "Values", (string)(cmbPageType.ToJavascriptSource()), !bGXsfl_15_Refreshing);
            send_integrity_lvl_hashesBC2( ) ;
      ...
      protected void StartGridControl15( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Structure", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Published Structure", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeCheckBox"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Predefined", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A516PageId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A517PageName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A518PageStructure));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A536PagePublishedStructure));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( A541IsPredefined)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A525PageType));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         edtPageStructure_Internalname = sPrefix+"PAGESTRUCTURE";
         edtPagePublishedStructure_Internalname = sPrefix+"PAGEPUBLISHEDSTRUCTURE";
         chkIsPredefined_Internalname = sPrefix+"ISPREDEFINED";
         cmbPageType_Internalname = sPrefix+"PAGETYPE";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:PageId|1:PageName|2:PageStructure|3:PagePublishedStructure|4:IsPredefined|5:PageType";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV8AppVersionId","fld":"vAPPVERSIONID"},{"av":"sPrefix"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV23Pgmname","fld":"vPGMNAME","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E11BC2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV8AppVersionId","fld":"vAPPVERSIONID"},{"av":"AV23Pgmname","fld":"vPGMNAME","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E12BC2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV8AppVersionId","fld":"vAPPVERSIONID"},{"av":"AV23Pgmname","fld":"vPGMNAME","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E13BC2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV8AppVersionId","fld":"vAPPVERSIONID"},{"av":"AV23Pgmname","fld":"vPGMNAME","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E16BC2","iparms":[]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Pagetype","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         A525PageType = "";
         GXDecQS = "";
         H00BC2_A523AppVersionId = new Guid[] {Guid.Empty} ;
         H00BC2_A525PageType = new string[] {""} ;
         H00BC2_A541IsPredefined = new bool[] {false} ;
         H00BC2_A536PagePublishedStructure = new string[] {""} ;
         H00BC2_A518PageStructure = new string[] {""} ;
         H00BC2_A517PageName = new string[] {""} ;
         H00BC2_A516PageId = new Guid[] {Guid.Empty} ;
         H00BC3_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV8AppVersionId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_appversionpagewc__default(),
            new Object[][] {
                new Object[] {
               H00BC2_A523AppVersionId, H00BC2_A525PageType, H00BC2_A541IsPredefined, H00BC2_A536PagePublishedStructure, H00BC2_A518PageStructure, H00BC2_A517PageName, H00BC2_A516PageId
               }
               , new Object[] {
               H00BC3_AGRID_nRecordCount
               }
            }
         );
         AV23Pgmname = "Trn_AppVersionPageWC";
      ...
      private string sCtrlAV8AppVersionId ;
      ...
      private Guid[] H00BC2_A523AppVersionId ;
      private string[] H00BC2_A525PageType ;
      private bool[] H00BC2_A541IsPredefined ;
      private string[] H00BC2_A536PagePublishedStructure ;
      private string[] H00BC2_A518PageStructure ;
      private string[] H00BC2_A517PageName ;
      private Guid[] H00BC2_A516PageId ;
      private long[] H00BC3_AGRID_nRecordCount ;
   ...
   public class trn_appversionpagewc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00BC2( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid AV8AppVersionId ,
                                             Guid A523AppVersionId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " AppVersionId, PageType, IsPredefined, PagePublishedStructure, PageStructure, PageName, PageId";
         sFromString = " FROM Trn_AppVersionPage";
         sOrderString = "";
         AddWhere(sWhereString, "(AppVersionId = :AV8AppVersionId)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY AppVersionId, PageId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AppVersionId DESC, PageId DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY AppVersionId, PageName, PageId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AppVersionId DESC, PageName DESC, PageId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY AppVersionId, PageStructure, PageId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AppVersionId DESC, PageStructure DESC, PageId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY AppVersionId, PagePublishedStructure, PageId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AppVersionId DESC, PagePublishedStructure DESC, PageId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY AppVersionId, IsPredefined, PageId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AppVersionId DESC, IsPredefined DESC, PageId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY AppVersionId, PageType, PageId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AppVersionId DESC, PageType DESC, PageId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY AppVersionId, PageId";
      ...
      protected Object[] conditional_H00BC3( IGxContext context ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             Guid AV8AppVersionId ,
                                             Guid A523AppVersionId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM Trn_AppVersionPage";
         AddWhere(sWhereString, "(AppVersionId = :AV8AppVersionId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00BC2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 1 :
                     return conditional_H00BC3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00BC3;
          prmH00BC3 = new Object[] {
          new ParDef("AV8AppVersionId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00BC2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BC2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00BC3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00BC3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
