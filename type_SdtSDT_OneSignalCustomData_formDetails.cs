...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDT_OneSignalCustomData.formDetails" , Namespace="Comforta_version21" )]
	[Serializable]
	...
	[DataContract(Name=@"SDT_OneSignalCustomData.formDetails", Namespace="Comforta_version21")]
