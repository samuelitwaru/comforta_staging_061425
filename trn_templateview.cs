   ...
   public class trn_templateview : GXDataArea
   {
      ...
      protected void RF512( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A299Trn_TemplateId = H00512_A299Trn_TemplateId[0];
               /* Execute user event: Load */
               E15512 ();
      ...
      protected void E13512( )
      {
         ...
         {
            A299Trn_TemplateId = H00513_A299Trn_TemplateId[0];
            A300Trn_TemplateName = H00513_A300Trn_TemplateName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A300Trn_TemplateName;
      ...
      protected void E14512( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Template",  StringUtil.Trim( A299Trn_TemplateId.ToString())) )
         {
      ...
      protected void E11512( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Template",(short)2,StringUtil.Trim( A299Trn_TemplateId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12512( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Template",StringUtil.Trim( A299Trn_TemplateId.ToString()),(string)AV14RecordDescription,formatLink("trn_templateview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256309464015", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_templateview.js", "?20256309464015", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A299Trn_TemplateId","fld":"TRN_TEMPLATEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10Trn_TemplateId","fld":"vTRN_TEMPLATEID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11512","iparms":[{"av":"A299Trn_TemplateId","fld":"TRN_TEMPLATEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12512","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A299Trn_TemplateId","fld":"TRN_TEMPLATEID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00512_A299Trn_TemplateId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00513_A299Trn_TemplateId = new Guid[] {Guid.Empty} ;
         H00513_A300Trn_TemplateName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_templateview__default(),
            new Object[][] {
                new Object[] {
               H00512_A299Trn_TemplateId
               }
               , new Object[] {
               H00513_A299Trn_TemplateId, H00513_A300Trn_TemplateName
               }
            }
         );
      ...
      private Guid[] H00512_A299Trn_TemplateId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00513_A299Trn_TemplateId ;
      private string[] H00513_A300Trn_TemplateName ;
   ...
   public class trn_templateview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00512", "SELECT Trn_TemplateId FROM Trn_Template WHERE Trn_TemplateId = :AV10Trn_TemplateId ORDER BY Trn_TemplateId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00512,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00513", "SELECT Trn_TemplateId, Trn_TemplateName FROM Trn_Template WHERE Trn_TemplateId = :AV10Trn_TemplateId ORDER BY Trn_TemplateId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00513,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
