...
namespace GeneXus.Programs {
   public class trn_suppliergentypewwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV26GridState.FromXml(new WorkWithPlus.workwithplus_web.loadgridstate(context).executeUdp(  "Trn_SupplierGenTypeWWGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRK6C2 = false;
            A254SupplierGenTypeName = P006C2_A254SupplierGenTypeName[0];
            A253SupplierGenTypeId = P006C2_A253SupplierGenTypeId[0];
            AV23count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P006C2_A254SupplierGenTypeName[0], A254SupplierGenTypeName) == 0 ) )
            {
               BRK6C2 = false;
               A253SupplierGenTypeId = P006C2_A253SupplierGenTypeId[0];
            ...
            if ( (0==AV14SkipItems) )
            {
               AV18Option = (String.IsNullOrEmpty(StringUtil.RTrim( A254SupplierGenTypeName)) ? "<#Empty#>" : A254SupplierGenTypeName);
      ...
      public override void initialize( )
      {
         ...
         A254SupplierGenTypeName = "";
         P006C2_A254SupplierGenTypeName = new string[] {""} ;
         P006C2_A253SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergentypewwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P006C2_A254SupplierGenTypeName, P006C2_A253SupplierGenTypeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P006C2_A254SupplierGenTypeName ;
      private Guid[] P006C2_A253SupplierGenTypeId ;
   ...
   public class trn_suppliergentypewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P006C2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
         }
