...
namespace GeneXus.Programs {
   public class urecoverpasswordstep1 : GXDataArea
   {
      public urecoverpasswordstep1( )
      {
      ...
      public urecoverpasswordstep1( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "urecoverpasswordstep1.aspx"+UrlEncode(StringUtil.RTrim(AV7IDP_State));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormBackgroundImage\" data-gx-class=\"form-horizontal FormBackgroundImage\" novalidate action=\""+formatLink("urecoverpasswordstep1.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "urecoverpasswordstep1.aspx"+UrlEncode(StringUtil.RTrim(AV7IDP_State));
         return formatLink("urecoverpasswordstep1.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "URecoverPasswordStep1" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "GAM_Recoverpasswordstep1", "") ;
      }
      ...
      protected void WB9V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgHeaderoriginal_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_URecoverPasswordStep1.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentrepository_Internalname, context.GetMessage( "Add recovery email", ""), "", "", lblCurrentrepository_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionLogin", 0, "", 1, 1, 0, 0, "HLP_URecoverPasswordStep1.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsername_Internalname, AV11UserName, StringUtil.RTrim( context.localUtil.Format( AV11UserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", context.GetMessage( "Email", ""), edtavUsername_Jsonclick, 0, "AttributeLoginImageLeft", "", "", "", "", 1, edtavUsername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMUserIdentification", "start", true, "", "HLP_URecoverPasswordStep1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", context.GetMessage( "GX_BtnEnter", ""), bttBtnenter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_URecoverPasswordStep1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "CellMarginTop", "start", "top", "", "flex-grow:1;align-self:center;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktologin_Internalname, context.GetMessage( "Back To Login", ""), "", "", lblBacktologin_Jsonclick, "'"+""+"'"+",false,"+"'"+"EBACKTOLOGIN.CLICK."+"'", "", "DataDescriptionLogin", 5, "", 1, 1, 0, 0, "HLP_URecoverPasswordStep1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START9V2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "GAM_Recoverpasswordstep1", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA9V2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "urecoverpasswordstep1.aspx")), "urecoverpasswordstep1.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "urecoverpasswordstep1.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E119V2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV18BrowserLanguage = AV17Httprequest.GetHeader("Accept-Language");
         if ( StringUtil.Like( AV18BrowserLanguage , StringUtil.PadR( "en" , 40 , "%"),  ' ' ) )
         {
            AV19Language = "English";
         }
         else if ( StringUtil.Like( AV18BrowserLanguage , StringUtil.PadR( "nl" , 40 , "%"),  ' ' ) )
         {
            AV19Language = "Dutch";
         }
         else
         ...
         AV22Numeric = (short)(context.SetLanguage( AV19Language));
      }
      ...
      protected void E129V2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbylogin(AV10UserAuthTypeName, AV11UserName, out  AV13GAMErrorCollection);
      ...
      protected void E139V2( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "gamexampleidplogin.aspx"+UrlEncode(StringUtil.RTrim(AV7IDP_State));
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV23GXV1 = 1;
         while ( AV23GXV1 <= AV13GAMErrorCollection.Count )
         {
            AV12GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV13GAMErrorCollection.Item(AV23GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017134990", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("urecoverpasswordstep1.js", "?202562017135040", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "GAM_Recoverpasswordstep1", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E129V2","iparms":[{"av":"AV10UserAuthTypeName","fld":"vUSERAUTHTYPENAME","hsh":true},{"av":"AV11UserName","fld":"vUSERNAME"}]}""");
         setEventMetadata("BACKTOLOGIN.CLICK","""{"handler":"E139V2","iparms":[{"av":"AV7IDP_State","fld":"vIDP_STATE"}]""");
      ...
      private bool AV16IsSuccess ;
      private string AV11UserName ;
      private string AV18BrowserLanguage ;
