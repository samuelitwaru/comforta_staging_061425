   ...
   public class trn_locationloaddvcombo : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         if ( StringUtil.StrCmp(AV14TrnMode, "INS") != 0 )
         {
            ...
            {
               A11OrganisationId = P007D2_A11OrganisationId[0];
               A29LocationId = P007D2_A29LocationId[0];
               A327LocationCountry = P007D2_A327LocationCountry[0];
               AV17SelectedValue = A327LocationCountry;
            ...
            if ( StringUtil.StrCmp(AV14TrnMode, "GET_DSC") == 0 )
            {
               ...
               {
                  AV12Combo_DataItem = ((WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item)AV11Combo_Data.Item(AV27GXV3));
      ...
      protected void S121( )
      {
         ...
         if ( StringUtil.StrCmp(AV14TrnMode, "INS") != 0 )
         {
            ...
            {
               A11OrganisationId = P007D3_A11OrganisationId[0];
               A29LocationId = P007D3_A29LocationId[0];
               A355LocationPhoneCode = P007D3_A355LocationPhoneCode[0];
               AV17SelectedValue = A355LocationPhoneCode;
               /* Exiting from a For First loop. */
               if (true) break;
            }
            pr_default.close(1);
            if ( StringUtil.StrCmp(AV14TrnMode, "GET_DSC") == 0 )
            {
               ...
               {
                  AV12Combo_DataItem = ((WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item)AV11Combo_Data.Item(AV31GXV6));
                  if ( StringUtil.StrCmp(AV12Combo_DataItem.gxTpr_Id, AV17SelectedValue) == 0 )
                  {
                     AV21ComboTitles = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
                     AV21ComboTitles.FromJSonString(AV12Combo_DataItem.gxTpr_Title, null);
      ...
      public override void initialize( )
      {
         ...
         AV24GXV1 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version21");
         AV23LocationCountry_DPItem = new SdtSDT_Country_SDT_CountryItem(context);
         AV12Combo_DataItem = new WorkWithPlus.workwithplus_web.SdtDVB_SDTComboData_Item(context);
         AV21ComboTitles = new GxSimpleCollection<string>();
         P007D2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P007D2_A29LocationId = new Guid[] {Guid.Empty} ;
         P007D2_A327LocationCountry = new string[] {""} ;
         A11OrganisationId = Guid.Empty;
         A29LocationId = Guid.Empty;
         A327LocationCountry = "";
         AV28GXV4 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version21");
         ...
         P007D3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P007D3_A29LocationId = new Guid[] {Guid.Empty} ;
         P007D3_A355LocationPhoneCode = new string[] {""} ;
         A355LocationPhoneCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_locationloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P007D2_A11OrganisationId, P007D2_A29LocationId, P007D2_A327LocationCountry
               }
               , new Object[] {
               P007D3_A11OrganisationId, P007D3_A29LocationId, P007D3_A355LocationPhoneCode
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P007D2_A11OrganisationId ;
      private Guid[] P007D2_A29LocationId ;
      private string[] P007D2_A327LocationCountry ;
      ...
      private Guid[] P007D3_A11OrganisationId ;
      private Guid[] P007D3_A29LocationId ;
      private string[] P007D3_A355LocationPhoneCode ;
   ...
   public class trn_locationloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P007D2", "SELECT OrganisationId, LocationId, LocationCountry FROM Trn_Location WHERE LocationId = :AV15LocationId and OrganisationId = :AV16OrganisationId ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007D2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007D3", "SELECT OrganisationId, LocationId, LocationPhoneCode FROM Trn_Location WHERE LocationId = :AV15LocationId and OrganisationId = :AV16OrganisationId ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007D3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
