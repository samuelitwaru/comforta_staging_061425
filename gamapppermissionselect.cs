   ...
   public class gamapppermissionselect : GXDataArea
   {
      ...
      protected void WB8U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_8U2( true) ;
         }
         else
         {
            wb_table1_14_8U2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_8U2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S132( )
      {
         ...
         new WorkWithPlus.workwithplus_web.wwp_gridstateaddfiltervalue(context ).execute( ref  AV33GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV15FilName)),  0,  AV15FilName,  AV15FilName,  false,  "",  "") ;
      ...
      protected void wb_table1_14_8U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_19_8U2( true) ;
         }
         else
         {
            wb_table2_19_8U2( false) ;
         }
         return  ;
      }

      protected void wb_table2_19_8U2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_8U2e( true) ;
         }
         else
         {
            wb_table1_14_8U2e( false) ;
         }
      }

      protected void wb_table2_19_8U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_19_8U2e( true) ;
         }
         else
         {
            wb_table2_19_8U2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202562017121125", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamapppermissionselect.js", "?202562017121127", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E178U2","iparms":[{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV15FilName","fld":"vFILNAME"},{"av":"AV23PermissionId","fld":"vPERMISSIONID","hsh":true},{"av":"AV19IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true}]""");
