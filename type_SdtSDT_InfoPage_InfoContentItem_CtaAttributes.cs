/*
				   File: type_SdtSDT_InfoPage_InfoContentItem_CtaAttributes
...
namespace GeneXus.Programs
{
	...
	{
		public SdtSDT_InfoPage_InfoContentItem_CtaAttributes( )
		{
			/* Constructor for serialization */
			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaid = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctatype = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctalabel = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaaction = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctacolor = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabgcolor = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttontype = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonimgurl = "";

			gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonicon = "";

		}

		public SdtSDT_InfoPage_InfoContentItem_CtaAttributes(IGxContext context)
		{
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaid; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaid = value;
				SetDirty("Ctaid");
			}
		}
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctatype; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctatype = value;
				SetDirty("Ctatype");
			}
		}
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctalabel; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctalabel = value;
				SetDirty("Ctalabel");
			}
		}
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaaction; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaaction = value;
				SetDirty("Ctaaction");
			}
		}
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctacolor; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctacolor = value;
				SetDirty("Ctacolor");
			}
		}
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabgcolor; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabgcolor = value;
				SetDirty("Ctabgcolor");
			}
		}
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttontype; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttontype = value;
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonimgurl; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonimgurl = value;
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonicon; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonicon = value;
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctasupplierisconnected; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctasupplierisconnected = value;
		...
		{
			get {
				return gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaconnectedsupplierid; 
			}
			set {
				gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaconnectedsupplierid = value;
		...
		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaid;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctatype;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctalabel;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaaction;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctacolor;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabgcolor;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttontype;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonimgurl;
		 

		protected string gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctabuttonicon;
		 

		protected bool gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctasupplierisconnected;
		 

		protected Guid gxTv_SdtSDT_InfoPage_InfoContentItem_CtaAttributes_Ctaconnectedsupplierid;
	...
	public class SdtSDT_InfoPage_InfoContentItem_CtaAttributes_RESTInterface : GxGenericCollectionItem<SdtSDT_InfoPage_InfoContentItem_CtaAttributes>, System.Web.SessionState.IRequiresSessionState
	{
		...
		public SdtSDT_InfoPage_InfoContentItem_CtaAttributes_RESTInterface( SdtSDT_InfoPage_InfoContentItem_CtaAttributes psdt ) : base(psdt)
		{	
		}
		...
		public SdtSDT_InfoPage_InfoContentItem_CtaAttributes sdt
		{
			get { 
				return (SdtSDT_InfoPage_InfoContentItem_CtaAttributes)Sdt;
			}
			set { 
				Sdt = value;
			}
		...
		void checkSdt( StreamingContext ctx )
		{
			if ( sdt == null )
			{
				sdt = new SdtSDT_InfoPage_InfoContentItem_CtaAttributes() ;
			}
		}
	}
	#endregion
